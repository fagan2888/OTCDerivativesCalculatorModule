...
namespace ParallelCalculationMangerServer
{
    public class DataBaseConnectManager
    {
        ...
        public const string ConnectionString_ = @"Data Source=D:\Project File\OTCDerivativesCalculatorModule\testExcelAddinWPF\bin\Debug\MarketDataDB.sdf";

        public DataBaseConnectManager()
        { 
