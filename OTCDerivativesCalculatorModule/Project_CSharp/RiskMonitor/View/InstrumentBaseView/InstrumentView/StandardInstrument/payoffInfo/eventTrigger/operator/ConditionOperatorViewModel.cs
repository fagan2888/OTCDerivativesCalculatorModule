    ...
    public class ConditionOperatorViewModel : IXmlData
    {
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("iXmlData");
                xmlWriter.WriteElementString("type" , "conditionOperator");
        ...
        public  void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            {
                RangeCondition1DViewModel viewModel = new RangeCondition1DViewModel();
                viewModel.setFromSerial(item);
                this.rangeCondition1DViewModel_.Add(viewModel);
            }
            
            //this.view_ = new ConditionOperatorView();
            //this.view_.DataContext = this;
        }
        
            //#region SelectRangeCondition1DInfo_
            //private string selectRangeCondition1DInfo_;
            //public string SelectRangeCondition1DInfo_
            //{
            //    get { return this.selectRangeCondition1DInfo_; }
            //    set
            //    {
            //        if (this.selectRangeCondition1DInfo_ != value)
            //        {
            //            this.selectRangeCondition1DInfo_ = value;
            //            this.NotifyPropertyChanged("SelectRangeCondition1DInfo_");
            //        }
            //    }
            //}
            //#endregion
            
            //public void selectRangeCondition1DInfo(string typeStr)
            //{
            //    this.rangeCondition1DViewModel_ = RangeCondition1DViewModel.CreateRangeCondition1D(typeStr);
            //    this.view_.DataContext = this;
            //}
    }
