...
namespace RiskMonitor
{
    public abstract class OperatorNDViewModel : IXmlData
    {
        ...
        public static OperatorNDViewModel CreateOperatorND(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            FpmlSerializedCSharp.OperatorND serial_OperatorND = serial_Class as FpmlSerializedCSharp.OperatorND;
            string typeStr = serial_OperatorND.Type_.ValueStr;
            return OperatorNDViewModel.CreateOperatorND(typeStr);
        }
