...
{
    public class InstrumentExplorerViewModel : IXmlData
    {
        ...
        public void loadBookInfo()
        {
            ...
            foreach (var item in serial_bookInfo.InstrumentList_.InstHirachyInfo_)
            {
                ...
                InstrumentBaseViewModel instBaseVM = InstrumentBaseViewModel.CreateInstBaseVM(itemCode, itemType, fileInfo);

                //ExploreHirachyInstrumentVMWrapper hirachyInstVMWrapper
                //    = new ExploreHirachyInstrumentVMWrapper(itemCode, itemType, instBaseVM);

                ExploreHirachyVMWrapper hirachyInstVMWrapper = ExploreHirachyVMWrapper.CreateExploreHirachyWrapper(itemCode, itemType, instBaseVM);
