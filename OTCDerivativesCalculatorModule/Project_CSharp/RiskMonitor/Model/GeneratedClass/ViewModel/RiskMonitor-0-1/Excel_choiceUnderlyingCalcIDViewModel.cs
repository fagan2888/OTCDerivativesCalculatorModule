    ...
    public class Excel_choiceUnderlyingCalcIDViewModel : Excel_underlyingCalcIDViewModel
    {
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("excel_underlyingCalcID");
                xmlWriter.WriteElementString("type" , "excel_choiceUnderlyingCalcID");
        ...
        public override void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            this.eventDate_ = StringConverter.xmlDateToDateTime(serial_Excel_choiceUnderlyingCalcID.EventDate_.ValueStr);
