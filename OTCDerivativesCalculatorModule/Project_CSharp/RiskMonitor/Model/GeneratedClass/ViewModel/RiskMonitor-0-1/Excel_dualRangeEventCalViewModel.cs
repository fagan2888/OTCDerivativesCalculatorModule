...
{
    public class Excel_dualRangeEventCalViewModel : Excel_eventCalcInfoViewModel
    {
        #region Event
        ...
        public Excel_dualRangeEventCalViewModel() { }
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("excel_eventCalcInfo");
                xmlWriter.WriteElementString("type" , "excel_dualRangeEventCal");
        ...
        {
            Control v = new Excel_dualRangeEventCalView();
            v.DataContext = this;
            return v;
        }
