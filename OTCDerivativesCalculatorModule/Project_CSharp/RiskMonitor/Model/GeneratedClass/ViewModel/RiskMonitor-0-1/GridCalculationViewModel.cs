...
namespace Excel_Interface
{
    public class GridCalculationViewModel : MessageBodyViewModel
    {
        ...
        private string productInnerXml_;
        public string ProductInnerXml_
        {
            get { return this.productInnerXml_; }
            set
            {
                if (this.productInnerXml_ != value)
                {
                    this.productInnerXml_ = value;
                    this.NotifyPropertyChanged("ProductInnerXml_");
                }
            }
        }
        #endregion
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("messageBody");
                xmlWriter.WriteElementString("type" , "gridCalculation");
                xmlWriter.WriteStartElement("gridCalculation");
                    ...
                    xmlWriter.WriteElementString("productInnerXml" , this.productInnerXml_);
