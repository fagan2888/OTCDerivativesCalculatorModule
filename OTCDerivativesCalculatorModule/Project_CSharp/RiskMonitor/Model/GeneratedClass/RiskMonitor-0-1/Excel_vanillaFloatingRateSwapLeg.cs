...
{
    public class Excel_vanillaFloatingRateSwapLeg : ISerialized
    {
        public Excel_vanillaFloatingRateSwapLeg() { }
        public Excel_vanillaFloatingRateSwapLeg(XmlNode xmlNode)
        : base(xmlNode)
        {
