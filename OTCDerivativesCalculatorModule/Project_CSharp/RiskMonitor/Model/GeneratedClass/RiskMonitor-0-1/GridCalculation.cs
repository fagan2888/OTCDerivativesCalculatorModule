...
namespace FpmlSerializedCSharp
{
    public class GridCalculation : ISerialized
    {
            ...
            if (productInnerXmlNode != null)
            {
                if (productInnerXmlNode.Attributes["href"] != null || productInnerXmlNode.Attributes["id"] != null) 
                {
                    if (productInnerXmlNode.Attributes["id"] != null) 
                    {
                        ...
                        XsdTypeToken ob = new XsdTypeToken(productInnerXmlNode);
                    ...
                    {
                        productInnerXml_ = new XsdTypeToken(productInnerXmlNode);
                    }
                }
                else
                {
        ...
        private XsdTypeToken productInnerXml_;
        public XsdTypeToken ProductInnerXml_
        {
            get
            {
                ...
                {
                    productInnerXml_ = IDManager.getID(productInnerXmlIDRef_) as XsdTypeToken;
                    return this.productInnerXml_; 
                }
                else
                {
