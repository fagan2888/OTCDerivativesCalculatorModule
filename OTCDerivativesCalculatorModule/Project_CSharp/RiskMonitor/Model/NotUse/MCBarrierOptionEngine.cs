...
//    public abstract class MCBarrierOptionEngine<MC, RNG, S> : MCBarrierOptionEngine<MC, RNG, S, MultiBarrierOption>
//        where RNG : IRSG, new()
//        where S : IGeneralStatistics, new()
//    {
//        protected MCBarrierOptionEngine(StochasticProcess process, int timeSteps, int timeStepsPerYear, bool brownianBridge,
...
//    public abstract class MCBarrierOptionEngine<MC, RNG, S, Inst> : McSimulation<MC, RNG, S>, IGenericEngine
//        where RNG : IRSG, new()
//        where S : IGeneralStatistics, new()
//    {
