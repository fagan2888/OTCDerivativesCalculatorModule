...
{
    public class FixedPaymentAmount : PaymentBase
    {
        ...
        #region PaymentDate_
        private RelativeDateOffset paymentDate_;
        public RelativeDateOffset PaymentDate_
        {
            get
            {
                ...
                {
                    paymentDate_ = IDManager.getID(paymentDateIDRef_) as RelativeDateOffset;
                    return this.paymentDate_; 
                }
                else
                {
