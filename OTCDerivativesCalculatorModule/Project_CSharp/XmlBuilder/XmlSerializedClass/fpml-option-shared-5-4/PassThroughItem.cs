...
{
    public class PassThroughItem : ISerialized
    {
        ...
        #region PassThroughPercentage_
        private XsdTypeDecimal passThroughPercentage_;
        public XsdTypeDecimal PassThroughPercentage_
        {
            get
            {
                if (this.passThroughPercentage_ != null)
                {
                    return this.passThroughPercentage_; 
                }
                else if (this.passThroughPercentageIDRef_ != null)
                {
                    passThroughPercentage_ = IDManager.getID(passThroughPercentageIDRef_) as XsdTypeDecimal;
                    return this.passThroughPercentage_; 
                }
                else
                {
            ...
            set
            {
                if (this.passThroughPercentage_ != value)
                {
                    this.passThroughPercentage_ = value;
                }
            }
        }
        #endregion
        
        public string passThroughPercentageIDRef_ { get; set; }
