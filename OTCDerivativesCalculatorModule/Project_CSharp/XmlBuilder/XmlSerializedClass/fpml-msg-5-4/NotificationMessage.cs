...
namespace FpmlSerializedCSharp
{
    public class NotificationMessage : Message
    {
            ...
            if (headerNode != null)
            {
                if (headerNode.Attributes["href"] != null || headerNode.Attributes["id"] != null) 
                {
                    if (headerNode.Attributes["id"] != null) 
                    {
                        ...
                        NotificationMessageHeader ob = new NotificationMessageHeader(headerNode);
                    ...
                    {
                        header_ = new NotificationMessageHeader(headerNode);
                    }
                }
                else
                {
        ...
        #region Header_
        private NotificationMessageHeader header_;
        public NotificationMessageHeader Header_
        {
            get
            {
                ...
                {
                    header_ = IDManager.getID(headerIDRef_) as NotificationMessageHeader;
                    return this.header_; 
                }
                else
                {
