...
{
    public class CorrectableRequestMessage : RequestMessage
    {
        ...
        private XsdTypeBoolean isCorrection_;
        public XsdTypeBoolean IsCorrection_
        {
            get
            {
                ...
                {
                    isCorrection_ = IDManager.getID(isCorrectionIDRef_) as XsdTypeBoolean;
                    return this.isCorrection_; 
                }
                else
                {
