...
{
    public class CommodityInformationSource : ISerialized
    {
            ...
            if (rateSourceNode != null)
            {
                if (rateSourceNode.Attributes["href"] != null || rateSourceNode.Attributes["id"] != null) 
                {
                    if (rateSourceNode.Attributes["id"] != null) 
                    {
                        ...
                        CommodityInformationProvider ob = new CommodityInformationProvider(rateSourceNode);
                    ...
                    {
                        rateSource_ = new CommodityInformationProvider(rateSourceNode);
                    }
                }
                else
                {
        ...
        #region RateSource_
        private CommodityInformationProvider rateSource_;
        public CommodityInformationProvider RateSource_
        {
            get
            {
                ...
                {
                    rateSource_ = IDManager.getID(rateSourceIDRef_) as CommodityInformationProvider;
                    return this.rateSource_; 
                }
                else
                {
