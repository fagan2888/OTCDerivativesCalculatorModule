...
{
    public class RequestConsent : CorrectableRequestMessage
    {
        public RequestConsent(XmlNode xmlNode)
        : base(xmlNode)
        {
            ...
            if (requestedActionNode != null)
            {
                if (requestedActionNode.Attributes["href"] != null || requestedActionNode.Attributes["id"] != null) 
                {
                    if (requestedActionNode.Attributes["id"] != null) 
                    {
                        ...
                        RequestedAction ob = new RequestedAction(requestedActionNode);
                    ...
                    {
                        requestedAction_ = new RequestedAction(requestedActionNode);
                    }
                }
                else
                {
        ...
        private RequestedAction requestedAction_;
        public RequestedAction RequestedAction_
        {
            get
            {
                ...
                {
                    requestedAction_ = IDManager.getID(requestedActionIDRef_) as RequestedAction;
                    return this.requestedAction_; 
                }
                else
                {
