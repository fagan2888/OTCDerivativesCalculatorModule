...
{
    public class ElectricityPhysicalDeliveryQuantitySchedule : CommodityPhysicalQuantitySchedule
    {
        public ElectricityPhysicalDeliveryQuantitySchedule(XmlNode xmlNode)
        : base(xmlNode)
        {
