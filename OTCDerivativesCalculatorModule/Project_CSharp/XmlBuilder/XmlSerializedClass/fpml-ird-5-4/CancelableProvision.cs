...
{
    public class CancelableProvision : ISerialized
    {
        ...
        #region CancelableProvisionAdjustedDates_
        private CancelableProvisionAdjustedDates cancelableProvisionAdjustedDates_;
        public CancelableProvisionAdjustedDates CancelableProvisionAdjustedDates_
        {
            get
            {
                if (this.cancelableProvisionAdjustedDates_ != null)
                {
                    return this.cancelableProvisionAdjustedDates_; 
                }
                else if (this.cancelableProvisionAdjustedDatesIDRef_ != null)
                {
                    cancelableProvisionAdjustedDates_ = IDManager.getID(cancelableProvisionAdjustedDatesIDRef_) as CancelableProvisionAdjustedDates;
                    return this.cancelableProvisionAdjustedDates_; 
                }
                else
                {
            ...
            set
            {
                if (this.cancelableProvisionAdjustedDates_ != value)
                {
                    this.cancelableProvisionAdjustedDates_ = value;
                }
            }
        }
        #endregion
        
        public string cancelableProvisionAdjustedDatesIDRef_ { get; set; }
        #region FinalCalculationPeriodDateAdjustment_
        private List<FinalCalculationPeriodDateAdjustment> finalCalculationPeriodDateAdjustment_;
        public List<FinalCalculationPeriodDateAdjustment> FinalCalculationPeriodDateAdjustment_
        {
            get
            {
                if (this.finalCalculationPeriodDateAdjustment_ != null)
                {
                    return this.finalCalculationPeriodDateAdjustment_; 
                }
                else if (this.finalCalculationPeriodDateAdjustmentIDRef_ != null)
                {
                    return this.finalCalculationPeriodDateAdjustment_; 
                }
                else
            ...
            set
            {
                if (this.finalCalculationPeriodDateAdjustment_ != value)
                {
                    this.finalCalculationPeriodDateAdjustment_ = value;
                }
            }
        }
        #endregion
        
        public string finalCalculationPeriodDateAdjustmentIDRef_ { get; set; }
        #region InitialFee_
        private SimplePayment initialFee_;
        public SimplePayment InitialFee_
        {
            get
            {
                if (this.initialFee_ != null)
                {
                    return this.initialFee_; 
                }
                else if (this.initialFeeIDRef_ != null)
                {
                    initialFee_ = IDManager.getID(initialFeeIDRef_) as SimplePayment;
                    return this.initialFee_; 
                }
                else
                {
            ...
            set
            {
                if (this.initialFee_ != value)
                {
                    this.initialFee_ = value;
                }
            }
        }
        #endregion
        
        public string initialFeeIDRef_ { get; set; }
