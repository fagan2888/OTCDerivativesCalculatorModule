...
{
    public class PhysicalSettlement : ISerialized
    {
        ...
        #region ResultingTradeIdentifier_
        private PartyTradeIdentifier resultingTradeIdentifier_;
        public PartyTradeIdentifier ResultingTradeIdentifier_
        {
            get
            {
                if (this.resultingTradeIdentifier_ != null)
                {
                    return this.resultingTradeIdentifier_; 
                }
                else if (this.resultingTradeIdentifierIDRef_ != null)
                {
                    resultingTradeIdentifier_ = IDManager.getID(resultingTradeIdentifierIDRef_) as PartyTradeIdentifier;
                    return this.resultingTradeIdentifier_; 
                }
                else
                {
            ...
            set
            {
                if (this.resultingTradeIdentifier_ != value)
                {
                    this.resultingTradeIdentifier_ = value;
                }
            }
        }
        #endregion
        
        public string resultingTradeIdentifierIDRef_ { get; set; }
        #region ResultingTrade_
        private Trade resultingTrade_;
        public Trade ResultingTrade_
        {
            get
            {
                if (this.resultingTrade_ != null)
                {
                    return this.resultingTrade_; 
                }
                else if (this.resultingTradeIDRef_ != null)
                {
                    resultingTrade_ = IDManager.getID(resultingTradeIDRef_) as Trade;
                    return this.resultingTrade_; 
                }
                else
                {
            ...
            set
            {
                if (this.resultingTrade_ != value)
                {
                    this.resultingTrade_ = value;
                }
            }
        }
        #endregion
        
        public string resultingTradeIDRef_ { get; set; }
        #region Product_
