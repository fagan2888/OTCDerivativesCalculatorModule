...
{
    public class EventProposedMatch : ISerialized
    {
        ...
        #region MatchId_
        private MatchId matchId_;
        public MatchId MatchId_
        {
            get
            {
                ...
                else if (this.matchIdIDRef_ != null)
                {
                    matchId_ = IDManager.getID(matchIdIDRef_) as MatchId;
                    return this.matchId_; 
                }
                else
                {
        ...
        public string matchIdIDRef_ { get; set; }
        #region Difference_
        private List<TradeDifference> difference_;
        public List<TradeDifference> Difference_
        {
            get
            {
                if (this.difference_ != null)
                {
                    return this.difference_; 
                }
                else if (this.differenceIDRef_ != null)
                {
                    return this.difference_; 
                }
                else
            ...
            set
            {
                if (this.difference_ != value)
                {
                    this.difference_ = value;
                }
            }
        }
        #endregion
        
        public string differenceIDRef_ { get; set; }
        #region MatchScore_
        private XsdTypeDecimal matchScore_;
        public XsdTypeDecimal MatchScore_
        {
            get
            {
                if (this.matchScore_ != null)
                {
                    return this.matchScore_; 
                }
                else if (this.matchScoreIDRef_ != null)
                {
                    matchScore_ = IDManager.getID(matchScoreIDRef_) as XsdTypeDecimal;
                    return this.matchScore_; 
                }
                else
                {
            ...
            set
            {
                if (this.matchScore_ != value)
                {
                    this.matchScore_ = value;
                }
            }
        }
        #endregion
        
        public string matchScoreIDRef_ { get; set; }
