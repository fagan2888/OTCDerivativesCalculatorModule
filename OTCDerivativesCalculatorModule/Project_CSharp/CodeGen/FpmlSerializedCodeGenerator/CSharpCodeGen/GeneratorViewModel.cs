...
namespace CSharpCodeGen
{
    ...
    {
        public GeneratorViewModel(XmlSchemaComplexType xsCoxType,
        ...
        private ClassGenViewModel m_ClassGen = new ClassGenViewModel();
        ...
        private void setXsd(XmlSchemaComplexType xsCoxType) 
        {
            ...
            if (xsCoxType.Id != null)
            {
                StringBuilder sb = new StringBuilder(xsCoxType.Id);
                
                string sb2 = sb.ToString().Substring(0,sb.Length-2);

                m_ClassGen.BaseID_ = sb2;
            }
            else 
            {
                m_ClassGen.BaseID_ = "IXmlData";
            }
