...
namespace QLNet
{
    ...
    //    
    public class AnalyticBarrierWithPartiRateEngine : BarrierOption.Engine
    {
        ...
        private double A(double phi)
        {
            ...
            return this.partiRate_.Value * phi * (underlying() * dividendDiscount() * N1 - strike() * riskFreeDiscount() * N2);
        }
        ...
        private double C(double eta, double phi)
        {
            ...
            return this.partiRate_.Value * phi * (underlying() * dividendDiscount() * powHS1 * N1 - strike() * riskFreeDiscount() * powHS0 * N2);
        }
