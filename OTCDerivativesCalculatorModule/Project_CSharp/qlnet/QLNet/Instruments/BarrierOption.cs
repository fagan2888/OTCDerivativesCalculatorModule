...
namespace QLNet {
	...
	public class BarrierOption : OneAssetOption
	{
        ...
        public BarrierOption(Barrier.Type barrierType, double barrier,double partiRate, double rebate, StrikedTypePayoff payoff, Exercise exercise)
            : base(payoff, exercise)
        {
            partiRate_ = partiRate;
            barrierType_ = barrierType;
            barrier_ = barrier;
            rebate_ = rebate;
        }
