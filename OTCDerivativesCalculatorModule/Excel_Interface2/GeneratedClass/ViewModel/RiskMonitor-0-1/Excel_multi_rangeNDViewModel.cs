...
{
    public class Excel_multi_rangeNDViewModel : IXmlData
    {
        #region Event
        ...
        public Excel_multi_rangeNDViewModel() { }
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("iXmlData");
                xmlWriter.WriteElementString("excel_type" , "excel_multi_rangeND");
                xmlWriter.WriteStartElement("excel_multi_rangeND");
        ...
        public  Control view()
        {
            Control v = new Excel_multi_rangeNDView();
            v.DataContext = this;
            return v;
        }
