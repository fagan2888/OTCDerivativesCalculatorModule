...
{
    public class Excel_maximumUnderlyingCalcIDViewModel : Excel_underlyingCalcIDViewModel
    {
        #region Event
        ...
        public Excel_maximumUnderlyingCalcIDViewModel() { }
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("excel_underlyingCalcID");
                xmlWriter.WriteElementString("excel_type" , "excel_maximumUnderlyingCalcID");
                xmlWriter.WriteStartElement("excel_maximumUnderlyingCalcID");
        ...
        {
            Control v = new Excel_maximumUnderlyingCalcIDView();
            v.DataContext = this;
            return v;
        }
        ...
        public override void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            this.eventDate_ = StringConverter.xmlDateToDateTime(serial_Excel_maximumUnderlyingCalcID.EventDate_.ValueStr);
