...
{
    public class Excel_structuredBondLegViewModel : Excel_swapLegViewModel
    {
        #region Event
        ...
        public Excel_structuredBondLegViewModel() { }
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("excel_swapLeg");
                xmlWriter.WriteElementString("excel_type" , "excel_structuredBondLeg");
                xmlWriter.WriteStartElement("excel_structuredBondLeg");
        ...
        {
            Control v = new Excel_structuredBondLegView();
            v.DataContext = this;
            return v;
        }
        ...
        public override void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            FpmlSerializedCSharp.Excel_structuredBondLeg serial_Excel_structuredBondLeg = serial_Excel_swapLeg.Excel_structuredBondLeg_;
        
            FpmlSerializedCSharp.Excel_swapLegInfo serial_excel_swapLegInfo = serial_Excel_structuredBondLeg.Excel_swapLegInfo_;
            ...
            FpmlSerializedCSharp.Excel_interface serial_excel_interface = serial_Excel_structuredBondLeg.Excel_interface_;
