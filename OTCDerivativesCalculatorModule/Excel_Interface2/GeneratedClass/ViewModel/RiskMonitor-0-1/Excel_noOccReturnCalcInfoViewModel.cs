...
{
    public class Excel_noOccReturnCalcInfoViewModel : IXmlData
    {
        #region Event
        ...
        public Excel_noOccReturnCalcInfoViewModel() { }
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("iXmlData");
                xmlWriter.WriteElementString("excel_type" , "excel_noOccReturnCalcInfo");
                xmlWriter.WriteStartElement("excel_noOccReturnCalcInfo");
        ...
        public  Control view()
        {
            Control v = new Excel_noOccReturnCalcInfoView();
            v.DataContext = this;
            return v;
        }
        ...
        {
            FpmlSerializedCSharp.Excel_noOccReturnCalcInfo serial_Excel_noOccReturnCalcInfo = serial_Class as FpmlSerializedCSharp.Excel_noOccReturnCalcInfo;
        
            FpmlSerializedCSharp.Excel_returnCalcInfo serial_excel_returnCalcInfo = serial_Excel_noOccReturnCalcInfo.Excel_returnCalcInfo_;
