...
namespace Excel_Interface
{
    public abstract class Excel_underlyingInfoViewModel : IXmlData
    {
        ...
        #region Excel_indexTypeViewModel_
        private Excel_indexTypeViewModel excel_indexTypeViewModel_;
        public Excel_indexTypeViewModel Excel_indexTypeViewModel_
        {
            get { return this.excel_indexTypeViewModel_; }
            set
            {
                if (this.excel_indexTypeViewModel_ != value)
                {
                    this.excel_indexTypeViewModel_ = value;
                    this.NotifyPropertyChanged("Excel_indexTypeViewModel_");
                }
            }
        }
        #endregion
