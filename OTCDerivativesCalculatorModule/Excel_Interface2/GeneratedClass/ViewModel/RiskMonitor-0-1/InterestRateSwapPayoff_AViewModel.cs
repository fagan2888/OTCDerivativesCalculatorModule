...
{
    public class InterestRateSwapPayoff_AViewModel : IXmlData
    {
        #region Event
        ...
        public InterestRateSwapPayoff_AViewModel() { }
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("iXmlData");
                xmlWriter.WriteElementString("excel_type" , "interestRateSwapPayoff_A");
                xmlWriter.WriteStartElement("interestRateSwapPayoff_A");
        ...
        public  Control view()
        {
            Control v = new InterestRateSwapPayoff_AView();
            v.DataContext = this;
            return v;
        }
        ...
        {
            FpmlSerializedCSharp.InterestRateSwapPayoff_A serial_InterestRateSwapPayoff_A = serial_Class as FpmlSerializedCSharp.InterestRateSwapPayoff_A;
        
            FpmlSerializedCSharp.PayoffInfo serial_payoffInfo = serial_InterestRateSwapPayoff_A.PayoffInfo_;
