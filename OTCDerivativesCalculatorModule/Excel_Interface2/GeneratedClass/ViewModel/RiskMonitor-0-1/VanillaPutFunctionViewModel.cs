...
{
    public class VanillaPutFunctionViewModel : OptionPayoffFunctionViewModel
    {
        #region Event
        ...
        public VanillaPutFunctionViewModel() { }
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("optionPayoffFunction");
                xmlWriter.WriteElementString("excel_type" , "vanillaPutFunction");
                xmlWriter.WriteStartElement("vanillaPutFunction");
        ...
        {
            Control v = new VanillaPutFunctionView();
            v.DataContext = this;
            return v;
        }
