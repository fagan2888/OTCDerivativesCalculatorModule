...
namespace Excel_Interface
{
    public abstract class Excel_swapLegViewModel : IXmlData
    {
        ...
        #region Excel_structuredSwapLegViewModel_
        private Excel_structuredSwapLegViewModel excel_structuredSwapLegViewModel_;
        public Excel_structuredSwapLegViewModel Excel_structuredSwapLegViewModel_
        {
            get { return this.excel_structuredSwapLegViewModel_; }
            set
            {
                if (this.excel_structuredSwapLegViewModel_ != value)
                {
                    this.excel_structuredSwapLegViewModel_ = value;
                    this.NotifyPropertyChanged("Excel_structuredSwapLegViewModel_");
                }
            }
        }
        #endregion
