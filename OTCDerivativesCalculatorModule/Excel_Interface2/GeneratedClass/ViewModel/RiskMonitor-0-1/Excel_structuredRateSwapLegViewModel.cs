...
{
    public class Excel_structuredRateSwapLegViewModel : Excel_swapLegViewModel
    {
        #region Event
        ...
        public Excel_structuredRateSwapLegViewModel() { }
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("excel_swapLeg");
                xmlWriter.WriteElementString("excel_type" , "excel_structuredRateSwapLeg");
                xmlWriter.WriteStartElement("excel_structuredRateSwapLeg");
        ...
        {
            Control v = new Excel_structuredRateSwapLegView();
            v.DataContext = this;
            return v;
        }
