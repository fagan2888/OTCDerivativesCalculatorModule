...
{
    public class Excel_multiAsset_downInOutPutViewModel : Excel_multiAsset_compositeOption_subtypeViewModel
    {
        #region Event
        ...
        public Excel_multiAsset_downInOutPutViewModel() { }
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("excel_multiAsset_compositeOption_subtype");
                xmlWriter.WriteElementString("excel_type" , "excel_multiAsset_downInOutPut");
                xmlWriter.WriteStartElement("excel_multiAsset_downInOutPut");
        ...
        {
            Control v = new Excel_multiAsset_downInOutPutView();
            v.DataContext = this;
            return v;
        }
        ...
        public override void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            FpmlSerializedCSharp.Excel_multiAsset_downInOutPut serial_Excel_multiAsset_downInOutPut = serial_Excel_multiAsset_compositeOption_subtype.Excel_multiAsset_downInOutPut_;
        
            this.payoffDate_ = StringConverter.xmlDateToDateTime(serial_Excel_multiAsset_downInOutPut.PayoffDate_.ValueStr);
            
            this.exerciseDate_ = StringConverter.xmlDateToDateTime(serial_Excel_multiAsset_downInOutPut.ExerciseDate_.ValueStr);
            
            this.inOut_ = serial_Excel_multiAsset_downInOutPut.InOut_.ValueStr;
            
            this.baseUnderlyingValue_ = serial_Excel_multiAsset_downInOutPut.BaseUnderlyingValue_.ValueStr;
            
            this.baseCoupon_ = serial_Excel_multiAsset_downInOutPut.BaseCoupon_.ValueStr;
            
            this.strike_ = serial_Excel_multiAsset_downInOutPut.Strike_.ValueStr;
            
            this.strikeValue_ = serial_Excel_multiAsset_downInOutPut.StrikeValue_.ValueStr;
            
            this.partiRate_ = serial_Excel_multiAsset_downInOutPut.PartiRate_.ValueStr;
            
            this.barrier_ = serial_Excel_multiAsset_downInOutPut.Barrier_.ValueStr;
            
            this.barrierValue_ = serial_Excel_multiAsset_downInOutPut.BarrierValue_.ValueStr;
            
            this.rebateCoupon_ = serial_Excel_multiAsset_downInOutPut.RebateCoupon_.ValueStr;
            
            this.rebateCouponValue_ = serial_Excel_multiAsset_downInOutPut.RebateCouponValue_.ValueStr;
            
            List<FpmlSerializedCSharp.Excel_underlyingCalcID> serial_excel_underlyingCalcID = serial_Excel_multiAsset_downInOutPut.Excel_underlyingCalcID_;
            ...
            this.observationStartDate_ = StringConverter.xmlDateToDateTime(serial_Excel_multiAsset_downInOutPut.ObservationStartDate_.ValueStr);
            
            this.observationEndDate_ = StringConverter.xmlDateToDateTime(serial_Excel_multiAsset_downInOutPut.ObservationEndDate_.ValueStr);
