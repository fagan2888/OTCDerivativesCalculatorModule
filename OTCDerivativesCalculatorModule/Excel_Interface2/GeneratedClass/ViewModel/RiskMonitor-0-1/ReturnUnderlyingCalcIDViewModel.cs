...
{
    public class ReturnUnderlyingCalcIDViewModel : IXmlData
    {
        ...
        public ReturnUnderlyingCalcIDViewModel() { }
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("iXmlData");
                xmlWriter.WriteElementString("type" , "returnUnderlyingCalcID");
                xmlWriter.WriteStartElement("returnUnderlyingCalcID");
        ...
        {
            FpmlSerializedCSharp.ReturnUnderlyingCalcID serial_ReturnUnderlyingCalcID = serial_Class as FpmlSerializedCSharp.ReturnUnderlyingCalcID;
        
            FpmlSerializedCSharp.Excel_underlyingCalcID serial_excel_underlyingCalcID = serial_ReturnUnderlyingCalcID.Excel_underlyingCalcID_;
            ...
            this.view_ = new ReturnUnderlyingCalcIDView();
