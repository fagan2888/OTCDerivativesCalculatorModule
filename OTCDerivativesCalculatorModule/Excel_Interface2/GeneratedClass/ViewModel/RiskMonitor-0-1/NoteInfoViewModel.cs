...
namespace Excel_Interface
{
    public class NoteInfoViewModel : IssueInformationViewModel
    {
        ...
        public override void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            this.tradeDate_ = StringConverter.xmlDateToDateTime(serial_NoteInfo.TradeDate_.ValueStr);
            
            this.effectiveDate_ = StringConverter.xmlDateToDateTime(serial_NoteInfo.EffectiveDate_.ValueStr);
            
            this.maturityDate_ = StringConverter.xmlDateToDateTime(serial_NoteInfo.MaturityDate_.ValueStr);
