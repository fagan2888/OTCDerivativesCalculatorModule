...
{
    public class VanillaPutOptionViewModel : StandardOptionViewModel
    {
        #region Event
        ...
        public VanillaPutOptionViewModel() { }
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("standardOption");
                xmlWriter.WriteElementString("excel_type" , "vanillaPutOption");
                xmlWriter.WriteStartElement("vanillaPutOption");
        ...
        {
            Control v = new VanillaPutOptionView();
            v.DataContext = this;
            return v;
        }
        ...
        public override void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            FpmlSerializedCSharp.VanillaPutOption serial_VanillaPutOption = serial_StandardOption.VanillaPutOption_;
        
            FpmlSerializedCSharp.PayoffDateInfo serial_payoffDateInfo = serial_VanillaPutOption.PayoffDateInfo_;
            ...
            this.participateRate_ = serial_VanillaPutOption.ParticipateRate_.ValueStr;
            
            FpmlSerializedCSharp.ReferenceCalculationInfo serial_referenceCalculationInfo = serial_VanillaPutOption.ReferenceCalculationInfo_;
            ...
            this.strike_ = serial_VanillaPutOption.Strike_.ValueStr;
            
            this.lowerBound_ = serial_VanillaPutOption.LowerBound_.ValueStr;
