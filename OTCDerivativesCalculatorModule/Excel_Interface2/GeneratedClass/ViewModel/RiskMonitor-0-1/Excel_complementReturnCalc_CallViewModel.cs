...
{
    public class Excel_complementReturnCalc_CallViewModel : IXmlData
    {
        #region Event
        ...
        public Excel_complementReturnCalc_CallViewModel() { }
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("iXmlData");
                xmlWriter.WriteElementString("excel_type" , "excel_complementReturnCalc_Call");
                xmlWriter.WriteStartElement("excel_complementReturnCalc_Call");
        ...
        public  Control view()
        {
            Control v = new Excel_complementReturnCalc_CallView();
            v.DataContext = this;
            return v;
        }
        ...
        {
            FpmlSerializedCSharp.Excel_complementReturnCalc_Call serial_Excel_complementReturnCalc_Call = serial_Class as FpmlSerializedCSharp.Excel_complementReturnCalc_Call;
        
            FpmlSerializedCSharp.Excel_returnCalcInfo serial_excel_returnCalcInfo = serial_Excel_complementReturnCalc_Call.Excel_returnCalcInfo_;
