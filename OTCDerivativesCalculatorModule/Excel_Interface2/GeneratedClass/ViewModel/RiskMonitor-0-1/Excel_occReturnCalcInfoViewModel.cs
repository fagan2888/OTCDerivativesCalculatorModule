...
{
    public class Excel_occReturnCalcInfoViewModel : IXmlData
    {
        #region Event
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("iXmlData");
                xmlWriter.WriteElementString("excel_type" , "excel_occReturnCalcInfo");
        ...
        public  Control view()
        {
            Control v = new Excel_occReturnCalcInfoView();
            v.DataContext = this;
            return v;
        }
