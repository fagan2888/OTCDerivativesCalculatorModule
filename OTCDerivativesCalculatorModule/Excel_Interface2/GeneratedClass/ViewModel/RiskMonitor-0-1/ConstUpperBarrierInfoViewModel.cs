...
{
    public class ConstUpperBarrierInfoViewModel : BarrierInfoViewModel
    {
        #region Event
        ...
        public ConstUpperBarrierInfoViewModel() { }
        ...
        public override void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("barrierInfo");
                xmlWriter.WriteElementString("excel_type" , "constUpperBarrierInfo");
                xmlWriter.WriteStartElement("constUpperBarrierInfo");
        ...
        {
            Control v = new ConstUpperBarrierInfoView();
            v.DataContext = this;
            return v;
        }
        ...
        public override void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            FpmlSerializedCSharp.ConstUpperBarrierInfo serial_ConstUpperBarrierInfo = serial_BarrierInfo.ConstUpperBarrierInfo_;
        
            FpmlSerializedCSharp.ReferenceCalculationInfo serial_referenceCalculationInfo = serial_ConstUpperBarrierInfo.ReferenceCalculationInfo_;
            ...
            FpmlSerializedCSharp.BarrierDateInfo serial_barrierDateInfo = serial_ConstUpperBarrierInfo.BarrierDateInfo_;
            ...
            this.trigger_ = serial_ConstUpperBarrierInfo.Trigger_.ValueStr;
            
            this.pastEventOccDate_ = StringConverter.xmlDateToDateTime(serial_ConstUpperBarrierInfo.PastEventOccDate_.ValueStr);
            
            this.pastEventOccValue_ = serial_ConstUpperBarrierInfo.PastEventOccValue_.ValueStr;
            
            this.refVariableFlag_eventOccDate_ = StringConverter.xmlDateToDateTime(serial_ConstUpperBarrierInfo.RefVariableFlag_eventOccDate_.ValueStr);
            
            this.refVariableFlag_eventOccValue_ = serial_ConstUpperBarrierInfo.RefVariableFlag_eventOccValue_.ValueStr;
