...
{
    public class Excel_obligations : ISerialized
    {
        public Excel_obligations() { }
        public Excel_obligations(XmlNode xmlNode)
        : base(xmlNode)
        {
        ...
        public XsdTypeToken Category_
        {
            get
            {
                ...
                {
                    throw new Exception( "category_Node no exist!");
                }
            }
            set
            {
        ...
        public XsdTypeToken NotSubordinated_
        {
            get
            {
                ...
                {
                    throw new Exception( "notSubordinated_Node no exist!");
                }
            }
            set
            {
        ...
        public XsdTypeToken NotDomesticCurrency_
        {
            get
            {
                ...
                {
                    throw new Exception( "notDomesticCurrency_Node no exist!");
                }
            }
            set
            {
        ...
        public XsdTypeToken NotDomesticLaw_
        {
            get
            {
                ...
                {
                    throw new Exception( "notDomesticLaw_Node no exist!");
                }
            }
            set
            {
        ...
        public XsdTypeToken NotDomesticIssuance_
        {
            get
            {
                ...
                {
                    throw new Exception( "notDomesticIssuance_Node no exist!");
                }
            }
            set
            {
