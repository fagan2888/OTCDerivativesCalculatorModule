...
{
    public class Excel_multiCondi_multiRng_structuredAccrualCouponSchedule : ISerialized
    {
        public Excel_multiCondi_multiRng_structuredAccrualCouponSchedule() { }
        public Excel_multiCondi_multiRng_structuredAccrualCouponSchedule(XmlNode xmlNode)
        : base(xmlNode)
        {
            ...
            XmlNodeList excel_multi_rangeNDNodeList = xmlNode.SelectNodes("excel_multi_rangeND");
            
            if (excel_multi_rangeNDNodeList != null)
            {
                this.excel_multi_rangeND_ = new List<Excel_multi_rangeND>();
                foreach (XmlNode item in excel_multi_rangeNDNodeList)
                {
                    if (item.Attributes["href"] != null || item.Attributes["id"] != null) 
                    {
                        if (item.Attributes["id"] != null) 
                        {
                            excel_multi_rangeNDIDRef_ = item.Attributes["id"].Value;
                            excel_multi_rangeND_.Add(new Excel_multi_rangeND(item));
                            IDManager.SetID(excel_multi_rangeNDIDRef_, excel_multi_rangeND_[excel_multi_rangeND_.Count - 1 ]);
                        }
                        else if (item.Attributes["href"] != null)
                        {
                            excel_multi_rangeNDIDRef_ = item.Attributes["href"].Value;
                        }
                        else
                        {
                        excel_multi_rangeND_.Add(new Excel_multi_rangeND(item));
        ...
        #region Excel_multi_rangeND_
        private List<Excel_multi_rangeND> excel_multi_rangeND_;
        public List<Excel_multi_rangeND> Excel_multi_rangeND_
        {
            get
            {
                if (this.excel_multi_rangeND_ != null)
                {
                    return this.excel_multi_rangeND_; 
                }
                else if (this.excel_multi_rangeNDIDRef_ != null)
                {
                    return this.excel_multi_rangeND_; 
                }
                else
                {
                    throw new Exception( "excel_multi_rangeND_Node no exist!");
                }
            }
            set
            {
                if (this.excel_multi_rangeND_ != value)
                {
                    this.excel_multi_rangeND_ = value;
                }
            }
        }
        #endregion
        
        public string excel_multi_rangeNDIDRef_ { get; set; }
