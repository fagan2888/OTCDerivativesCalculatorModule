...
{
    public class Excel_multiCondi_structuredCouponSchedule : ISerialized
    {
        public Excel_multiCondi_structuredCouponSchedule() { }
        public Excel_multiCondi_structuredCouponSchedule(XmlNode xmlNode)
        : base(xmlNode)
        {
