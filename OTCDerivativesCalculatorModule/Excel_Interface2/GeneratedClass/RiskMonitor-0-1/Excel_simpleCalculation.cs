...
namespace FpmlSerializedCSharp
{
    public class Excel_simpleCalculation : ISerialized
    {
        ...
        #region Excel_returnCalcInfo_CallableOption_
        private Excel_returnCalcInfo_CallableOption excel_returnCalcInfo_CallableOption_;
        public Excel_returnCalcInfo_CallableOption Excel_returnCalcInfo_CallableOption_
        {
            get
            {
                if (this.excel_returnCalcInfo_CallableOption_ != null)
                {
                    return this.excel_returnCalcInfo_CallableOption_; 
                }
                else if (this.excel_returnCalcInfo_CallableOptionIDRef_ != null)
                {
                    excel_returnCalcInfo_CallableOption_ = IDManager.getID(excel_returnCalcInfo_CallableOptionIDRef_) as Excel_returnCalcInfo_CallableOption;
                    return this.excel_returnCalcInfo_CallableOption_; 
                }
                else
                {
                    throw new Exception( "excel_returnCalcInfo_CallableOption_Node no exist!");
                }
            }
            set
            {
                if (this.excel_returnCalcInfo_CallableOption_ != value)
                {
                    this.excel_returnCalcInfo_CallableOption_ = value;
                }
            }
        }
        #endregion
        
        public string excel_returnCalcInfo_CallableOptionIDRef_ { get; set; }
