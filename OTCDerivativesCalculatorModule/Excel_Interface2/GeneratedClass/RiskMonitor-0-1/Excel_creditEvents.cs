...
{
    public class Excel_creditEvents : ISerialized
    {
        public Excel_creditEvents() { }
        public Excel_creditEvents(XmlNode xmlNode)
        : base(xmlNode)
        {
        ...
        public XsdTypeToken FailureToPay_
        {
            get
            {
                ...
                {
                    throw new Exception( "failureToPay_Node no exist!");
                }
            }
            set
            {
        ...
        public XsdTypeToken ObligationAcceleration_
        {
            get
            {
                ...
                {
                    throw new Exception( "obligationAcceleration_Node no exist!");
                }
            }
            set
            {
        ...
        public XsdTypeToken RepudiationMoratorium_
        {
            get
            {
                ...
                {
                    throw new Exception( "repudiationMoratorium_Node no exist!");
                }
            }
            set
            {
        ...
        public XsdTypeToken Restructuring_
        {
            get
            {
                ...
                {
                    throw new Exception( "restructuring_Node no exist!");
                }
            }
            set
            {
        ...
        public XsdTypeToken DefaultRequirement_
        {
            get
            {
                ...
                {
                    throw new Exception( "defaultRequirement_Node no exist!");
                }
            }
            set
            {
