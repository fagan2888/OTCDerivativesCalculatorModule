...
{
    public class Excel_noteInfo : ISerialized
    {
        public Excel_noteInfo() { }
        public Excel_noteInfo(XmlNode xmlNode)
        : base(xmlNode)
        {
            ...
            XmlNode includeNotionalPaymentNode = xmlNode.SelectSingleNode("includeNotionalPayment");
            
            if (includeNotionalPaymentNode != null)
            {
                if (includeNotionalPaymentNode.Attributes["href"] != null || includeNotionalPaymentNode.Attributes["id"] != null) 
                {
                    if (includeNotionalPaymentNode.Attributes["id"] != null) 
                    {
                        includeNotionalPaymentIDRef_ = includeNotionalPaymentNode.Attributes["id"].Value;
                        XsdTypeToken ob = new XsdTypeToken(includeNotionalPaymentNode);
                        IDManager.SetID(includeNotionalPaymentIDRef_, ob);
                    }
                    else if (includeNotionalPaymentNode.Attributes["href"] != null)
                    {
                        includeNotionalPaymentIDRef_ = includeNotionalPaymentNode.Attributes["href"].Value;
                    }
                    else
                    {
                        includeNotionalPayment_ = new XsdTypeToken(includeNotionalPaymentNode);
                    }
                }
                else
                {
        ...
        private XsdTypeToken includeNotionalPayment_;
        public XsdTypeToken IncludeNotionalPayment_
        {
            get
            {
                if (this.includeNotionalPayment_ != null)
                {
                    return this.includeNotionalPayment_; 
                }
                else if (this.includeNotionalPaymentIDRef_ != null)
                {
                    includeNotionalPayment_ = IDManager.getID(includeNotionalPaymentIDRef_) as XsdTypeToken;
                    return this.includeNotionalPayment_; 
                }
                else
                {
                    throw new Exception( "includeNotionalPayment_Node no exist!");
                }
            }
            set
            {
        ...
        public string includeNotionalPaymentIDRef_ { get; set; }
