...
{
    public class Excel_returnCalcInfo_CallableOption : ISerialized
    {
        public Excel_returnCalcInfo_CallableOption() { }
        public Excel_returnCalcInfo_CallableOption(XmlNode xmlNode)
        : base(xmlNode)
        {
