...
namespace FpmlSerializedCSharp
{
    public class Excel_swapLeg : ISerialized
    {
        ...
        #region Excel_structuredSwapLeg_
        private Excel_structuredSwapLeg excel_structuredSwapLeg_;
        public Excel_structuredSwapLeg Excel_structuredSwapLeg_
        {
            get
            {
                if (this.excel_structuredSwapLeg_ != null)
                {
                    return this.excel_structuredSwapLeg_; 
                }
                else if (this.excel_structuredSwapLegIDRef_ != null)
                {
                    excel_structuredSwapLeg_ = IDManager.getID(excel_structuredSwapLegIDRef_) as Excel_structuredSwapLeg;
                    return this.excel_structuredSwapLeg_; 
                }
                else
                {
                    throw new Exception( "excel_structuredSwapLeg_Node no exist!");
                }
            }
            set
            {
                if (this.excel_structuredSwapLeg_ != value)
                {
                    this.excel_structuredSwapLeg_ = value;
                }
            }
        }
        #endregion
        
        public string excel_structuredSwapLegIDRef_ { get; set; }
