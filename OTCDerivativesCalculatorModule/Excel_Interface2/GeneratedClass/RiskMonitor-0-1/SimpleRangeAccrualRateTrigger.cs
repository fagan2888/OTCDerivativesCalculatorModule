...
{
    public class SimpleRangeAccrualRateTrigger : ISerialized
    {
        ...
        private XsdTypeToken denumerDateNum_;
        public XsdTypeToken DenumerDateNum_
        {
            get
            {
                if (this.denumerDateNum_ != null)
                {
                    return this.denumerDateNum_; 
                }
                else if (this.denumerDateNumIDRef_ != null)
                {
                    denumerDateNum_ = IDManager.getID(denumerDateNumIDRef_) as XsdTypeToken;
                    return this.denumerDateNum_; 
                }
                else
                {
                    throw new Exception( "denumerDateNum_Node no exist!");
                }
            }
            set
            {
        ...
        public string denumerDateNumIDRef_ { get; set; }
