...
{
    public class Excel_compositeOption : ISerialized
    {
        public Excel_compositeOption() { }
        ...
        #region Excel_compositeOption_subtype_
        private List<Excel_compositeOption_subtype> excel_compositeOption_subtype_;
        public List<Excel_compositeOption_subtype> Excel_compositeOption_subtype_
        {
            get
            {
                if (this.excel_compositeOption_subtype_ != null)
                {
                    return this.excel_compositeOption_subtype_; 
                }
                else if (this.excel_compositeOption_subtypeIDRef_ != null)
                {
                    return this.excel_compositeOption_subtype_; 
                }
                else
                {
                    throw new Exception( "excel_compositeOption_subtype_Node no exist!");
                }
            }
            set
            {
                if (this.excel_compositeOption_subtype_ != value)
                {
                    this.excel_compositeOption_subtype_ = value;
                }
            }
        }
        #endregion
        
        public string excel_compositeOption_subtypeIDRef_ { get; set; }
