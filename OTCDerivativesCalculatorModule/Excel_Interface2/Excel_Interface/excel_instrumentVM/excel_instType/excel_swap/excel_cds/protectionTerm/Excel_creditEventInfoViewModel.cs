...
namespace Excel_Interface
{
    public class Excel_creditEventInfoViewModel : IXmlData
    {
        ...
        {
            this.excel_issueInfoViewModel_ = new Excel_swapLegInfoViewModel();
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            xmlWriter.WriteStartElement("excel_creditEventInfo");
                ...
                this.excel_referenceInformationListViewModel_.buildXml(xmlWriter);
                this.excel_jointProbabilityTraitViewModel_.buildXml(xmlWriter);
                this.excel_protectionTermsViewModel_.buildXml(xmlWriter);
