...
namespace Excel_Interface
{
    public class Excel_referenceCalcInfo_paraViewModel : IXmlData
    {
        ...
        public  void buildXml(System.Xml.XmlWriter xmlWriter)
        {
            ...
            foreach (var item in this.excel_referenceInfo_paraViewModel_)
            {
        ...
        public  void setFromSerial(FpmlSerializedCSharp.ISerialized serial_Class)
        {
            ...
            foreach (var item in serial_excel_referenceInfo_para)
            {
                ...
                Excel_referenceInfo_paraViewModel viewModel = new Excel_referenceInfo_paraViewModel();//.CreateExcel_referenceInfo_para(type);
