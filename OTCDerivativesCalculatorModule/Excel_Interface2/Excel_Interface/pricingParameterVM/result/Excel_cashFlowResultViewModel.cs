...
namespace Excel_Interface
{
    public class Excel_cashFlowResultViewModel : IXmlData
    {
        ...
        public string vba_description()
        {
            ...
            str += "seq=" + this.seq_ + ";";
            str += "eventDate=" + StringConverter.xmlDateTimeToDateString(this.eventDate_) + ";";
            str += "payoffDate=" + StringConverter.xmlDateTimeToDateString(this.payoffDate_) + ";";
            str += "type=" + this.type_ + ";";
            str += "currency=" + this.currency_ + ";";
            str += "cashFlow=" + this.cashFlow_ + ";";
            str += "yield=" + this.yield_+ ";";
            str += "discount=" + this.discount_ + ";";
            str += "exProb=" + this.exProb_+ ";";
            str += "notionalPayment=" + this.notionalPayment_+ ";";
            str += "value=" + this.value_ + ";";
