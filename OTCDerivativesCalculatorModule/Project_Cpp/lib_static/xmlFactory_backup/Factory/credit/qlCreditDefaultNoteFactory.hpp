#ifndef xmlFactory_qlCreditDefaultNoteFactory_hpp
#define xmlFactory_qlCreditDefaultNoteFactory_hpp
...
namespace XmlFactory {
	...
	class qlCreditDefaultNoteFactory {
		public:
			qlCreditDefaultNoteFactory(const std::string& instInfoStr,
