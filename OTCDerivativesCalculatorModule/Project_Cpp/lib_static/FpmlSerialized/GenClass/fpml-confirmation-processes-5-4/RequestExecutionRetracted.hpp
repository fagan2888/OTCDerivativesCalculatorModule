// RequestExecutionRetracted.hpp 
#ifndef FpmlSerialized_RequestExecutionRetracted_hpp
#define FpmlSerialized_RequestExecutionRetracted_hpp
...
class RequestExecutionRetracted : public NonCorrectableRequestMessage { 
   public: 
       RequestExecutionRetracted(TiXmlNode* xmlNode);
