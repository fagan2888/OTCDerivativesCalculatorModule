// ExecutionAdvice.hpp 
#ifndef FpmlSerialized_ExecutionAdvice_hpp
#define FpmlSerialized_ExecutionAdvice_hpp
...
class ExecutionAdvice : public CorrectableRequestMessage { 
   public: 
       ExecutionAdvice(TiXmlNode* xmlNode);
