// ConfirmationAgreed.hpp 
#ifndef FpmlSerialized_ConfirmationAgreed_hpp
#define FpmlSerialized_ConfirmationAgreed_hpp
...
class ConfirmationAgreed : public ResponseMessage { 
   public: 
       ConfirmationAgreed(TiXmlNode* xmlNode);
