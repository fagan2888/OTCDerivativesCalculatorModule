// RequestExecution.hpp 
#ifndef FpmlSerialized_RequestExecution_hpp
#define FpmlSerialized_RequestExecution_hpp
...
class RequestExecution : public CorrectableRequestMessage { 
   public: 
       RequestExecution(TiXmlNode* xmlNode);
