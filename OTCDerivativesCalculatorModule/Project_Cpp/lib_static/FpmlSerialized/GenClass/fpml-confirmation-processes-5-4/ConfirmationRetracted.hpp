// ConfirmationRetracted.hpp 
#ifndef FpmlSerialized_ConfirmationRetracted_hpp
#define FpmlSerialized_ConfirmationRetracted_hpp
...
class ConfirmationRetracted : public NonCorrectableRequestMessage { 
   public: 
       ConfirmationRetracted(TiXmlNode* xmlNode);
