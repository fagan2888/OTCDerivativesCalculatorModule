// ExecutionNotification.hpp 
#ifndef FpmlSerialized_ExecutionNotification_hpp
#define FpmlSerialized_ExecutionNotification_hpp
...
class ExecutionNotification : public CorrectableRequestMessage { 
   public: 
       ExecutionNotification(TiXmlNode* xmlNode);
