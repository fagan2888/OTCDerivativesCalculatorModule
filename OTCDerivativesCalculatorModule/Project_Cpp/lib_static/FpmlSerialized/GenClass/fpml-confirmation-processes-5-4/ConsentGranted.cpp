...
ConsentGranted::ConsentGranted(TiXmlNode* xmlNode)
   ...
   if(portfolioReferenceNode)
   {
      if(portfolioReferenceNode->Attribute("href") || portfolioReferenceNode->Attribute("id"))
      {
          if(portfolioReferenceNode->Attribute("id"))
          {
             ...
             portfolioReference_ = boost::shared_ptr<PortfolioReferenceBase>(new PortfolioReferenceBase(portfolioReferenceNode));
      ...
      else { portfolioReference_ = boost::shared_ptr<PortfolioReferenceBase>(new PortfolioReferenceBase(portfolioReferenceNode));}
   }
...
boost::shared_ptr<PortfolioReferenceBase> ConsentGranted::getPortfolioReference()
{
   if(!this->portfolioReferenceIsNull_){
        if(portfolioReferenceIDRef_ != ""){
             return boost::shared_static_cast<PortfolioReferenceBase>(IDManager::instance().getID(portfolioReferenceIDRef_));
        }else{
   ...
   {
      QL_FAIL("null Ptr");
      return boost::shared_ptr<PortfolioReferenceBase>();
   }
}
boost::shared_ptr<OriginatingEvent> ConsentGranted::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ConsentGranted::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ConsentGranted::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ConsentGranted::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ConsentGranted::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ConsentGranted::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ConsentGranted::getNovation()
{
...
boost::shared_ptr<OptionExercise> ConsentGranted::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ConsentGranted::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ConsentGranted::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ConsentGranted::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ConsentGranted::getAdditionalEvent()
{
...
boost::shared_ptr<TradeReferenceInformation> ConsentGranted::getTradeReferenceInformation()
{
...
std::vector<boost::shared_ptr<Party>> ConsentGranted::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ConsentGranted::getAccount()
{
