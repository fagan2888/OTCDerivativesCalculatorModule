...
RequestConsent::RequestConsent(TiXmlNode* xmlNode)
   ...
   if(requestedActionNode)
   {
      if(requestedActionNode->Attribute("href") || requestedActionNode->Attribute("id"))
      {
          if(requestedActionNode->Attribute("id"))
          {
             ...
             requestedAction_ = boost::shared_ptr<RequestedAction>(new RequestedAction(requestedActionNode));
      ...
      else { requestedAction_ = boost::shared_ptr<RequestedAction>(new RequestedAction(requestedActionNode));}
   }
...
boost::shared_ptr<RequestedAction> RequestConsent::getRequestedAction()
{
   if(!this->requestedActionIsNull_){
        if(requestedActionIDRef_ != ""){
             return boost::shared_static_cast<RequestedAction>(IDManager::instance().getID(requestedActionIDRef_));
        }else{
   ...
   {
      QL_FAIL("null Ptr");
      return boost::shared_ptr<RequestedAction>();
   }
}
boost::shared_ptr<PortfolioReference> RequestConsent::getPortfolioReference()
{
...
boost::shared_ptr<CompressionActivity> RequestConsent::getCompressionActivity()
{
...
boost::shared_ptr<OriginatingEvent> RequestConsent::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> RequestConsent::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> RequestConsent::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> RequestConsent::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> RequestConsent::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> RequestConsent::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> RequestConsent::getNovation()
{
...
boost::shared_ptr<OptionExercise> RequestConsent::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> RequestConsent::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> RequestConsent::getDeClear()
{
...
boost::shared_ptr<Withdrawal> RequestConsent::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> RequestConsent::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<BasicQuotation>> RequestConsent::getQuote()
{
...
std::vector<boost::shared_ptr<Party>> RequestConsent::getParty()
{
...
std::vector<boost::shared_ptr<Account>> RequestConsent::getAccount()
{
