...
ExecutionAdvice::ExecutionAdvice(TiXmlNode* xmlNode)
...
boost::shared_ptr<ProductType> ExecutionAdvice::getProductType()
{
...
boost::shared_ptr<OriginatingEvent> ExecutionAdvice::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ExecutionAdvice::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ExecutionAdvice::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ExecutionAdvice::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ExecutionAdvice::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ExecutionAdvice::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ExecutionAdvice::getNovation()
{
...
boost::shared_ptr<OptionExercise> ExecutionAdvice::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ExecutionAdvice::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ExecutionAdvice::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ExecutionAdvice::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ExecutionAdvice::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<BasicQuotation>> ExecutionAdvice::getQuote()
{
...
std::vector<boost::shared_ptr<PaymentDetails>> ExecutionAdvice::getPaymentDetails()
{
...
std::vector<boost::shared_ptr<Party>> ExecutionAdvice::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ExecutionAdvice::getAccount()
{
