// RequestConfirmation.hpp 
#ifndef FpmlSerialized_RequestConfirmation_hpp
#define FpmlSerialized_RequestConfirmation_hpp
...
class RequestConfirmation : public CorrectableRequestMessage { 
   public: 
       RequestConfirmation(TiXmlNode* xmlNode);
