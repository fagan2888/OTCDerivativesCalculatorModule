// ExecutionAdviceRetracted.hpp 
#ifndef FpmlSerialized_ExecutionAdviceRetracted_hpp
#define FpmlSerialized_ExecutionAdviceRetracted_hpp
...
class ExecutionAdviceRetracted : public NonCorrectableRequestMessage { 
   public: 
       ExecutionAdviceRetracted(TiXmlNode* xmlNode);
