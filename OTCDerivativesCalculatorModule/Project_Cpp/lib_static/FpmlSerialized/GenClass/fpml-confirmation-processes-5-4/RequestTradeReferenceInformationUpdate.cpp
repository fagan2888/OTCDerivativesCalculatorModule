// RequestTradeReferenceInformationUpdate.cpp 
#include "RequestTradeReferenceInformationUpdate.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
RequestTradeReferenceInformationUpdate::RequestTradeReferenceInformationUpdate(TiXmlNode* xmlNode)
...
boost::shared_ptr<TradeReferenceInformation> RequestTradeReferenceInformationUpdate::getTradeReferenceInformation()
{
...
std::vector<boost::shared_ptr<Party>> RequestTradeReferenceInformationUpdate::getParty()
{
...
std::vector<boost::shared_ptr<Account>> RequestTradeReferenceInformationUpdate::getAccount()
{
