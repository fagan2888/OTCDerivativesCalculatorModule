// ConfirmationRetracted.cpp 
#include "ConfirmationRetracted.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ConfirmationRetracted::ConfirmationRetracted(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> ConfirmationRetracted::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ConfirmationRetracted::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ConfirmationRetracted::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ConfirmationRetracted::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ConfirmationRetracted::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ConfirmationRetracted::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ConfirmationRetracted::getNovation()
{
...
boost::shared_ptr<OptionExercise> ConfirmationRetracted::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ConfirmationRetracted::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ConfirmationRetracted::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ConfirmationRetracted::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ConfirmationRetracted::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<Party>> ConfirmationRetracted::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ConfirmationRetracted::getAccount()
{
