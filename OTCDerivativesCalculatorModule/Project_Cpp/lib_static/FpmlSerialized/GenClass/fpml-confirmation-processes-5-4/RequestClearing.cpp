...
RequestClearing::RequestClearing(TiXmlNode* xmlNode)
...
boost::shared_ptr<PortfolioReference> RequestClearing::getPortfolioReference()
{
...
boost::shared_ptr<OriginatingEvent> RequestClearing::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> RequestClearing::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> RequestClearing::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> RequestClearing::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> RequestClearing::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> RequestClearing::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> RequestClearing::getNovation()
{
...
boost::shared_ptr<OptionExercise> RequestClearing::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> RequestClearing::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> RequestClearing::getDeClear()
{
...
boost::shared_ptr<Withdrawal> RequestClearing::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> RequestClearing::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<BasicQuotation>> RequestClearing::getQuote()
{
...
std::vector<boost::shared_ptr<Party>> RequestClearing::getParty()
{
...
std::vector<boost::shared_ptr<Account>> RequestClearing::getAccount()
{
