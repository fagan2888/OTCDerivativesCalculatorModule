// ConfirmationAgreed.cpp 
#include "ConfirmationAgreed.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ConfirmationAgreed::ConfirmationAgreed(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> ConfirmationAgreed::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ConfirmationAgreed::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ConfirmationAgreed::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ConfirmationAgreed::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ConfirmationAgreed::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ConfirmationAgreed::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ConfirmationAgreed::getNovation()
{
...
boost::shared_ptr<OptionExercise> ConfirmationAgreed::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ConfirmationAgreed::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ConfirmationAgreed::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ConfirmationAgreed::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ConfirmationAgreed::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<Party>> ConfirmationAgreed::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ConfirmationAgreed::getAccount()
{
