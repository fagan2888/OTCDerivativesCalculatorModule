// ConsentGranted.hpp 
#ifndef FpmlSerialized_ConsentGranted_hpp
#define FpmlSerialized_ConsentGranted_hpp
...
class ConsentGranted : public ResponseMessage { 
   public: 
       ConsentGranted(TiXmlNode* xmlNode);

       bool isPortfolioReference(){return this->portfolioReferenceIsNull_;}
       boost::shared_ptr<PortfolioReferenceBase> getPortfolioReference();
   ...
   protected: 
       boost::shared_ptr<PortfolioReferenceBase> portfolioReference_;
