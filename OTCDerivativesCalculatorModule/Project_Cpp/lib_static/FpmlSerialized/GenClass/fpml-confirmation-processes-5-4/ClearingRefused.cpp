...
ClearingRefused::ClearingRefused(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> ClearingRefused::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ClearingRefused::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ClearingRefused::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ClearingRefused::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ClearingRefused::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ClearingRefused::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ClearingRefused::getNovation()
{
...
boost::shared_ptr<OptionExercise> ClearingRefused::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ClearingRefused::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ClearingRefused::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ClearingRefused::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ClearingRefused::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<BasicQuotation>> ClearingRefused::getQuote()
{
...
std::vector<boost::shared_ptr<Party>> ClearingRefused::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ClearingRefused::getAccount()
{
...
std::vector<boost::shared_ptr<Reason>> ClearingRefused::getReason()
{
