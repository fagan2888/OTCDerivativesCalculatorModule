// RequestClearing.hpp 
#ifndef FpmlSerialized_RequestClearing_hpp
#define FpmlSerialized_RequestClearing_hpp
...
class RequestClearing : public CorrectableRequestMessage { 
   public: 
       RequestClearing(TiXmlNode* xmlNode);
