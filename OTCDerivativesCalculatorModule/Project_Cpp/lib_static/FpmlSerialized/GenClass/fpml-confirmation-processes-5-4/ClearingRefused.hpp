// ClearingRefused.hpp 
#ifndef FpmlSerialized_ClearingRefused_hpp
#define FpmlSerialized_ClearingRefused_hpp
...
class ClearingRefused : public NotificationMessage { 
   public: 
       ClearingRefused(TiXmlNode* xmlNode);
