// ExecutionNotification.cpp 
#include "ExecutionNotification.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ExecutionNotification::ExecutionNotification(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> ExecutionNotification::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ExecutionNotification::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ExecutionNotification::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ExecutionNotification::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ExecutionNotification::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ExecutionNotification::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ExecutionNotification::getNovation()
{
...
boost::shared_ptr<OptionExercise> ExecutionNotification::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ExecutionNotification::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ExecutionNotification::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ExecutionNotification::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ExecutionNotification::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<BasicQuotation>> ExecutionNotification::getQuote()
{
...
std::vector<boost::shared_ptr<Party>> ExecutionNotification::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ExecutionNotification::getAccount()
{
