// ExecutionRetracted.cpp 
#include "ExecutionRetracted.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ExecutionRetracted::ExecutionRetracted(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> ExecutionRetracted::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ExecutionRetracted::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ExecutionRetracted::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ExecutionRetracted::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ExecutionRetracted::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ExecutionRetracted::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ExecutionRetracted::getNovation()
{
...
boost::shared_ptr<OptionExercise> ExecutionRetracted::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ExecutionRetracted::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ExecutionRetracted::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ExecutionRetracted::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ExecutionRetracted::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<Party>> ExecutionRetracted::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ExecutionRetracted::getAccount()
{
