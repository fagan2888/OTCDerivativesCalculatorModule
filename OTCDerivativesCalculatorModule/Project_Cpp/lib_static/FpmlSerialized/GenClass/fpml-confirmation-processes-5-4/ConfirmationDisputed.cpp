// ConfirmationDisputed.cpp 
#include "ConfirmationDisputed.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
boost::shared_ptr<OriginatingEvent> ConfirmationDisputed::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ConfirmationDisputed::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ConfirmationDisputed::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ConfirmationDisputed::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ConfirmationDisputed::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ConfirmationDisputed::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ConfirmationDisputed::getNovation()
{
...
boost::shared_ptr<OptionExercise> ConfirmationDisputed::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ConfirmationDisputed::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ConfirmationDisputed::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ConfirmationDisputed::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ConfirmationDisputed::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<Party>> ConfirmationDisputed::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ConfirmationDisputed::getAccount()
{
...
std::vector<boost::shared_ptr<Reason>> ConfirmationDisputed::getReason()
{
