// ClearingConfirmed.hpp 
#ifndef FpmlSerialized_ClearingConfirmed_hpp
#define FpmlSerialized_ClearingConfirmed_hpp
...
#include <fpml-confirmation-processes-5-4/Clearing.hpp>
...
class ClearingConfirmed : public NotificationMessage { 
   public: 
       ClearingConfirmed(TiXmlNode* xmlNode);
      ...
      std::string getAdditionalEventIDRef(){return additionalEventIDRef_;}
       ...
       bool isClearing(){return this->clearingIsNull_;}
       boost::shared_ptr<Clearing> getClearing();
      std::string getClearingIDRef(){return clearingIDRef_;}
   ...
   protected: 
       ...
       bool additionalEventIsNull_;
         boost::shared_ptr<Clearing> clearing_;     //choice
       std::string clearingIDRef_;
       bool clearingIsNull_;
