// RequestConsentRetracted.cpp 
#include "RequestConsentRetracted.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
RequestConsentRetracted::RequestConsentRetracted(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> RequestConsentRetracted::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> RequestConsentRetracted::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> RequestConsentRetracted::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> RequestConsentRetracted::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> RequestConsentRetracted::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> RequestConsentRetracted::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> RequestConsentRetracted::getNovation()
{
...
boost::shared_ptr<OptionExercise> RequestConsentRetracted::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> RequestConsentRetracted::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> RequestConsentRetracted::getDeClear()
{
...
boost::shared_ptr<Withdrawal> RequestConsentRetracted::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> RequestConsentRetracted::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<Party>> RequestConsentRetracted::getParty()
{
...
std::vector<boost::shared_ptr<Account>> RequestConsentRetracted::getAccount()
{
