// RequestExecution.cpp 
#include "RequestExecution.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
RequestExecution::RequestExecution(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> RequestExecution::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> RequestExecution::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> RequestExecution::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> RequestExecution::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> RequestExecution::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> RequestExecution::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> RequestExecution::getNovation()
{
...
boost::shared_ptr<OptionExercise> RequestExecution::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> RequestExecution::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> RequestExecution::getDeClear()
{
...
boost::shared_ptr<Withdrawal> RequestExecution::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> RequestExecution::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<Party>> RequestExecution::getParty()
{
...
std::vector<boost::shared_ptr<Account>> RequestExecution::getAccount()
{
