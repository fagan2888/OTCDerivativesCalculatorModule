// ExecutionAdviceRetracted.cpp 
#include "ExecutionAdviceRetracted.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ExecutionAdviceRetracted::ExecutionAdviceRetracted(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> ExecutionAdviceRetracted::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ExecutionAdviceRetracted::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ExecutionAdviceRetracted::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ExecutionAdviceRetracted::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ExecutionAdviceRetracted::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ExecutionAdviceRetracted::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ExecutionAdviceRetracted::getNovation()
{
...
boost::shared_ptr<OptionExercise> ExecutionAdviceRetracted::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ExecutionAdviceRetracted::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ExecutionAdviceRetracted::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ExecutionAdviceRetracted::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ExecutionAdviceRetracted::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<PaymentDetails>> ExecutionAdviceRetracted::getPaymentDetails()
{
...
std::vector<boost::shared_ptr<Party>> ExecutionAdviceRetracted::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ExecutionAdviceRetracted::getAccount()
{
