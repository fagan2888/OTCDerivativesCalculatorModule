// RequestClearingRetracted.cpp 
#include "RequestClearingRetracted.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
RequestClearingRetracted::RequestClearingRetracted(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> RequestClearingRetracted::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> RequestClearingRetracted::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> RequestClearingRetracted::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> RequestClearingRetracted::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> RequestClearingRetracted::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> RequestClearingRetracted::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> RequestClearingRetracted::getNovation()
{
...
boost::shared_ptr<OptionExercise> RequestClearingRetracted::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> RequestClearingRetracted::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> RequestClearingRetracted::getDeClear()
{
...
boost::shared_ptr<Withdrawal> RequestClearingRetracted::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> RequestClearingRetracted::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<Party>> RequestClearingRetracted::getParty()
{
...
std::vector<boost::shared_ptr<Account>> RequestClearingRetracted::getAccount()
{
