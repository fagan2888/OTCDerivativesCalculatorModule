// RequestClearingRetracted.hpp 
#ifndef FpmlSerialized_RequestClearingRetracted_hpp
#define FpmlSerialized_RequestClearingRetracted_hpp
...
class RequestClearingRetracted : public NonCorrectableRequestMessage { 
   public: 
       RequestClearingRetracted(TiXmlNode* xmlNode);
