// RequestAllocationRetracted.cpp 
#include "RequestAllocationRetracted.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
RequestAllocationRetracted::RequestAllocationRetracted(TiXmlNode* xmlNode)
...
boost::shared_ptr<TradeIdentifier> RequestAllocationRetracted::getBlockTradeIdentifier()
{
...
boost::shared_ptr<Allocations> RequestAllocationRetracted::getAllocations()
{
...
std::vector<boost::shared_ptr<Party>> RequestAllocationRetracted::getParty()
{
...
std::vector<boost::shared_ptr<Account>> RequestAllocationRetracted::getAccount()
{
