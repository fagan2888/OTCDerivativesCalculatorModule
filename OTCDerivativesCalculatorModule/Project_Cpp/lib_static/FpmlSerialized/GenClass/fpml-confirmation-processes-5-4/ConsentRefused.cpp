...
ConsentRefused::ConsentRefused(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> ConsentRefused::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> ConsentRefused::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> ConsentRefused::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> ConsentRefused::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> ConsentRefused::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> ConsentRefused::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> ConsentRefused::getNovation()
{
...
boost::shared_ptr<OptionExercise> ConsentRefused::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> ConsentRefused::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> ConsentRefused::getDeClear()
{
...
boost::shared_ptr<Withdrawal> ConsentRefused::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> ConsentRefused::getAdditionalEvent()
{
...
boost::shared_ptr<TradeReferenceInformation> ConsentRefused::getTradeReferenceInformation()
{
...
std::vector<boost::shared_ptr<Party>> ConsentRefused::getParty()
{
...
std::vector<boost::shared_ptr<Account>> ConsentRefused::getAccount()
{
...
std::vector<boost::shared_ptr<Reason>> ConsentRefused::getReason()
{
