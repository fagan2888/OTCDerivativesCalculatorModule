// RequestConsentRetracted.hpp 
#ifndef FpmlSerialized_RequestConsentRetracted_hpp
#define FpmlSerialized_RequestConsentRetracted_hpp
...
class RequestConsentRetracted : public NonCorrectableRequestMessage { 
   public: 
       RequestConsentRetracted(TiXmlNode* xmlNode);
