// ConsentRefused.hpp 
#ifndef FpmlSerialized_ConsentRefused_hpp
#define FpmlSerialized_ConsentRefused_hpp
...
class ConsentRefused : public ResponseMessage { 
   public: 
       ConsentRefused(TiXmlNode* xmlNode);
