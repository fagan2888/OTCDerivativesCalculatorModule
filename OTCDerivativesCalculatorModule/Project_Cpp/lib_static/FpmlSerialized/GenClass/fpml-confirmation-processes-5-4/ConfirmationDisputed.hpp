// ConfirmationDisputed.hpp 
#ifndef FpmlSerialized_ConfirmationDisputed_hpp
#define FpmlSerialized_ConfirmationDisputed_hpp
...
class ConfirmationDisputed : public ResponseMessage { 
   public: 
       ConfirmationDisputed(TiXmlNode* xmlNode);
