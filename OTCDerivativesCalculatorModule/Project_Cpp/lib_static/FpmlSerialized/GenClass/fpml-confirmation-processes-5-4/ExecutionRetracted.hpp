// ExecutionRetracted.hpp 
#ifndef FpmlSerialized_ExecutionRetracted_hpp
#define FpmlSerialized_ExecutionRetracted_hpp
...
class ExecutionRetracted : public NonCorrectableRequestMessage { 
   public: 
       ExecutionRetracted(TiXmlNode* xmlNode);
