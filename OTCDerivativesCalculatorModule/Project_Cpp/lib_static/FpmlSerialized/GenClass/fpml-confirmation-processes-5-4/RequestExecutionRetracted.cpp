// RequestExecutionRetracted.cpp 
#include "RequestExecutionRetracted.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
RequestExecutionRetracted::RequestExecutionRetracted(TiXmlNode* xmlNode)
...
boost::shared_ptr<OriginatingEvent> RequestExecutionRetracted::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> RequestExecutionRetracted::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> RequestExecutionRetracted::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> RequestExecutionRetracted::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> RequestExecutionRetracted::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> RequestExecutionRetracted::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> RequestExecutionRetracted::getNovation()
{
...
boost::shared_ptr<OptionExercise> RequestExecutionRetracted::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> RequestExecutionRetracted::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> RequestExecutionRetracted::getDeClear()
{
...
boost::shared_ptr<Withdrawal> RequestExecutionRetracted::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> RequestExecutionRetracted::getAdditionalEvent()
{
...
std::vector<boost::shared_ptr<Party>> RequestExecutionRetracted::getParty()
{
...
std::vector<boost::shared_ptr<Account>> RequestExecutionRetracted::getAccount()
{
