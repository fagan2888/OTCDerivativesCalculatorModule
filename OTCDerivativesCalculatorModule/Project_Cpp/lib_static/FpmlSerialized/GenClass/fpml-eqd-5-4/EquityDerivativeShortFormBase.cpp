// EquityDerivativeShortFormBase.cpp 
#include "EquityDerivativeShortFormBase.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
EquityDerivativeShortFormBase::EquityDerivativeShortFormBase(TiXmlNode* xmlNode)
...
boost::shared_ptr<EquityStrike> EquityDerivativeShortFormBase::getStrike()
{
...
boost::shared_ptr<NonNegativeDecimal> EquityDerivativeShortFormBase::getSpotPrice()
{
...
boost::shared_ptr<NonNegativeDecimal> EquityDerivativeShortFormBase::getNumberOfOptions()
{
...
boost::shared_ptr<EquityPremium> EquityDerivativeShortFormBase::getEquityPremium()
{
