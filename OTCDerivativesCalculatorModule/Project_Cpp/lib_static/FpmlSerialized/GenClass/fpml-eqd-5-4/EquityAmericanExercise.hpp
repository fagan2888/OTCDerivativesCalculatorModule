// EquityAmericanExercise.hpp 
#ifndef FpmlSerialized_EquityAmericanExercise_hpp
#define FpmlSerialized_EquityAmericanExercise_hpp
...
class EquityAmericanExercise : public SharedAmericanExercise { 
   public: 
       EquityAmericanExercise(TiXmlNode* xmlNode);
