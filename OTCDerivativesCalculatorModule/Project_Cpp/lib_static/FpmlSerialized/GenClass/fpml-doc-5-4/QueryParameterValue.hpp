#ifndef FpmlSerialized_QueryParameterValue_hpp
#define FpmlSerialized_QueryParameterValue_hpp
...
class QueryParameterValue : public ISerialized {

   public:
       QueryParameterValue(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
