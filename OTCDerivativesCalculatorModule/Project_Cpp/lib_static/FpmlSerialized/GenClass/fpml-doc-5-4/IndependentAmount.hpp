// IndependentAmount.hpp 
#ifndef FpmlSerialized_IndependentAmount_hpp
#define FpmlSerialized_IndependentAmount_hpp

#include <ISerialized.hpp>
#include <fpml-shared-5-4/PartyReference.hpp>
#include <fpml-shared-5-4/AccountReference.hpp>
#include <fpml-doc-5-4/PaymentDetail.hpp>

namespace FpmlSerialized {

class IndependentAmount : public ISerialized { 
   public: 
       IndependentAmount(TiXmlNode* xmlNode);
      ...
      std::string getReceiverAccountReferenceIDRef(){return receiverAccountReferenceIDRef_;}
       ...
       bool isPaymentDetail(){return this->paymentDetailIsNull_;}
       std::vector<boost::shared_ptr<PaymentDetail>> getPaymentDetail();
      std::string getPaymentDetailIDRef(){return paymentDetailIDRef_;}
   ...
   protected: 
       ...
       std::vector<boost::shared_ptr<PaymentDetail>> paymentDetail_;
       std::string paymentDetailIDRef_;
       bool paymentDetailIsNull_;
