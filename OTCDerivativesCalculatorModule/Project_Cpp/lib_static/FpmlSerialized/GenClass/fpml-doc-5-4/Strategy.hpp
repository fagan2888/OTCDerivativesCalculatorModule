// Strategy.hpp 
#ifndef FpmlSerialized_Strategy_hpp
#define FpmlSerialized_Strategy_hpp

#include <fpml-shared-5-4/Product.hpp>
#include <fpml-doc-5-4/StrategyComponentIdentification.hpp>
...
class Strategy : public Product { 
   public: 
       Strategy(TiXmlNode* xmlNode);

       bool isStrategyComponentIdentifier(){return this->strategyComponentIdentifierIsNull_;}
       std::vector<boost::shared_ptr<StrategyComponentIdentification>> getStrategyComponentIdentifier();
      std::string getStrategyComponentIdentifierIDRef(){return strategyComponentIdentifierIDRef_;}
   ...
   protected: 
       std::vector<boost::shared_ptr<StrategyComponentIdentification>> strategyComponentIdentifier_;
       std::string strategyComponentIdentifierIDRef_;
       bool strategyComponentIdentifierIsNull_;
