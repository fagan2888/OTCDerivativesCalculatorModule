...
Strategy::Strategy(TiXmlNode* xmlNode)
: Product(xmlNode)
{
    #ifdef ConsolePrint
    ...
    #endif 
   //strategyComponentIdentifierNode ----------------------------------------------------------------------------------------------------------------------
   TiXmlElement* strategyComponentIdentifierNode = xmlNode->FirstChildElement("strategyComponentIdentifier");

   if(strategyComponentIdentifierNode){strategyComponentIdentifierIsNull_ = false;}
   else{strategyComponentIdentifierIsNull_ = true;}

   if(strategyComponentIdentifierNode)
   {
      for(strategyComponentIdentifierNode; strategyComponentIdentifierNode; strategyComponentIdentifierNode = strategyComponentIdentifierNode->NextSiblingElement("strategyComponentIdentifier")){
          #ifdef ConsolePrint
              FileManager::instance().outFile_ << FileManager::instance().tap_.c_str() << "- strategyComponentIdentifierNode , address : " << strategyComponentIdentifierNode << std::endl;
          #endif
          if(strategyComponentIdentifierNode->Attribute("href") || strategyComponentIdentifierNode->Attribute("id"))
          {
              if(strategyComponentIdentifierNode->Attribute("id"))
              {
                  strategyComponentIdentifierIDRef_ = strategyComponentIdentifierNode->Attribute("id");
                  strategyComponentIdentifier_.push_back(boost::shared_ptr<StrategyComponentIdentification>(new StrategyComponentIdentification(strategyComponentIdentifierNode)));
                  strategyComponentIdentifier_.back()->setID(strategyComponentIdentifierIDRef_);
                  IDManager::instance().setID(strategyComponentIdentifierIDRef_, strategyComponentIdentifier_.back());
              }
              else if(strategyComponentIdentifierNode->Attribute("href")) { strategyComponentIdentifierIDRef_ = strategyComponentIdentifierNode->Attribute("href");}
              else { QL_FAIL("id or href error"); }
          }
          else { strategyComponentIdentifier_.push_back(boost::shared_ptr<StrategyComponentIdentification>(new StrategyComponentIdentification(strategyComponentIdentifierNode)));}
      }
   }
   else {
       #ifdef ConsolePrint
...
std::vector<boost::shared_ptr<StrategyComponentIdentification>> Strategy::getStrategyComponentIdentifier()
{
   if(!this->strategyComponentIdentifierIsNull_){
        if(strategyComponentIdentifierIDRef_ != ""){
   ...
   {
      QL_FAIL("null Ptr");
      return std::vector<boost::shared_ptr<StrategyComponentIdentification>>();
   }
}
boost::shared_ptr<ProductReference> Strategy::getPremiumProductReference()
{
...
boost::shared_ptr<Product> Strategy::getProduct()
{
...
boost::shared_ptr<ForwardSale> Strategy::getForward()
{
...
boost::shared_ptr<BondOption> Strategy::getBondOption()
{
...
boost::shared_ptr<CreditDefaultSwap> Strategy::getCreditDefaultSwap()
{
...
boost::shared_ptr<CreditDefaultSwapOption> Strategy::getCreditDefaultSwapOption()
{
...
boost::shared_ptr<CommodityForward> Strategy::getCommodityForward()
{
...
boost::shared_ptr<CommodityOption> Strategy::getCommodityOption()
{
...
boost::shared_ptr<CommoditySwap> Strategy::getCommoditySwap()
{
...
boost::shared_ptr<CommoditySwaption> Strategy::getCommoditySwaption()
{
...
boost::shared_ptr<CorrelationSwap> Strategy::getCorrelationSwap()
{
...
boost::shared_ptr<DividendSwapOptionTransactionSupplement> Strategy::getDividendSwapOptionTransactionSupplement()
{
...
boost::shared_ptr<DividendSwapTransactionSupplement> Strategy::getDividendSwapTransactionSupplement()
{
...
boost::shared_ptr<InstrumentTradeDetails> Strategy::getInstrumentTradeDetails()
{
...
boost::shared_ptr<Strategy> Strategy::getStrategy()
{
...
boost::shared_ptr<ReturnSwap> Strategy::getReturnSwap()
{
...
boost::shared_ptr<BrokerEquityOption> Strategy::getBrokerEquityOption()
{
...
boost::shared_ptr<EquityForward> Strategy::getEquityForward()
{
...
boost::shared_ptr<EquityOption> Strategy::getEquityOption()
{
...
boost::shared_ptr<EquityOptionTransactionSupplement> Strategy::getEquityOptionTransactionSupplement()
{
...
boost::shared_ptr<FxSingleLeg> Strategy::getFxSingleLeg()
{
...
boost::shared_ptr<FxSwap> Strategy::getFxSwap()
{
...
boost::shared_ptr<FxOption> Strategy::getFxOption()
{
...
boost::shared_ptr<FxDigitalOption> Strategy::getFxDigitalOption()
{
...
boost::shared_ptr<TermDeposit> Strategy::getTermDeposit()
{
...
boost::shared_ptr<GenericProduct> Strategy::getGenericProduct()
{
...
boost::shared_ptr<GenericProduct> Strategy::getNonSchemaProduct()
{
...
boost::shared_ptr<BulletPayment> Strategy::getBulletPayment()
{
...
boost::shared_ptr<CapFloor> Strategy::getCapFloor()
{
...
boost::shared_ptr<Fra> Strategy::getFra()
{
   if(!this->fraIsNull_){
        if(fraIDRef_ != ""){
...
boost::shared_ptr<Swap> Strategy::getSwap()
{
   if(!this->swapIsNull_){
        if(swapIDRef_ != ""){
...
boost::shared_ptr<Swaption> Strategy::getSwaption()
{
...
boost::shared_ptr<EquitySwapTransactionSupplement> Strategy::getEquitySwapTransactionSupplement()
{
...
boost::shared_ptr<StandardProduct> Strategy::getStandardProduct()
{
...
boost::shared_ptr<VarianceOptionTransactionSupplement> Strategy::getVarianceOptionTransactionSupplement()
{
...
boost::shared_ptr<VarianceSwap> Strategy::getVarianceSwap()
{
...
boost::shared_ptr<VarianceSwapTransactionSupplement> Strategy::getVarianceSwapTransactionSupplement()
{
