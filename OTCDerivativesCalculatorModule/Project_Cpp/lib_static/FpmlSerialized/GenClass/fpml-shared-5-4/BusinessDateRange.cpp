// BusinessDateRange.cpp 
#include "BusinessDateRange.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
BusinessDateRange::BusinessDateRange(TiXmlNode* xmlNode)
: DateRange(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<BusinessDayConventionEnum> BusinessDateRange::getBusinessDayConvention()
{
...
boost::shared_ptr<BusinessCentersReference> BusinessDateRange::getBusinessCentersReference()
{
...
boost::shared_ptr<BusinessCenters> BusinessDateRange::getBusinessCenters()
{
