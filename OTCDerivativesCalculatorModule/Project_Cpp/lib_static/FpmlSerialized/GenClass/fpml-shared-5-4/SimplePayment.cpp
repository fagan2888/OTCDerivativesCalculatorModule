...
SimplePayment::SimplePayment(TiXmlNode* xmlNode)
: PaymentBase(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<PartyReference> SimplePayment::getPayerPartyReference()
{
...
boost::shared_ptr<AccountReference> SimplePayment::getPayerAccountReference()
{
...
boost::shared_ptr<PartyReference> SimplePayment::getReceiverPartyReference()
{
...
boost::shared_ptr<AccountReference> SimplePayment::getReceiverAccountReference()
{
...
boost::shared_ptr<NonNegativeMoney> SimplePayment::getPaymentAmount()
{
...
boost::shared_ptr<AdjustableOrRelativeDate> SimplePayment::getPaymentDate()
{
