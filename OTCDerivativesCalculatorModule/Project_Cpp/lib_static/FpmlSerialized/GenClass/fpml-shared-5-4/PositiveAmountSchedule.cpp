// PositiveAmountSchedule.cpp 
#include "PositiveAmountSchedule.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
PositiveAmountSchedule::PositiveAmountSchedule(TiXmlNode* xmlNode)
: PositiveSchedule(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Currency> PositiveAmountSchedule::getCurrency()
{
