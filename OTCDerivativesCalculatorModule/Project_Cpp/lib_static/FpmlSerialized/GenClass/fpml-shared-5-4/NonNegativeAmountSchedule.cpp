// NonNegativeAmountSchedule.cpp 
#include "NonNegativeAmountSchedule.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
NonNegativeAmountSchedule::NonNegativeAmountSchedule(TiXmlNode* xmlNode)
: NonNegativeSchedule(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Currency> NonNegativeAmountSchedule::getCurrency()
{
