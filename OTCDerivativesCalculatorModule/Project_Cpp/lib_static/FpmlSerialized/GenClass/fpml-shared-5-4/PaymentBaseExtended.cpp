// PaymentBaseExtended.cpp 
#include "PaymentBaseExtended.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
PaymentBaseExtended::PaymentBaseExtended(TiXmlNode* xmlNode)
: PaymentBase(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<PartyReference> PaymentBaseExtended::getPayerPartyReference()
{
...
boost::shared_ptr<AccountReference> PaymentBaseExtended::getPayerAccountReference()
{
...
boost::shared_ptr<PartyReference> PaymentBaseExtended::getReceiverPartyReference()
{
...
boost::shared_ptr<AccountReference> PaymentBaseExtended::getReceiverAccountReference()
{
...
boost::shared_ptr<AdjustableOrRelativeDate> PaymentBaseExtended::getPaymentDate()
{
