#ifndef FpmlSerialized_NonNegativeDecimal_hpp
#define FpmlSerialized_NonNegativeDecimal_hpp
...
class NonNegativeDecimal : public ISerialized {

   public:
       NonNegativeDecimal(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
