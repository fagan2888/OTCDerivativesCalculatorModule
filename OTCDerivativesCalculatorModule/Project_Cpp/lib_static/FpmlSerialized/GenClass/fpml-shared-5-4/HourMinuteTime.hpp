#ifndef FpmlSerialized_HourMinuteTime_hpp
#define FpmlSerialized_HourMinuteTime_hpp
...
class HourMinuteTime : public ISerialized {

   public:
       HourMinuteTime(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
