#ifndef FpmlSerialized_PositiveDecimal_hpp
#define FpmlSerialized_PositiveDecimal_hpp
...
class PositiveDecimal : public ISerialized {

   public:
       PositiveDecimal(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
