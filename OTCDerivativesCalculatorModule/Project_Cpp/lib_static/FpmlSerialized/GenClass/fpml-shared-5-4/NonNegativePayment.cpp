// NonNegativePayment.cpp 
#include "NonNegativePayment.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
NonNegativePayment::NonNegativePayment(TiXmlNode* xmlNode)
...
boost::shared_ptr<NonNegativeMoney> NonNegativePayment::getPaymentAmount()
{
