// BusinessDateRange.hpp 
#ifndef FpmlSerialized_BusinessDateRange_hpp
#define FpmlSerialized_BusinessDateRange_hpp
...
class BusinessDateRange : public DateRange { 
   public: 
       BusinessDateRange(TiXmlNode* xmlNode);
