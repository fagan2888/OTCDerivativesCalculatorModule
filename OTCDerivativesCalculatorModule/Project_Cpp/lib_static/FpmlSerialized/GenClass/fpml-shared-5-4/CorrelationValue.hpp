#ifndef FpmlSerialized_CorrelationValue_hpp
#define FpmlSerialized_CorrelationValue_hpp
...
class CorrelationValue : public ISerialized {

   public:
       CorrelationValue(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
