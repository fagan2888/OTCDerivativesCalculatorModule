// BasicQuotation.hpp 
#ifndef FpmlSerialized_BasicQuotation_hpp
#define FpmlSerialized_BasicQuotation_hpp
...
class BasicQuotation : public ISerialized { 
   public: 
       BasicQuotation(TiXmlNode* xmlNode);
