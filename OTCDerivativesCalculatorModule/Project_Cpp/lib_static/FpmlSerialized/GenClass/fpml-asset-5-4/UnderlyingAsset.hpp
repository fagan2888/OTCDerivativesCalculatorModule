// UnderlyingAsset.hpp 
#ifndef FpmlSerialized_UnderlyingAsset_hpp
#define FpmlSerialized_UnderlyingAsset_hpp
...
class UnderlyingAsset : public IdentifiedAsset { 
   public: 
       UnderlyingAsset(TiXmlNode* xmlNode);
   ...
   protected: 
       boost::shared_ptr<IdentifiedCurrency> currency_;
