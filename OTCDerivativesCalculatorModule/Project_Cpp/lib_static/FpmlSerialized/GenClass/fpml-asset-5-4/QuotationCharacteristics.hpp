// QuotationCharacteristics.hpp 
#ifndef FpmlSerialized_QuotationCharacteristics_hpp
#define FpmlSerialized_QuotationCharacteristics_hpp
...
class QuotationCharacteristics : public ISerialized { 
   public: 
       QuotationCharacteristics(TiXmlNode* xmlNode);
