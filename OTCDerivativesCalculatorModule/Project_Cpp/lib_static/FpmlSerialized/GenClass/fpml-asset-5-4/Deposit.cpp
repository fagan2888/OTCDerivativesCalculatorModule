...
Deposit::Deposit(TiXmlNode* xmlNode)
...
boost::shared_ptr<Period> Deposit::getTerm()
{
   if(!this->termIsNull_){
        if(termIDRef_ != ""){
...
boost::shared_ptr<Period> Deposit::getPaymentFrequency()
{
...
boost::shared_ptr<DayCountFraction> Deposit::getDayCountFraction()
{
