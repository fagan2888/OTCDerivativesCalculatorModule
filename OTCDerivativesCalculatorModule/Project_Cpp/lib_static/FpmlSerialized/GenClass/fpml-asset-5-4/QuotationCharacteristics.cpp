// QuotationCharacteristics.cpp 
#include "QuotationCharacteristics.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
QuotationCharacteristics::QuotationCharacteristics(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<AssetMeasureType> QuotationCharacteristics::getMeasureType()
{
...
boost::shared_ptr<PriceQuoteUnits> QuotationCharacteristics::getQuoteUnits()
{
...
boost::shared_ptr<QuotationSideEnum> QuotationCharacteristics::getSide()
{
   if(!this->sideIsNull_){
        if(sideIDRef_ != ""){
...
boost::shared_ptr<Currency> QuotationCharacteristics::getCurrency()
{
...
boost::shared_ptr<ReportingCurrencyType> QuotationCharacteristics::getCurrencyType()
{
...
boost::shared_ptr<QuoteTiming> QuotationCharacteristics::getTiming()
{
...
boost::shared_ptr<BusinessCenter> QuotationCharacteristics::getBusinessCenter()
{
...
boost::shared_ptr<ExchangeId> QuotationCharacteristics::getExchangeId()
{
...
std::vector<boost::shared_ptr<InformationSource>> QuotationCharacteristics::getInformationSource()
{
...
boost::shared_ptr<PricingModel> QuotationCharacteristics::getPricingModel()
{
...
boost::shared_ptr<XsdTypeDateTime> QuotationCharacteristics::getTime()
{
   if(!this->timeIsNull_){
        if(timeIDRef_ != ""){
...
boost::shared_ptr<XsdTypeDate> QuotationCharacteristics::getValuationDate()
{
...
boost::shared_ptr<XsdTypeDateTime> QuotationCharacteristics::getExpiryTime()
{
...
boost::shared_ptr<CashflowType> QuotationCharacteristics::getCashflowType()
{
