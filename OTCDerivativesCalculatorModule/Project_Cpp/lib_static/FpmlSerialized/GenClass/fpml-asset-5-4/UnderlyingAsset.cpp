...
UnderlyingAsset::UnderlyingAsset(TiXmlNode* xmlNode)
...
boost::shared_ptr<IdentifiedCurrency> UnderlyingAsset::getCurrency()
{
...
boost::shared_ptr<ExchangeId> UnderlyingAsset::getExchangeId()
{
...
boost::shared_ptr<ClearanceSystem> UnderlyingAsset::getClearanceSystem()
{
...
boost::shared_ptr<ProductReference> UnderlyingAsset::getDefinition()
{
