// CreditEventNotificationRetracted.cpp 
#include "CreditEventNotificationRetracted.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
CreditEventNotificationRetracted::CreditEventNotificationRetracted(TiXmlNode* xmlNode)
...
boost::shared_ptr<CreditEventNoticeDocument> CreditEventNotificationRetracted::getCreditEventNotice()
{
...
std::vector<boost::shared_ptr<Party>> CreditEventNotificationRetracted::getParty()
{
