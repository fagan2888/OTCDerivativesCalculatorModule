// MultiDimensionalPricingData.cpp 
#include "MultiDimensionalPricingData.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
MultiDimensionalPricingData::MultiDimensionalPricingData(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
      ...
      for(pointNode; pointNode; pointNode = pointNode->NextSiblingElement("point")){
          ...
          if(pointNode->Attribute("href") || pointNode->Attribute("id"))
          {
              if(pointNode->Attribute("id"))
              {
                  ...
                  point_.push_back(boost::shared_ptr<PricingStructurePoint>(new PricingStructurePoint(pointNode)));
          ...
          else { point_.push_back(boost::shared_ptr<PricingStructurePoint>(new PricingStructurePoint(pointNode)));}
      }
   }
   else {
       #ifdef ConsolePrint
...
boost::shared_ptr<AssetMeasureType> MultiDimensionalPricingData::getMeasureType()
{
...
boost::shared_ptr<PriceQuoteUnits> MultiDimensionalPricingData::getQuoteUnits()
{
...
boost::shared_ptr<QuotationSideEnum> MultiDimensionalPricingData::getSide()
{
   if(!this->sideIsNull_){
        if(sideIDRef_ != ""){
...
boost::shared_ptr<Currency> MultiDimensionalPricingData::getCurrency()
{
...
boost::shared_ptr<ReportingCurrencyType> MultiDimensionalPricingData::getCurrencyType()
{
...
boost::shared_ptr<QuoteTiming> MultiDimensionalPricingData::getTiming()
{
...
boost::shared_ptr<BusinessCenter> MultiDimensionalPricingData::getBusinessCenter()
{
...
boost::shared_ptr<ExchangeId> MultiDimensionalPricingData::getExchangeId()
{
...
std::vector<boost::shared_ptr<InformationSource>> MultiDimensionalPricingData::getInformationSource()
{
...
boost::shared_ptr<PricingModel> MultiDimensionalPricingData::getPricingModel()
{
...
boost::shared_ptr<XsdTypeDateTime> MultiDimensionalPricingData::getTime()
{
   if(!this->timeIsNull_){
        if(timeIDRef_ != ""){
...
boost::shared_ptr<XsdTypeDate> MultiDimensionalPricingData::getValuationDate()
{
...
boost::shared_ptr<XsdTypeDateTime> MultiDimensionalPricingData::getExpiryTime()
{
...
boost::shared_ptr<CashflowType> MultiDimensionalPricingData::getCashflowType()
{
...
std::vector<boost::shared_ptr<PricingStructurePoint>> MultiDimensionalPricingData::getPoint()
{
   ...
   {
      QL_FAIL("null Ptr");
      return std::vector<boost::shared_ptr<PricingStructurePoint>>();
   }
}
}
