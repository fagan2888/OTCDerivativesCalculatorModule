// DividendSwapOptionTransactionSupplement.hpp 
#ifndef FpmlSerialized_DividendSwapOptionTransactionSupplement_hpp
#define FpmlSerialized_DividendSwapOptionTransactionSupplement_hpp
...
class DividendSwapOptionTransactionSupplement : public OptionBase { 
   public: 
       DividendSwapOptionTransactionSupplement(TiXmlNode* xmlNode);
   ...
   protected: 
       ...
       boost::shared_ptr<DividendSwapTransactionSupplement> dividendSwapTransactionSupplement_;
