#ifndef FpmlSerialized_JointTimeTypeEnum_hpp
#define FpmlSerialized_JointTimeTypeEnum_hpp
...
class JointTimeTypeEnum : public ISerialized {

   public:
       JointTimeTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
