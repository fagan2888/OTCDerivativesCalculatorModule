// UpDownEventCheck.cpp 
#include "UpDownEventCheck.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
UpDownEventCheck::UpDownEventCheck(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeDouble> UpDownEventCheck::getCheckValue()
{
...
boost::shared_ptr<XsdTypeBoolean> UpDownEventCheck::getEquality()
{
