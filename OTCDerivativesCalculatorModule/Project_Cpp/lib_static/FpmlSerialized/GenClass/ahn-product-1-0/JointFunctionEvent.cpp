// JointFunctionEvent.cpp 
#include "JointFunctionEvent.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
JointFunctionEvent::JointFunctionEvent(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<JointTypeEnum> JointFunctionEvent::getJointType()
{
...
boost::shared_ptr<Functions> JointFunctionEvent::getFunctions()
{
