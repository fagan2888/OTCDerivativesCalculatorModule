...
boost::shared_ptr<XsdTypeToken> InterestrateIndex::getCode()
{
   if(!this->codeIsNull_){
        if(codeIDRef_ != ""){
...
boost::shared_ptr<XsdTypeToken> InterestrateIndex::getName()
{
   if(!this->nameIsNull_){
        if(nameIDRef_ != ""){
...
boost::shared_ptr<XsdTypeToken> InterestrateIndex::getIndexType()
{
