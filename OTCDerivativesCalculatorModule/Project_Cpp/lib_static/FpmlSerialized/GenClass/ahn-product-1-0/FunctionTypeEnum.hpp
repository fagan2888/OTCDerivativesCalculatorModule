#ifndef FpmlSerialized_FunctionTypeEnum_hpp
#define FpmlSerialized_FunctionTypeEnum_hpp
...
class FunctionTypeEnum : public ISerialized {

   public:
       FunctionTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
