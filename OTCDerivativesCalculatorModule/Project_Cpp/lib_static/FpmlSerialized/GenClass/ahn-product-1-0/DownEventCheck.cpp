...
DownEventCheck::DownEventCheck(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeDouble> DownEventCheck::getCheckValue()
{
...
boost::shared_ptr<XsdTypeBoolean> DownEventCheck::getEquality()
{
