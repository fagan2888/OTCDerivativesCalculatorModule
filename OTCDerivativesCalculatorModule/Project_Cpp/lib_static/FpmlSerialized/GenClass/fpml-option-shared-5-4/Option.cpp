...
Option::Option(TiXmlNode* xmlNode)
: Product(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<PartyReference> Option::getBuyerPartyReference()
{
...
boost::shared_ptr<AccountReference> Option::getBuyerAccountReference()
{
...
boost::shared_ptr<PartyReference> Option::getSellerPartyReference()
{
...
boost::shared_ptr<AccountReference> Option::getSellerAccountReference()
{
