// SinglePartyOption.cpp 
#include "SinglePartyOption.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
SinglePartyOption::SinglePartyOption(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<PartyReference> SinglePartyOption::getBuyerPartyReference()
{
...
boost::shared_ptr<AccountReference> SinglePartyOption::getBuyerAccountReference()
{
...
boost::shared_ptr<PartyReference> SinglePartyOption::getSellerPartyReference()
{
...
boost::shared_ptr<AccountReference> SinglePartyOption::getSellerAccountReference()
{
