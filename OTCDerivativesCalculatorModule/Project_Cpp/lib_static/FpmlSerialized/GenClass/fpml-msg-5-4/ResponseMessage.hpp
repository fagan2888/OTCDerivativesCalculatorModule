// ResponseMessage.hpp 
#ifndef FpmlSerialized_ResponseMessage_hpp
#define FpmlSerialized_ResponseMessage_hpp

#include <fpml-msg-5-4/Message.hpp>
#include <fpml-msg-5-4/ResponseMessageHeader.hpp>
...
class ResponseMessage : public Message { 
   public: 
       ResponseMessage(TiXmlNode* xmlNode);

       bool isHeader(){return this->headerIsNull_;}
       boost::shared_ptr<ResponseMessageHeader> getHeader();
   ...
   protected: 
       boost::shared_ptr<ResponseMessageHeader> header_;
