// ResponseMessageHeader.cpp 
#include "ResponseMessageHeader.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ResponseMessageHeader::ResponseMessageHeader(TiXmlNode* xmlNode)
...
boost::shared_ptr<MessageId> ResponseMessageHeader::getInReplyTo()
{
...
boost::shared_ptr<MessageAddress> ResponseMessageHeader::getSentBy()
{
...
std::vector<boost::shared_ptr<MessageAddress>> ResponseMessageHeader::getSendTo()
{
...
std::vector<boost::shared_ptr<MessageAddress>> ResponseMessageHeader::getCopyTo()
{
...
boost::shared_ptr<XsdTypeDateTime> ResponseMessageHeader::getCreationTimestamp()
{
...
boost::shared_ptr<XsdTypeDateTime> ResponseMessageHeader::getExpiryTimestamp()
{
...
boost::shared_ptr<ImplementationSpecification> ResponseMessageHeader::getImplementationSpecification()
{
...
std::vector<boost::shared_ptr<PartyMessageInformation>> ResponseMessageHeader::getPartyMessageInformation()
{
...
boost::shared_ptr<SignatureType> ResponseMessageHeader::getSignature()
{
