// ExceptionMessageHeader.hpp 
#ifndef FpmlSerialized_ExceptionMessageHeader_hpp
#define FpmlSerialized_ExceptionMessageHeader_hpp
...
class ExceptionMessageHeader : public MessageHeader { 
   public: 
       ExceptionMessageHeader(TiXmlNode* xmlNode);
