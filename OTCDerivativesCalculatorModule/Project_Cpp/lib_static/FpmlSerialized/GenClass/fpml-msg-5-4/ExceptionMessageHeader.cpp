// ExceptionMessageHeader.cpp 
#include "ExceptionMessageHeader.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ExceptionMessageHeader::ExceptionMessageHeader(TiXmlNode* xmlNode)
...
boost::shared_ptr<MessageId> ExceptionMessageHeader::getInReplyTo()
{
...
boost::shared_ptr<MessageAddress> ExceptionMessageHeader::getSentBy()
{
...
std::vector<boost::shared_ptr<MessageAddress>> ExceptionMessageHeader::getSendTo()
{
...
std::vector<boost::shared_ptr<MessageAddress>> ExceptionMessageHeader::getCopyTo()
{
...
boost::shared_ptr<XsdTypeDateTime> ExceptionMessageHeader::getCreationTimestamp()
{
...
boost::shared_ptr<XsdTypeDateTime> ExceptionMessageHeader::getExpiryTimestamp()
{
...
boost::shared_ptr<ImplementationSpecification> ExceptionMessageHeader::getImplementationSpecification()
{
...
std::vector<boost::shared_ptr<PartyMessageInformation>> ExceptionMessageHeader::getPartyMessageInformation()
{
...
boost::shared_ptr<SignatureType> ExceptionMessageHeader::getSignature()
{
