// ResponseMessageHeader.hpp 
#ifndef FpmlSerialized_ResponseMessageHeader_hpp
#define FpmlSerialized_ResponseMessageHeader_hpp
...
class ResponseMessageHeader : public MessageHeader { 
   public: 
       ResponseMessageHeader(TiXmlNode* xmlNode);
