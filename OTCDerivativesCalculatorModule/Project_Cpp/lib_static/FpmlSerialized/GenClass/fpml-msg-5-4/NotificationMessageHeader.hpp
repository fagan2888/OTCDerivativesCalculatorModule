// NotificationMessageHeader.hpp 
#ifndef FpmlSerialized_NotificationMessageHeader_hpp
#define FpmlSerialized_NotificationMessageHeader_hpp
...
class NotificationMessageHeader : public MessageHeader { 
   public: 
       NotificationMessageHeader(TiXmlNode* xmlNode);

       bool isInReplyTo(){return this->inReplyToIsNull_;}
       boost::shared_ptr<MessageId> getInReplyTo();
      std::string getInReplyToIDRef(){return inReplyToIDRef_;}
   ...
   protected: 
       boost::shared_ptr<MessageId> inReplyTo_;
       std::string inReplyToIDRef_;
       bool inReplyToIsNull_;
