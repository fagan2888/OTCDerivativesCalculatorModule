// ForwardSale.hpp 
#ifndef FpmlSerialized_ForwardSale_hpp
#define FpmlSerialized_ForwardSale_hpp
...
class ForwardSale : public Product { 
   public: 
       ForwardSale(TiXmlNode* xmlNode);
      ...
      std::string getMutualFundIDRef(){return mutualFundIDRef_;}
       ...
       bool isForwardSaleDate(){return this->forwardSaleDateIsNull_;}
       boost::shared_ptr<XsdTypeDate> getForwardSaleDate();
      std::string getForwardSaleDateIDRef(){return forwardSaleDateIDRef_;}

       bool isSettlement(){return this->settlementIsNull_;}
       boost::shared_ptr<Payment> getSettlement();
      std::string getSettlementIDRef(){return settlementIDRef_;}

       bool isPrice(){return this->priceIsNull_;}
       boost::shared_ptr<Price> getPrice();
   ...
   protected: 
       ...
       boost::shared_ptr<XsdTypeDate> forwardSaleDate_;
       std::string forwardSaleDateIDRef_;
       bool forwardSaleDateIsNull_;
       boost::shared_ptr<Payment> settlement_;
       std::string settlementIDRef_;
       bool settlementIsNull_;
       boost::shared_ptr<Price> price_;
