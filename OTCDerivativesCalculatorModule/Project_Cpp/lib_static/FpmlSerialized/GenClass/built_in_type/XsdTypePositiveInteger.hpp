#ifndef FpmlSerialized_XsdTypePositiveInteger_hpp
#define FpmlSerialized_XsdTypePositiveInteger_hpp
...
class XsdTypePositiveInteger : public ISerialized {

   public:
       XsdTypePositiveInteger(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
