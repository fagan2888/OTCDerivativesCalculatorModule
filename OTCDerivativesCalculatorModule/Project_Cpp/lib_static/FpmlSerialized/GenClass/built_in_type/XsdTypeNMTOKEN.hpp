#ifndef FpmlSerialized_XsdTypeNMTOKEN_hpp
#define FpmlSerialized_XsdTypeNMTOKEN_hpp
...
class XsdTypeNMTOKEN : public ISerialized {

   public:
       XsdTypeNMTOKEN(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
