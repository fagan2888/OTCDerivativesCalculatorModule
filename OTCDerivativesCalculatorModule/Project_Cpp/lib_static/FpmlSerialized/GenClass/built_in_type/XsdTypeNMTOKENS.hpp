#ifndef FpmlSerialized_XsdTypeNMTOKENS_hpp
#define FpmlSerialized_XsdTypeNMTOKENS_hpp
...
class XsdTypeNMTOKENS : public ISerialized {

   public:
       XsdTypeNMTOKENS(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
