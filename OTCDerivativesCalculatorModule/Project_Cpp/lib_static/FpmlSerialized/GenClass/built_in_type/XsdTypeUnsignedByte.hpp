#ifndef FpmlSerialized_XsdTypeUnsignedByte_hpp
#define FpmlSerialized_XsdTypeUnsignedByte_hpp
...
class XsdTypeUnsignedByte : public ISerialized {

   public:
       XsdTypeUnsignedByte(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
