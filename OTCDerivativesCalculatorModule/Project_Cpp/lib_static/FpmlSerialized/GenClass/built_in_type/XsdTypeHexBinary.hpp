#ifndef FpmlSerialized_XsdTypeHexBinary_hpp
#define FpmlSerialized_XsdTypeHexBinary_hpp
...
class XsdTypeHexBinary : public ISerialized {

   public:
       XsdTypeHexBinary(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
