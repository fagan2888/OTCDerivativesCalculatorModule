#ifndef FpmlSerialized_XsdTypeGYearMonth_hpp
#define FpmlSerialized_XsdTypeGYearMonth_hpp
...
class XsdTypeGYearMonth : public ISerialized {

   public:
       XsdTypeGYearMonth(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
