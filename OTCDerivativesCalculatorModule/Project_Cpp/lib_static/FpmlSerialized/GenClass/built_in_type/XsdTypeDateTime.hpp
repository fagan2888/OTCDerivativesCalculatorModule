#ifndef FpmlSerialized_XsdTypeDateTime_hpp
#define FpmlSerialized_XsdTypeDateTime_hpp
...
class XsdTypeDateTime : public ISerialized {

   public:
       XsdTypeDateTime(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
