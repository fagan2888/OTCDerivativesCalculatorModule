#ifndef FpmlSerialized_XsdTypeENTITIES_hpp
#define FpmlSerialized_XsdTypeENTITIES_hpp
...
class XsdTypeENTITIES : public ISerialized {

   public:
       XsdTypeENTITIES(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
