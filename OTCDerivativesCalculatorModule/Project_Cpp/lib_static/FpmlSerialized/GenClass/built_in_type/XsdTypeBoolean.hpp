#ifndef FpmlSerialized_XsdTypeBoolean_hpp
#define FpmlSerialized_XsdTypeBoolean_hpp
...
class XsdTypeBoolean : public ISerialized {

   public:
       XsdTypeBoolean(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
