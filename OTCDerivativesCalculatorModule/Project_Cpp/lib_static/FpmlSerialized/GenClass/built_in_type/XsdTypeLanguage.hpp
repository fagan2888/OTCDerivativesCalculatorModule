#ifndef FpmlSerialized_XsdTypeLanguage_hpp
#define FpmlSerialized_XsdTypeLanguage_hpp
...
class XsdTypeLanguage : public ISerialized {

   public:
       XsdTypeLanguage(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
