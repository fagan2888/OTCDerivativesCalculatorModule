#ifndef FpmlSerialized_XsdTypeNormalizedString_hpp
#define FpmlSerialized_XsdTypeNormalizedString_hpp
...
class XsdTypeNormalizedString : public ISerialized {

   public:
       XsdTypeNormalizedString(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
