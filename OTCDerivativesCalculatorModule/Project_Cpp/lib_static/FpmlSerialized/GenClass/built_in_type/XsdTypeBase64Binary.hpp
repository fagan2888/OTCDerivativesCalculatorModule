#ifndef FpmlSerialized_XsdTypeBase64Binary_hpp
#define FpmlSerialized_XsdTypeBase64Binary_hpp
...
class XsdTypeBase64Binary : public ISerialized {

   public:
       XsdTypeBase64Binary(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
