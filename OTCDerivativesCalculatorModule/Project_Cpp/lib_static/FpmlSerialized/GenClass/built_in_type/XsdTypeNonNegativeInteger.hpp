#ifndef FpmlSerialized_XsdTypeNonNegativeInteger_hpp
#define FpmlSerialized_XsdTypeNonNegativeInteger_hpp
...
class XsdTypeNonNegativeInteger : public ISerialized {

   public:
       XsdTypeNonNegativeInteger(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
