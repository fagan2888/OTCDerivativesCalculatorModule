#ifndef FpmlSerialized_XsdTypeUnsignedInt_hpp
#define FpmlSerialized_XsdTypeUnsignedInt_hpp
...
class XsdTypeUnsignedInt : public ISerialized {

   public:
       XsdTypeUnsignedInt(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
