#ifndef FpmlSerialized_XsdTypeGMonthDay_hpp
#define FpmlSerialized_XsdTypeGMonthDay_hpp
...
class XsdTypeGMonthDay : public ISerialized {

   public:
       XsdTypeGMonthDay(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
