...
EventsChoice::EventsChoice(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<OriginatingEvent> EventsChoice::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> EventsChoice::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> EventsChoice::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> EventsChoice::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> EventsChoice::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> EventsChoice::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> EventsChoice::getNovation()
{
...
boost::shared_ptr<OptionExercise> EventsChoice::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> EventsChoice::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> EventsChoice::getDeClear()
{
...
boost::shared_ptr<Withdrawal> EventsChoice::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> EventsChoice::getAdditionalEvent()
{
