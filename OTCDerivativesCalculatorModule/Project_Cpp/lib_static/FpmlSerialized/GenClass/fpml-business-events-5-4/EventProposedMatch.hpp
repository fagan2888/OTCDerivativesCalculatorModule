// EventProposedMatch.hpp 
#ifndef FpmlSerialized_EventProposedMatch_hpp
#define FpmlSerialized_EventProposedMatch_hpp
...
#include <fpml-shared-5-4/MatchId.hpp>
#include <fpml-doc-5-4/TradeDifference.hpp>
#include <built_in_type/XsdTypeDecimal.hpp>

namespace FpmlSerialized {

class EventProposedMatch : public ISerialized { 
   public: 
       EventProposedMatch(TiXmlNode* xmlNode);
      ...
      std::string getAdditionalEventIDRef(){return additionalEventIDRef_;}
       ...
       bool isMatchId(){return this->matchIdIsNull_;}
       boost::shared_ptr<MatchId> getMatchId();
      std::string getMatchIdIDRef(){return matchIdIDRef_;}

       bool isDifference(){return this->differenceIsNull_;}
       std::vector<boost::shared_ptr<TradeDifference>> getDifference();
      std::string getDifferenceIDRef(){return differenceIDRef_;}

       bool isMatchScore(){return this->matchScoreIsNull_;}
       boost::shared_ptr<XsdTypeDecimal> getMatchScore();
      std::string getMatchScoreIDRef(){return matchScoreIDRef_;}
   ...
   protected: 
       ...
       boost::shared_ptr<MatchId> matchId_;
       std::string matchIdIDRef_;
       bool matchIdIsNull_;
       std::vector<boost::shared_ptr<TradeDifference>> difference_;
       std::string differenceIDRef_;
       bool differenceIsNull_;
       boost::shared_ptr<XsdTypeDecimal> matchScore_;
       std::string matchScoreIDRef_;
       bool matchScoreIsNull_;
