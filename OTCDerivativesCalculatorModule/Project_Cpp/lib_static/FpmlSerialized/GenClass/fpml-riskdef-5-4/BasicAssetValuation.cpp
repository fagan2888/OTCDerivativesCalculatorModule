// BasicAssetValuation.cpp 
#include "BasicAssetValuation.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
BasicAssetValuation::BasicAssetValuation(TiXmlNode* xmlNode)
: Valuation(xmlNode)
{
    #ifdef ConsolePrint
...
std::vector<boost::shared_ptr<BasicQuotation>> BasicAssetValuation::getQuote()
{
