#ifndef FpmlSerialized_InterestCalculationMethodEnum_hpp
#define FpmlSerialized_InterestCalculationMethodEnum_hpp
...
class InterestCalculationMethodEnum : public ISerialized {

   public:
       InterestCalculationMethodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
