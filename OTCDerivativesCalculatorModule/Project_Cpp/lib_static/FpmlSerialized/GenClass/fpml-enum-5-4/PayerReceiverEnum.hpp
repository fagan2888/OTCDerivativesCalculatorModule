#ifndef FpmlSerialized_PayerReceiverEnum_hpp
#define FpmlSerialized_PayerReceiverEnum_hpp
...
class PayerReceiverEnum : public ISerialized {

   public:
       PayerReceiverEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
