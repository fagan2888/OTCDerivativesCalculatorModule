#ifndef FpmlSerialized_PremiumTypeEnum_hpp
#define FpmlSerialized_PremiumTypeEnum_hpp
...
class PremiumTypeEnum : public ISerialized {

   public:
       PremiumTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
