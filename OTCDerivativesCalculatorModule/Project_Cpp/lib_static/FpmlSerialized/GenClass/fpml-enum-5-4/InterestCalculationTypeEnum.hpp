#ifndef FpmlSerialized_InterestCalculationTypeEnum_hpp
#define FpmlSerialized_InterestCalculationTypeEnum_hpp
...
class InterestCalculationTypeEnum : public ISerialized {

   public:
       InterestCalculationTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
