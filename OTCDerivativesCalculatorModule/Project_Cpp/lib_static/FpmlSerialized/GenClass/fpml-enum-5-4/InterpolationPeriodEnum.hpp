#ifndef FpmlSerialized_InterpolationPeriodEnum_hpp
#define FpmlSerialized_InterpolationPeriodEnum_hpp
...
class InterpolationPeriodEnum : public ISerialized {

   public:
       InterpolationPeriodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
