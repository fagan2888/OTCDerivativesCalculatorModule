#ifndef FpmlSerialized_DividendEntitlementEnum_hpp
#define FpmlSerialized_DividendEntitlementEnum_hpp
...
class DividendEntitlementEnum : public ISerialized {

   public:
       DividendEntitlementEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
