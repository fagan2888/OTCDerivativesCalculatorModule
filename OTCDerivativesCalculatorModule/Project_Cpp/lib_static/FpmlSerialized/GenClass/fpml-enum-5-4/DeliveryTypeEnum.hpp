#ifndef FpmlSerialized_DeliveryTypeEnum_hpp
#define FpmlSerialized_DeliveryTypeEnum_hpp
...
class DeliveryTypeEnum : public ISerialized {

   public:
       DeliveryTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
