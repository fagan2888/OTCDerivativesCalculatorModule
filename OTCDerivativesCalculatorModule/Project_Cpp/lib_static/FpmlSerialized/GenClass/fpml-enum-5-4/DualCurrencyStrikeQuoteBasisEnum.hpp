#ifndef FpmlSerialized_DualCurrencyStrikeQuoteBasisEnum_hpp
#define FpmlSerialized_DualCurrencyStrikeQuoteBasisEnum_hpp
...
class DualCurrencyStrikeQuoteBasisEnum : public ISerialized {

   public:
       DualCurrencyStrikeQuoteBasisEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
