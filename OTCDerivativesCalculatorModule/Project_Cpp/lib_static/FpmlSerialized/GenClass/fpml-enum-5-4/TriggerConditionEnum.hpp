#ifndef FpmlSerialized_TriggerConditionEnum_hpp
#define FpmlSerialized_TriggerConditionEnum_hpp
...
class TriggerConditionEnum : public ISerialized {

   public:
       TriggerConditionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
