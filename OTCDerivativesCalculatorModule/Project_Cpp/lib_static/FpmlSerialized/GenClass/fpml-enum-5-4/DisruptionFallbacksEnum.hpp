#ifndef FpmlSerialized_DisruptionFallbacksEnum_hpp
#define FpmlSerialized_DisruptionFallbacksEnum_hpp
...
class DisruptionFallbacksEnum : public ISerialized {

   public:
       DisruptionFallbacksEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
