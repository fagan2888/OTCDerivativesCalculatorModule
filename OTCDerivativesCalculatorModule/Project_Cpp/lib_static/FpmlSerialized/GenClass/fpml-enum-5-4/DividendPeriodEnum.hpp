#ifndef FpmlSerialized_DividendPeriodEnum_hpp
#define FpmlSerialized_DividendPeriodEnum_hpp
...
class DividendPeriodEnum : public ISerialized {

   public:
       DividendPeriodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
