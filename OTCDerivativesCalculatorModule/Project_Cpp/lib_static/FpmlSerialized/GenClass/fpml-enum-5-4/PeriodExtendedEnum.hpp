#ifndef FpmlSerialized_PeriodExtendedEnum_hpp
#define FpmlSerialized_PeriodExtendedEnum_hpp
...
class PeriodExtendedEnum : public ISerialized {

   public:
       PeriodExtendedEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
