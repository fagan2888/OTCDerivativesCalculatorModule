#ifndef FpmlSerialized_PositionStatusEnum_hpp
#define FpmlSerialized_PositionStatusEnum_hpp
...
class PositionStatusEnum : public ISerialized {

   public:
       PositionStatusEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
