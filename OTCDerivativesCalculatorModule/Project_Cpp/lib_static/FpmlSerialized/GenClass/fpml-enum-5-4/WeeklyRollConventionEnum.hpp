#ifndef FpmlSerialized_WeeklyRollConventionEnum_hpp
#define FpmlSerialized_WeeklyRollConventionEnum_hpp
...
class WeeklyRollConventionEnum : public ISerialized {

   public:
       WeeklyRollConventionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
