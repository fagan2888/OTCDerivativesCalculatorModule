#ifndef FpmlSerialized_EnvironmentalAbandonmentOfSchemeEnum_hpp
#define FpmlSerialized_EnvironmentalAbandonmentOfSchemeEnum_hpp
...
class EnvironmentalAbandonmentOfSchemeEnum : public ISerialized {

   public:
       EnvironmentalAbandonmentOfSchemeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
