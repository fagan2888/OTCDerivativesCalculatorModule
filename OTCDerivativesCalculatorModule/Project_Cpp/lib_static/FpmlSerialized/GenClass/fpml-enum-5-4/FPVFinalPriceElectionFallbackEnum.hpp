#ifndef FpmlSerialized_FPVFinalPriceElectionFallbackEnum_hpp
#define FpmlSerialized_FPVFinalPriceElectionFallbackEnum_hpp
...
class FPVFinalPriceElectionFallbackEnum : public ISerialized {

   public:
       FPVFinalPriceElectionFallbackEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
