#ifndef FpmlSerialized_SettlementPeriodDurationEnum_hpp
#define FpmlSerialized_SettlementPeriodDurationEnum_hpp
...
class SettlementPeriodDurationEnum : public ISerialized {

   public:
       SettlementPeriodDurationEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
