#ifndef FpmlSerialized_InterestMethodEnum_hpp
#define FpmlSerialized_InterestMethodEnum_hpp
...
class InterestMethodEnum : public ISerialized {

   public:
       InterestMethodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
