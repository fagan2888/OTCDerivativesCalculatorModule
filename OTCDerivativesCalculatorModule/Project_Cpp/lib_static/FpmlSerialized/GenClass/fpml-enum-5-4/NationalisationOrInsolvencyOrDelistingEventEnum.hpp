#ifndef FpmlSerialized_NationalisationOrInsolvencyOrDelistingEventEnum_hpp
#define FpmlSerialized_NationalisationOrInsolvencyOrDelistingEventEnum_hpp
...
class NationalisationOrInsolvencyOrDelistingEventEnum : public ISerialized {

   public:
       NationalisationOrInsolvencyOrDelistingEventEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
