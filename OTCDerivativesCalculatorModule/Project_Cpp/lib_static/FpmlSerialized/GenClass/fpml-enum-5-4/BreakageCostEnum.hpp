#ifndef FpmlSerialized_BreakageCostEnum_hpp
#define FpmlSerialized_BreakageCostEnum_hpp
...
class BreakageCostEnum : public ISerialized {

   public:
       BreakageCostEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
