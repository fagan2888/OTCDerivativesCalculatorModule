#ifndef FpmlSerialized_FxBarrierTypeEnum_hpp
#define FpmlSerialized_FxBarrierTypeEnum_hpp
...
class FxBarrierTypeEnum : public ISerialized {

   public:
       FxBarrierTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
