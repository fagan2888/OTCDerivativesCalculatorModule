#ifndef FpmlSerialized_EnvironmentalProductTypeEnum_hpp
#define FpmlSerialized_EnvironmentalProductTypeEnum_hpp
...
class EnvironmentalProductTypeEnum : public ISerialized {

   public:
       EnvironmentalProductTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
