#ifndef FpmlSerialized_DividendAmountTypeEnum_hpp
#define FpmlSerialized_DividendAmountTypeEnum_hpp
...
class DividendAmountTypeEnum : public ISerialized {

   public:
       DividendAmountTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
