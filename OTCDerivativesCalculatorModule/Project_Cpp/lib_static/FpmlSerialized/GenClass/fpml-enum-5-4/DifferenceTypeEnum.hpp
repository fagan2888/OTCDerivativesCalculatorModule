#ifndef FpmlSerialized_DifferenceTypeEnum_hpp
#define FpmlSerialized_DifferenceTypeEnum_hpp
...
class DifferenceTypeEnum : public ISerialized {

   public:
       DifferenceTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
