#ifndef FpmlSerialized_PositionOriginEnum_hpp
#define FpmlSerialized_PositionOriginEnum_hpp
...
class PositionOriginEnum : public ISerialized {

   public:
       PositionOriginEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
