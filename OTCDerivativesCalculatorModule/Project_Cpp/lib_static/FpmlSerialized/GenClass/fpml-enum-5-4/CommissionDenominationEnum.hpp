#ifndef FpmlSerialized_CommissionDenominationEnum_hpp
#define FpmlSerialized_CommissionDenominationEnum_hpp
...
class CommissionDenominationEnum : public ISerialized {

   public:
       CommissionDenominationEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
