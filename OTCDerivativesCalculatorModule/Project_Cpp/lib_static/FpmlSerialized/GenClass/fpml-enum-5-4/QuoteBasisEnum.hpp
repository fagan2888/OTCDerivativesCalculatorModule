#ifndef FpmlSerialized_QuoteBasisEnum_hpp
#define FpmlSerialized_QuoteBasisEnum_hpp
...
class QuoteBasisEnum : public ISerialized {

   public:
       QuoteBasisEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
