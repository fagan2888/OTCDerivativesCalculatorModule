#ifndef FpmlSerialized_ObligationCategoryEnum_hpp
#define FpmlSerialized_ObligationCategoryEnum_hpp
...
class ObligationCategoryEnum : public ISerialized {

   public:
       ObligationCategoryEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
