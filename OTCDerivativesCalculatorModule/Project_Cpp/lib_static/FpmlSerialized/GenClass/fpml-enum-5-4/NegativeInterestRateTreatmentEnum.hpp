#ifndef FpmlSerialized_NegativeInterestRateTreatmentEnum_hpp
#define FpmlSerialized_NegativeInterestRateTreatmentEnum_hpp
...
class NegativeInterestRateTreatmentEnum : public ISerialized {

   public:
       NegativeInterestRateTreatmentEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
