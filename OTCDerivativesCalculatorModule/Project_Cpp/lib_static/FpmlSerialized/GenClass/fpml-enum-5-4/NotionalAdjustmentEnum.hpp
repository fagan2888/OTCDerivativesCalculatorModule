#ifndef FpmlSerialized_NotionalAdjustmentEnum_hpp
#define FpmlSerialized_NotionalAdjustmentEnum_hpp
...
class NotionalAdjustmentEnum : public ISerialized {

   public:
       NotionalAdjustmentEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
