#ifndef FpmlSerialized_ShareExtraordinaryEventEnum_hpp
#define FpmlSerialized_ShareExtraordinaryEventEnum_hpp
...
class ShareExtraordinaryEventEnum : public ISerialized {

   public:
       ShareExtraordinaryEventEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
