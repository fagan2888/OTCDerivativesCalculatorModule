#ifndef FpmlSerialized_PremiumQuoteBasisEnum_hpp
#define FpmlSerialized_PremiumQuoteBasisEnum_hpp
...
class PremiumQuoteBasisEnum : public ISerialized {

   public:
       PremiumQuoteBasisEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
