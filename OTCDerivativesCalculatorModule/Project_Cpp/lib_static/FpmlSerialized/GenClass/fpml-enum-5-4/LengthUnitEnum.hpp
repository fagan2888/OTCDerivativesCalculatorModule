#ifndef FpmlSerialized_LengthUnitEnum_hpp
#define FpmlSerialized_LengthUnitEnum_hpp
...
class LengthUnitEnum : public ISerialized {

   public:
       LengthUnitEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
