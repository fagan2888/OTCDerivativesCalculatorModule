#ifndef FpmlSerialized_ExerciseStyleEnum_hpp
#define FpmlSerialized_ExerciseStyleEnum_hpp
...
class ExerciseStyleEnum : public ISerialized {

   public:
       ExerciseStyleEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
