#ifndef FpmlSerialized_WeatherSettlementLevelEnum_hpp
#define FpmlSerialized_WeatherSettlementLevelEnum_hpp
...
class WeatherSettlementLevelEnum : public ISerialized {

   public:
       WeatherSettlementLevelEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
