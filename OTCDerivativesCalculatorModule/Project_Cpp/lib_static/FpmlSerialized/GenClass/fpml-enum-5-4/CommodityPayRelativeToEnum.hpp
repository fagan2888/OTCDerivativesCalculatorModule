#ifndef FpmlSerialized_CommodityPayRelativeToEnum_hpp
#define FpmlSerialized_CommodityPayRelativeToEnum_hpp
...
class CommodityPayRelativeToEnum : public ISerialized {

   public:
       CommodityPayRelativeToEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
