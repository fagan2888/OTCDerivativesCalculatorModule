#ifndef FpmlSerialized_MethodOfAdjustmentEnum_hpp
#define FpmlSerialized_MethodOfAdjustmentEnum_hpp
...
class MethodOfAdjustmentEnum : public ISerialized {

   public:
       MethodOfAdjustmentEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
