#ifndef FpmlSerialized_CalendarSourceEnum_hpp
#define FpmlSerialized_CalendarSourceEnum_hpp
...
class CalendarSourceEnum : public ISerialized {

   public:
       CalendarSourceEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
