#ifndef FpmlSerialized_SpecifiedPriceEnum_hpp
#define FpmlSerialized_SpecifiedPriceEnum_hpp
...
class SpecifiedPriceEnum : public ISerialized {

   public:
       SpecifiedPriceEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
