#ifndef FpmlSerialized_QuotationRateTypeEnum_hpp
#define FpmlSerialized_QuotationRateTypeEnum_hpp
...
class QuotationRateTypeEnum : public ISerialized {

   public:
       QuotationRateTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
