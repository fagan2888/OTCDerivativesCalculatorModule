#ifndef FpmlSerialized_FraDiscountingEnum_hpp
#define FpmlSerialized_FraDiscountingEnum_hpp
...
class FraDiscountingEnum : public ISerialized {

   public:
       FraDiscountingEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
