#ifndef FpmlSerialized_DealtCurrencyEnum_hpp
#define FpmlSerialized_DealtCurrencyEnum_hpp
...
class DealtCurrencyEnum : public ISerialized {

   public:
       DealtCurrencyEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
