#ifndef FpmlSerialized_AveragingMethodEnum_hpp
#define FpmlSerialized_AveragingMethodEnum_hpp
...
class AveragingMethodEnum : public ISerialized {

   public:
       AveragingMethodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
