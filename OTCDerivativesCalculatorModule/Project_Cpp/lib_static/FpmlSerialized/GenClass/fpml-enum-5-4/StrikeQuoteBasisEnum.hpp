#ifndef FpmlSerialized_StrikeQuoteBasisEnum_hpp
#define FpmlSerialized_StrikeQuoteBasisEnum_hpp
...
class StrikeQuoteBasisEnum : public ISerialized {

   public:
       StrikeQuoteBasisEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
