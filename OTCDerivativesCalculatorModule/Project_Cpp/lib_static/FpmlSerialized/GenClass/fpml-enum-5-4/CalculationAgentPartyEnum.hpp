#ifndef FpmlSerialized_CalculationAgentPartyEnum_hpp
#define FpmlSerialized_CalculationAgentPartyEnum_hpp
...
class CalculationAgentPartyEnum : public ISerialized {

   public:
       CalculationAgentPartyEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
