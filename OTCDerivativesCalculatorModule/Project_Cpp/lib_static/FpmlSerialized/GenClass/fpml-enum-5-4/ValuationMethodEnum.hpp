#ifndef FpmlSerialized_ValuationMethodEnum_hpp
#define FpmlSerialized_ValuationMethodEnum_hpp
...
class ValuationMethodEnum : public ISerialized {

   public:
       ValuationMethodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
