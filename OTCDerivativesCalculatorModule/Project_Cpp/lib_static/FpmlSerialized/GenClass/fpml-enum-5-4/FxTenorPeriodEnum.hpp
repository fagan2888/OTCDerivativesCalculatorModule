#ifndef FpmlSerialized_FxTenorPeriodEnum_hpp
#define FpmlSerialized_FxTenorPeriodEnum_hpp
...
class FxTenorPeriodEnum : public ISerialized {

   public:
       FxTenorPeriodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
