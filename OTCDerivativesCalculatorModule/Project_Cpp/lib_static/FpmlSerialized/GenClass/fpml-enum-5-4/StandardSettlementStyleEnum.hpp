#ifndef FpmlSerialized_StandardSettlementStyleEnum_hpp
#define FpmlSerialized_StandardSettlementStyleEnum_hpp
...
class StandardSettlementStyleEnum : public ISerialized {

   public:
       StandardSettlementStyleEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
