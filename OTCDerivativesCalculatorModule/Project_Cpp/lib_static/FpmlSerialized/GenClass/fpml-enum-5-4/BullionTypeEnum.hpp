#ifndef FpmlSerialized_BullionTypeEnum_hpp
#define FpmlSerialized_BullionTypeEnum_hpp
...
class BullionTypeEnum : public ISerialized {

   public:
       BullionTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
