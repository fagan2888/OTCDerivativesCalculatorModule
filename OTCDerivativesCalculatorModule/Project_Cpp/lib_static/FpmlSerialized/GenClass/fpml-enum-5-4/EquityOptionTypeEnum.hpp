#ifndef FpmlSerialized_EquityOptionTypeEnum_hpp
#define FpmlSerialized_EquityOptionTypeEnum_hpp
...
class EquityOptionTypeEnum : public ISerialized {

   public:
       EquityOptionTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
