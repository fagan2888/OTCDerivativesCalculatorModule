#ifndef FpmlSerialized_FrequencyTypeEnum_hpp
#define FpmlSerialized_FrequencyTypeEnum_hpp
...
class FrequencyTypeEnum : public ISerialized {

   public:
       FrequencyTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
