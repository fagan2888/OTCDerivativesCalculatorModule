#ifndef FpmlSerialized_RollConventionEnum_hpp
#define FpmlSerialized_RollConventionEnum_hpp
...
class RollConventionEnum : public ISerialized {

   public:
       RollConventionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
