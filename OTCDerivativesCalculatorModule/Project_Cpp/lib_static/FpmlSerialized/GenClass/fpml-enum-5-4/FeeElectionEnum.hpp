#ifndef FpmlSerialized_FeeElectionEnum_hpp
#define FpmlSerialized_FeeElectionEnum_hpp
...
class FeeElectionEnum : public ISerialized {

   public:
       FeeElectionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
