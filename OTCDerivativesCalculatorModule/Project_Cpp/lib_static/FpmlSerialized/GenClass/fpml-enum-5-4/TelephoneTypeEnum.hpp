#ifndef FpmlSerialized_TelephoneTypeEnum_hpp
#define FpmlSerialized_TelephoneTypeEnum_hpp
...
class TelephoneTypeEnum : public ISerialized {

   public:
       TelephoneTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
