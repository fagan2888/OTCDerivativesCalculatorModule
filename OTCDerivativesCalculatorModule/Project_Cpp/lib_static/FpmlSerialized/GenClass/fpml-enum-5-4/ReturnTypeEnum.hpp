#ifndef FpmlSerialized_ReturnTypeEnum_hpp
#define FpmlSerialized_ReturnTypeEnum_hpp
...
class ReturnTypeEnum : public ISerialized {

   public:
       ReturnTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
