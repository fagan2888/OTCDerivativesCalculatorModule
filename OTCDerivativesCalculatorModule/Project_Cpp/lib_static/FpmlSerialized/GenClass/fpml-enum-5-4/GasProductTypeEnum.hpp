#ifndef FpmlSerialized_GasProductTypeEnum_hpp
#define FpmlSerialized_GasProductTypeEnum_hpp
...
class GasProductTypeEnum : public ISerialized {

   public:
       GasProductTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
