#ifndef FpmlSerialized_CommodityDayTypeEnum_hpp
#define FpmlSerialized_CommodityDayTypeEnum_hpp
...
class CommodityDayTypeEnum : public ISerialized {

   public:
       CommodityDayTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
