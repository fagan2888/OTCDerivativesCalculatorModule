#ifndef FpmlSerialized_DividendCompositionEnum_hpp
#define FpmlSerialized_DividendCompositionEnum_hpp
...
class DividendCompositionEnum : public ISerialized {

   public:
       DividendCompositionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
