#ifndef FpmlSerialized_CollateralValueAllocationEnum_hpp
#define FpmlSerialized_CollateralValueAllocationEnum_hpp
...
class CollateralValueAllocationEnum : public ISerialized {

   public:
       CollateralValueAllocationEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
