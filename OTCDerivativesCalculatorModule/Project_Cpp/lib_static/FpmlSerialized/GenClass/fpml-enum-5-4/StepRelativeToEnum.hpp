#ifndef FpmlSerialized_StepRelativeToEnum_hpp
#define FpmlSerialized_StepRelativeToEnum_hpp
...
class StepRelativeToEnum : public ISerialized {

   public:
       StepRelativeToEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
