#ifndef FpmlSerialized_RateTreatmentEnum_hpp
#define FpmlSerialized_RateTreatmentEnum_hpp
...
class RateTreatmentEnum : public ISerialized {

   public:
       RateTreatmentEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
