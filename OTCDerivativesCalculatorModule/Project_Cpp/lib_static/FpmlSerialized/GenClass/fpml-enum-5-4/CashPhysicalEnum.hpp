#ifndef FpmlSerialized_CashPhysicalEnum_hpp
#define FpmlSerialized_CashPhysicalEnum_hpp
...
class CashPhysicalEnum : public ISerialized {

   public:
       CashPhysicalEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
