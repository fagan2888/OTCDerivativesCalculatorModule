#ifndef FpmlSerialized_CompoundingMethodEnum_hpp
#define FpmlSerialized_CompoundingMethodEnum_hpp
...
class CompoundingMethodEnum : public ISerialized {

   public:
       CompoundingMethodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
