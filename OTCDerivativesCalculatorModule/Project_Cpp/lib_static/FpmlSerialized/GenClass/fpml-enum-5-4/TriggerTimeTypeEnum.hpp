#ifndef FpmlSerialized_TriggerTimeTypeEnum_hpp
#define FpmlSerialized_TriggerTimeTypeEnum_hpp
...
class TriggerTimeTypeEnum : public ISerialized {

   public:
       TriggerTimeTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
