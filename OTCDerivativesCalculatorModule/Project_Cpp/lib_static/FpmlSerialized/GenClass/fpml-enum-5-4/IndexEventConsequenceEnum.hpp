#ifndef FpmlSerialized_IndexEventConsequenceEnum_hpp
#define FpmlSerialized_IndexEventConsequenceEnum_hpp
...
class IndexEventConsequenceEnum : public ISerialized {

   public:
       IndexEventConsequenceEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
