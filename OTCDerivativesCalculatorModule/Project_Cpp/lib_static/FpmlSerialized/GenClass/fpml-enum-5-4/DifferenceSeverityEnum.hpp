#ifndef FpmlSerialized_DifferenceSeverityEnum_hpp
#define FpmlSerialized_DifferenceSeverityEnum_hpp
...
class DifferenceSeverityEnum : public ISerialized {

   public:
       DifferenceSeverityEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
