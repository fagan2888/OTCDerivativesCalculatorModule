#ifndef FpmlSerialized_BusinessDayConventionEnum_hpp
#define FpmlSerialized_BusinessDayConventionEnum_hpp
...
class BusinessDayConventionEnum : public ISerialized {

   public:
       BusinessDayConventionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
