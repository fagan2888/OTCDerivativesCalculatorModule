#ifndef FpmlSerialized_DiscountingTypeEnum_hpp
#define FpmlSerialized_DiscountingTypeEnum_hpp
...
class DiscountingTypeEnum : public ISerialized {

   public:
       DiscountingTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
