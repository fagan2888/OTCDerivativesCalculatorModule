#ifndef FpmlSerialized_RealisedVarianceMethodEnum_hpp
#define FpmlSerialized_RealisedVarianceMethodEnum_hpp
...
class RealisedVarianceMethodEnum : public ISerialized {

   public:
       RealisedVarianceMethodEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
