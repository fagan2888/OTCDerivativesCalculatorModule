#ifndef FpmlSerialized_MarkToMarketConventionEnum_hpp
#define FpmlSerialized_MarkToMarketConventionEnum_hpp
...
class MarkToMarketConventionEnum : public ISerialized {

   public:
       MarkToMarketConventionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
