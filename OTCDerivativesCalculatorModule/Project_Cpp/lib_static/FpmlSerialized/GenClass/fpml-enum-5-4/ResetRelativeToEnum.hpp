#ifndef FpmlSerialized_ResetRelativeToEnum_hpp
#define FpmlSerialized_ResetRelativeToEnum_hpp
...
class ResetRelativeToEnum : public ISerialized {

   public:
       ResetRelativeToEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
