#ifndef FpmlSerialized_StubPeriodTypeEnum_hpp
#define FpmlSerialized_StubPeriodTypeEnum_hpp
...
class StubPeriodTypeEnum : public ISerialized {

   public:
       StubPeriodTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
