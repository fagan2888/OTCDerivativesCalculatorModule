#ifndef FpmlSerialized_AveragingInOutEnum_hpp
#define FpmlSerialized_AveragingInOutEnum_hpp
...
class AveragingInOutEnum : public ISerialized {

   public:
       AveragingInOutEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
