#ifndef FpmlSerialized_DividendDateReferenceEnum_hpp
#define FpmlSerialized_DividendDateReferenceEnum_hpp
...
class DividendDateReferenceEnum : public ISerialized {

   public:
       DividendDateReferenceEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
