#ifndef FpmlSerialized_QuotationStyleEnum_hpp
#define FpmlSerialized_QuotationStyleEnum_hpp
...
class QuotationStyleEnum : public ISerialized {

   public:
       QuotationStyleEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
