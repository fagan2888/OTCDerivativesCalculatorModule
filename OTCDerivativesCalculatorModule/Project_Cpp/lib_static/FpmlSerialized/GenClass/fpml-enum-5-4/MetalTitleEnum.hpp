#ifndef FpmlSerialized_MetalTitleEnum_hpp
#define FpmlSerialized_MetalTitleEnum_hpp
...
class MetalTitleEnum : public ISerialized {

   public:
       MetalTitleEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
