#ifndef FpmlSerialized_NonCashDividendTreatmentEnum_hpp
#define FpmlSerialized_NonCashDividendTreatmentEnum_hpp
...
class NonCashDividendTreatmentEnum : public ISerialized {

   public:
       NonCashDividendTreatmentEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
