#ifndef FpmlSerialized_QuotationSideEnum_hpp
#define FpmlSerialized_QuotationSideEnum_hpp
...
class QuotationSideEnum : public ISerialized {

   public:
       QuotationSideEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
