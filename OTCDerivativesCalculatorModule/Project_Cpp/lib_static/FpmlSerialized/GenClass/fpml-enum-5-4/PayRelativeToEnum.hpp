#ifndef FpmlSerialized_PayRelativeToEnum_hpp
#define FpmlSerialized_PayRelativeToEnum_hpp
...
class PayRelativeToEnum : public ISerialized {

   public:
       PayRelativeToEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
