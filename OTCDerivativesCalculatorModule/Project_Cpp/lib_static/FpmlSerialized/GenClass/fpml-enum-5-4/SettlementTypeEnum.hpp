#ifndef FpmlSerialized_SettlementTypeEnum_hpp
#define FpmlSerialized_SettlementTypeEnum_hpp
...
class SettlementTypeEnum : public ISerialized {

   public:
       SettlementTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
