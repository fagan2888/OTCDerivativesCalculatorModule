#ifndef FpmlSerialized_OptionTypeEnum_hpp
#define FpmlSerialized_OptionTypeEnum_hpp
...
class OptionTypeEnum : public ISerialized {

   public:
       OptionTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
