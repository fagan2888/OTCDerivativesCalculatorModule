#ifndef FpmlSerialized_CommodityBullionSettlementDisruptionEnum_hpp
#define FpmlSerialized_CommodityBullionSettlementDisruptionEnum_hpp
...
class CommodityBullionSettlementDisruptionEnum : public ISerialized {

   public:
       CommodityBullionSettlementDisruptionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
