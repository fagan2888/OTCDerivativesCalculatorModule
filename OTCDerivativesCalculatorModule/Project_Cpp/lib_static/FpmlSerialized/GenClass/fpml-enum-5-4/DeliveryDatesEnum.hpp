#ifndef FpmlSerialized_DeliveryDatesEnum_hpp
#define FpmlSerialized_DeliveryDatesEnum_hpp
...
class DeliveryDatesEnum : public ISerialized {

   public:
       DeliveryDatesEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
