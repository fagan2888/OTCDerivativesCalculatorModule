#ifndef FpmlSerialized_MarketDisruptionEventsEnum_hpp
#define FpmlSerialized_MarketDisruptionEventsEnum_hpp
...
class MarketDisruptionEventsEnum : public ISerialized {

   public:
       MarketDisruptionEventsEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
