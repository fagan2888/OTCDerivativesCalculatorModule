#ifndef FpmlSerialized_TouchConditionEnum_hpp
#define FpmlSerialized_TouchConditionEnum_hpp
...
class TouchConditionEnum : public ISerialized {

   public:
       TouchConditionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
