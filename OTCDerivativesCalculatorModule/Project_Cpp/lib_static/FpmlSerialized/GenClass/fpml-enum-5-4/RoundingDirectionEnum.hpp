#ifndef FpmlSerialized_RoundingDirectionEnum_hpp
#define FpmlSerialized_RoundingDirectionEnum_hpp
...
class RoundingDirectionEnum : public ISerialized {

   public:
       RoundingDirectionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
