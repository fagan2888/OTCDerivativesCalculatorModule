#ifndef FpmlSerialized_IndependentAmountConventionEnum_hpp
#define FpmlSerialized_IndependentAmountConventionEnum_hpp
...
class IndependentAmountConventionEnum : public ISerialized {

   public:
       IndependentAmountConventionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
