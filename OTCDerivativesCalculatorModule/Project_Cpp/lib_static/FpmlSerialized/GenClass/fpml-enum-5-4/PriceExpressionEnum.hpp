#ifndef FpmlSerialized_PriceExpressionEnum_hpp
#define FpmlSerialized_PriceExpressionEnum_hpp
...
class PriceExpressionEnum : public ISerialized {

   public:
       PriceExpressionEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
