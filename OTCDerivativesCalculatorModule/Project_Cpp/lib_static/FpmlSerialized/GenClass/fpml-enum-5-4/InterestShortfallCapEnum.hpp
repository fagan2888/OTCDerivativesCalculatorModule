#ifndef FpmlSerialized_InterestShortfallCapEnum_hpp
#define FpmlSerialized_InterestShortfallCapEnum_hpp
...
class InterestShortfallCapEnum : public ISerialized {

   public:
       InterestShortfallCapEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
