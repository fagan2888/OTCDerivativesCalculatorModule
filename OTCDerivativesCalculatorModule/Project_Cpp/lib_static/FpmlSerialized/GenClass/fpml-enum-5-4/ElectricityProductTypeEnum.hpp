#ifndef FpmlSerialized_ElectricityProductTypeEnum_hpp
#define FpmlSerialized_ElectricityProductTypeEnum_hpp
...
class ElectricityProductTypeEnum : public ISerialized {

   public:
       ElectricityProductTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
