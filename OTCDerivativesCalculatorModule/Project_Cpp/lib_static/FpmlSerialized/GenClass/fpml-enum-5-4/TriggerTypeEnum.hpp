#ifndef FpmlSerialized_TriggerTypeEnum_hpp
#define FpmlSerialized_TriggerTypeEnum_hpp
...
class TriggerTypeEnum : public ISerialized {

   public:
       TriggerTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
