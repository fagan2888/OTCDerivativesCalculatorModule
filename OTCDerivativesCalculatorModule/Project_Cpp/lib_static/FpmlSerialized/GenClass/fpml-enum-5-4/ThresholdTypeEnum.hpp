#ifndef FpmlSerialized_ThresholdTypeEnum_hpp
#define FpmlSerialized_ThresholdTypeEnum_hpp
...
class ThresholdTypeEnum : public ISerialized {

   public:
       ThresholdTypeEnum(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
