// FinancialSwapLeg.cpp 
#include "FinancialSwapLeg.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
FinancialSwapLeg::FinancialSwapLeg(TiXmlNode* xmlNode)
...
boost::shared_ptr<PartyReference> FinancialSwapLeg::getPayerPartyReference()
{
...
boost::shared_ptr<AccountReference> FinancialSwapLeg::getPayerAccountReference()
{
...
boost::shared_ptr<PartyReference> FinancialSwapLeg::getReceiverPartyReference()
{
...
boost::shared_ptr<AccountReference> FinancialSwapLeg::getReceiverAccountReference()
{
