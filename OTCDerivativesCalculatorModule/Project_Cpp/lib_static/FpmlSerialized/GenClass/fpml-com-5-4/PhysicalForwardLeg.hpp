// PhysicalForwardLeg.hpp 
#ifndef FpmlSerialized_PhysicalForwardLeg_hpp
#define FpmlSerialized_PhysicalForwardLeg_hpp
...
class PhysicalForwardLeg : public CommodityForwardLeg { 
   public: 
       PhysicalForwardLeg(TiXmlNode* xmlNode);
