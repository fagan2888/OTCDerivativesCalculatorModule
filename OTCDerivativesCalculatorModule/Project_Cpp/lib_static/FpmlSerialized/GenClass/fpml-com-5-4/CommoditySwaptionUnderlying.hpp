// CommoditySwaptionUnderlying.hpp 
#ifndef FpmlSerialized_CommoditySwaptionUnderlying_hpp
#define FpmlSerialized_CommoditySwaptionUnderlying_hpp
...
class CommoditySwaptionUnderlying : public ISerialized { 
   public: 
       CommoditySwaptionUnderlying(TiXmlNode* xmlNode);
