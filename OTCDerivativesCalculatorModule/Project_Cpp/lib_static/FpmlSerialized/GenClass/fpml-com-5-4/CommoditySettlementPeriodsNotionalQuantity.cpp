// CommoditySettlementPeriodsNotionalQuantity.cpp 
#include "CommoditySettlementPeriodsNotionalQuantity.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
CommoditySettlementPeriodsNotionalQuantity::CommoditySettlementPeriodsNotionalQuantity(TiXmlNode* xmlNode)
: CommodityNotionalQuantity(xmlNode)
{
    #ifdef ConsolePrint
...
std::vector<boost::shared_ptr<SettlementPeriodsReference>> CommoditySettlementPeriodsNotionalQuantity::getSettlementPeriodsReference()
{
