// PhysicalForwardLeg.cpp 
#include "PhysicalForwardLeg.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
PhysicalForwardLeg::PhysicalForwardLeg(TiXmlNode* xmlNode)
: CommodityForwardLeg(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<PartyReference> PhysicalForwardLeg::getPayerPartyReference()
{
...
boost::shared_ptr<AccountReference> PhysicalForwardLeg::getPayerAccountReference()
{
...
boost::shared_ptr<PartyReference> PhysicalForwardLeg::getReceiverPartyReference()
{
...
boost::shared_ptr<AccountReference> PhysicalForwardLeg::getReceiverAccountReference()
{
