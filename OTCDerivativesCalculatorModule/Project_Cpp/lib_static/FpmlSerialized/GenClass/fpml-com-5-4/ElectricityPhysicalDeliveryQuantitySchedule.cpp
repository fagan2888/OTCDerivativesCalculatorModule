// ElectricityPhysicalDeliveryQuantitySchedule.cpp 
#include "ElectricityPhysicalDeliveryQuantitySchedule.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ElectricityPhysicalDeliveryQuantitySchedule::ElectricityPhysicalDeliveryQuantitySchedule(TiXmlNode* xmlNode)
: CommodityPhysicalQuantitySchedule(xmlNode)
{
    #ifdef ConsolePrint
...
std::vector<boost::shared_ptr<SettlementPeriodsReference>> ElectricityPhysicalDeliveryQuantitySchedule::getSettlementPeriodsReference()
{
