...
CommoditySwap::CommoditySwap(TiXmlNode* xmlNode)
: Product(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<AdjustableOrRelativeDate> CommoditySwap::getEffectiveDate()
{
...
boost::shared_ptr<AdjustableOrRelativeDate> CommoditySwap::getTerminationDate()
{
...
boost::shared_ptr<IdentifiedCurrency> CommoditySwap::getSettlementCurrency()
{
...
boost::shared_ptr<CommoditySwapLeg> CommoditySwap::getCommoditySwapLeg()
{
...
boost::shared_ptr<CoalPhysicalLeg> CommoditySwap::getCoalPhysicalLeg()
{
...
boost::shared_ptr<ElectricityPhysicalLeg> CommoditySwap::getElectricityPhysicalLeg()
{
...
boost::shared_ptr<EnvironmentalPhysicalLeg> CommoditySwap::getEnvironmentalPhysicalLeg()
{
...
boost::shared_ptr<FixedPriceLeg> CommoditySwap::getFixedLeg()
{
...
boost::shared_ptr<FloatingPriceLeg> CommoditySwap::getFloatingLeg()
{
...
boost::shared_ptr<GasPhysicalLeg> CommoditySwap::getGasPhysicalLeg()
{
...
boost::shared_ptr<OilPhysicalLeg> CommoditySwap::getOilPhysicalLeg()
{
...
std::vector<boost::shared_ptr<WeatherLeg>> CommoditySwap::getWeatherLeg()
{
...
boost::shared_ptr<XsdTypeBoolean> CommoditySwap::getCommonPricing()
{
...
boost::shared_ptr<CommodityMarketDisruption> CommoditySwap::getMarketDisruption()
{
...
boost::shared_ptr<CommodityBullionSettlementDisruptionEnum> CommoditySwap::getSettlementDisruption()
{
...
boost::shared_ptr<Rounding> CommoditySwap::getRounding()
{
