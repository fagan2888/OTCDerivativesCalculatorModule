// FinancialSwapLeg.hpp 
#ifndef FpmlSerialized_FinancialSwapLeg_hpp
#define FpmlSerialized_FinancialSwapLeg_hpp
...
class FinancialSwapLeg : public CommoditySwapLeg { 
   public: 
       FinancialSwapLeg(TiXmlNode* xmlNode);
