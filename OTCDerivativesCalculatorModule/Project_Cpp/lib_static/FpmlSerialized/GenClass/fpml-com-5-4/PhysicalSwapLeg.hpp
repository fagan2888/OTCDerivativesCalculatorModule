// PhysicalSwapLeg.hpp 
#ifndef FpmlSerialized_PhysicalSwapLeg_hpp
#define FpmlSerialized_PhysicalSwapLeg_hpp
...
class PhysicalSwapLeg : public CommoditySwapLeg { 
   public: 
       PhysicalSwapLeg(TiXmlNode* xmlNode);
