// SettlementPeriodsFixedPrice.cpp 
#include "SettlementPeriodsFixedPrice.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
SettlementPeriodsFixedPrice::SettlementPeriodsFixedPrice(TiXmlNode* xmlNode)
: FixedPrice(xmlNode)
{
    #ifdef ConsolePrint
...
std::vector<boost::shared_ptr<SettlementPeriodsReference>> SettlementPeriodsFixedPrice::getSettlementPeriodsReference()
{
