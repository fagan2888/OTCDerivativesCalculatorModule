// ElectricityPhysicalDeliveryQuantity.cpp 
#include "ElectricityPhysicalDeliveryQuantity.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ElectricityPhysicalDeliveryQuantity::ElectricityPhysicalDeliveryQuantity(TiXmlNode* xmlNode)
...
std::vector<boost::shared_ptr<SettlementPeriodsReference>> ElectricityPhysicalDeliveryQuantity::getSettlementPeriodsReference()
{
