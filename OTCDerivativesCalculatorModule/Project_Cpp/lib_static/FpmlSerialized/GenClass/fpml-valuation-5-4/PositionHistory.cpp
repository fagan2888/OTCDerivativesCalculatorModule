...
PositionHistory::PositionHistory(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<OriginatingEvent> PositionHistory::getOriginatingEvent()
{
...
boost::shared_ptr<Trade> PositionHistory::getTrade()
{
...
boost::shared_ptr<TradeAmendmentContent> PositionHistory::getAmendment()
{
...
boost::shared_ptr<TradeNotionalChange> PositionHistory::getIncrease()
{
...
boost::shared_ptr<TerminatingEvent> PositionHistory::getTerminatingEvent()
{
...
boost::shared_ptr<TradeNotionalChange> PositionHistory::getTermination()
{
...
boost::shared_ptr<TradeNovationContent> PositionHistory::getNovation()
{
...
boost::shared_ptr<OptionExercise> PositionHistory::getOptionExercise()
{
...
std::vector<boost::shared_ptr<OptionExpiry>> PositionHistory::getOptionExpiry()
{
...
boost::shared_ptr<DeClear> PositionHistory::getDeClear()
{
...
boost::shared_ptr<Withdrawal> PositionHistory::getWithdrawal()
{
...
boost::shared_ptr<AdditionalEvent> PositionHistory::getAdditionalEvent()
{
