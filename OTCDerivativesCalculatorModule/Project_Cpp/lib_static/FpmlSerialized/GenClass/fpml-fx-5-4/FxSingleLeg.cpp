...
FxSingleLeg::FxSingleLeg(TiXmlNode* xmlNode)
: Product(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Payment> FxSingleLeg::getExchangedCurrency1()
{
...
boost::shared_ptr<Payment> FxSingleLeg::getExchangedCurrency2()
{
...
boost::shared_ptr<DealtCurrencyEnum> FxSingleLeg::getDealtCurrency()
{
...
boost::shared_ptr<XsdTypeBoolean> FxSingleLeg::getTenorName()
{
...
boost::shared_ptr<Period> FxSingleLeg::getTenorPeriod()
{
...
boost::shared_ptr<XsdTypeDate> FxSingleLeg::getValueDate()
{
...
boost::shared_ptr<XsdTypeDate> FxSingleLeg::getCurrency1ValueDate()
{
...
boost::shared_ptr<XsdTypeDate> FxSingleLeg::getCurrency2ValueDate()
{
...
boost::shared_ptr<ExchangeRate> FxSingleLeg::getExchangeRate()
{
...
boost::shared_ptr<FxCashSettlement> FxSingleLeg::getNonDeliverableSettlement()
{
