...
namespace FpmlSerializedCSharp
{
    public class CreditDefaultSwap
    {
        ...
        public CashSettlementTerms CashSettlementTerms
        {
            get
            {
                ...
                else if (this.cashSettlementTermsIDRef != null)
                {
                    cashSettlementTerms = IDManager.getID(cashSettlementTermsIDRef) as CashSettlementTerms;
                    return this.cashSettlementTerms; 
                }
                else
                {
            ...
            set
            {
                if (this.cashSettlementTerms != value)
                {
        ...
        public string CashSettlementTermsIDRef { get; set; }
        ...
        public PhysicalSettlementTerms PhysicalSettlementTerms
        {
            get
            {
                ...
                else if (this.physicalSettlementTermsIDRef != null)
                {
                    physicalSettlementTerms = IDManager.getID(physicalSettlementTermsIDRef) as PhysicalSettlementTerms;
                    return this.physicalSettlementTerms; 
                }
                else
                {
            ...
            set
            {
                if (this.physicalSettlementTerms != value)
                {
                    this.physicalSettlementTerms = value;
                }
            }
        }
        #endregion
        
        public string PhysicalSettlementTermsIDRef { get; set; }
