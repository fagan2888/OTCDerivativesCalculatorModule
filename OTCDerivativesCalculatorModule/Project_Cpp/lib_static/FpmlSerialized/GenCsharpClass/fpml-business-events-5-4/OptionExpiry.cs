...
namespace FpmlSerializedCSharp
{
    public class OptionExpiry
    {
        ...
        private ExerciseProcedureOption exerciseProcedure;
        public ExerciseProcedureOption ExerciseProcedure
        {
            get
            {
                ...
                {
                    exerciseProcedure = IDManager.getID(exerciseProcedureIDRef) as ExerciseProcedureOption;
                    return this.exerciseProcedure; 
                }
                else
                {
        ...
        public string ExerciseProcedureOptionIDRef { get; set; }
