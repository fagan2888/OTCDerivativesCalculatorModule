...
namespace FpmlSerializedCSharp
{
    public class ConsentGranted
    {
            ...
            foreach (XmlNode item in portfolioReferenceNodeList)
            {
                if (item.Attributes["href"] != null || item.Attributes["id"] == null) 
                {
                    if (item.Attributes["id"] != null) 
                    {
                        ...
                        PortfolioReferenceBase ob = PortfolioReferenceBase();
                    ...
                    {
                        portfolioReference = new PortfolioReferenceBase(item);
                    }
                }
            }
        ...
        private PortfolioReferenceBase portfolioReference;
        public PortfolioReferenceBase PortfolioReference
        {
            get
            {
                ...
                {
                    portfolioReference = IDManager.getID(portfolioReferenceIDRef) as PortfolioReferenceBase;
                    return this.portfolioReference; 
                }
                else
                {
        ...
        public string PortfolioReferenceBaseIDRef { get; set; }
