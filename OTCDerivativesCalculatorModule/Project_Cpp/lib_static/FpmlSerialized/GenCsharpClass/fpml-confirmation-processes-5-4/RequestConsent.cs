    ...
    public class RequestConsent
    {
            ...
            foreach (XmlNode item in requestedActionNodeList)
            {
                if (item.Attributes["href"] != null || item.Attributes["id"] == null) 
                {
                    if (item.Attributes["id"] != null) 
                    {
                        ...
                        RequestedAction ob = RequestedAction();
                    ...
                    {
                        requestedAction = new RequestedAction(item);
                    }
                }
            }
        ...
        public RequestedAction RequestedAction
        {
            get
            {
                ...
                {
                    requestedAction = IDManager.getID(requestedActionIDRef) as RequestedAction;
                    return this.requestedAction; 
                }
                else
                {
        ...
        public string RequestedActionIDRef { get; set; }
        ...
        #region CompressionActivity
        private CompressionActivity compressionActivity;
        public CompressionActivity CompressionActivity
        {
            get
            {
                if (this.compressionActivity != null)
                {
                    return this.compressionActivity; 
                }
                else if (this.compressionActivityIDRef != null)
                {
                    compressionActivity = IDManager.getID(compressionActivityIDRef) as CompressionActivity;
                    return this.compressionActivity; 
                }
                else
                {
            ...
            set
            {
                if (this.compressionActivity != value)
                {
        ...
        public string CompressionActivityIDRef { get; set; }
