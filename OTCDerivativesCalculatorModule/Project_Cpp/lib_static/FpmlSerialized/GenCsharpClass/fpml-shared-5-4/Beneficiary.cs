...
namespace FpmlSerializedCSharp
{
    public class Beneficiary
    {
        ...
        #region BeneficiaryPartyReference
        private PartyReference beneficiaryPartyReference;
        public PartyReference BeneficiaryPartyReference
        {
            get
            {
                if (this.beneficiaryPartyReference != null)
                {
                    return this.beneficiaryPartyReference; 
                }
                else if (this.beneficiaryPartyReferenceIDRef != null)
                {
                    beneficiaryPartyReference = IDManager.getID(beneficiaryPartyReferenceIDRef) as PartyReference;
                    return this.beneficiaryPartyReference; 
                }
                else
                {
            ...
            set
            {
                if (this.beneficiaryPartyReference != value)
                {
