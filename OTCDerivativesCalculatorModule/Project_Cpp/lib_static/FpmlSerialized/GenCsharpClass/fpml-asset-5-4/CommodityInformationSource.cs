...
namespace FpmlSerializedCSharp
{
    public class CommodityInformationSource
    {
        ...
        #region RateSource
        private CommodityInformationProvider rateSource;
        public CommodityInformationProvider RateSource
        {
            get
            {
                ...
                {
                    rateSource = IDManager.getID(rateSourceIDRef) as CommodityInformationProvider;
                    return this.rateSource; 
                }
                else
                {
        ...
        public string CommodityInformationProviderIDRef { get; set; }
