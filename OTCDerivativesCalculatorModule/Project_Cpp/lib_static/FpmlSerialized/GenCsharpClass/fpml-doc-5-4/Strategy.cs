...
namespace FpmlSerializedCSharp
{
    public class Strategy
    {
        ...
        #region StrategyComponentIdentifier
        private List<StrategyComponentIdentification> strategyComponentIdentifier;
        public List<StrategyComponentIdentification> StrategyComponentIdentifier
        {
            get
            {
                ...
                else if (this.strategyComponentIdentifierIDRef != null)
                {
                    strategyComponentIdentifier = IDManager.getID(strategyComponentIdentifierIDRef) as List<StrategyComponentIdentification>;
                    return this.strategyComponentIdentifier; 
                }
                else
                {
            ...
            set
            {
                if (this.strategyComponentIdentifier != value)
                {
                    this.strategyComponentIdentifier = value;
                }
            }
        }
        #endregion
        
        public string StrategyComponentIdentificationIDRef { get; set; }
