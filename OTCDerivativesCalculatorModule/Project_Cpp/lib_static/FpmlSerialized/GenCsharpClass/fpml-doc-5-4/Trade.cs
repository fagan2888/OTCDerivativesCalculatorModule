...
namespace FpmlSerializedCSharp
{
    public class Trade
    {
        ...
        public TradeHeader TradeHeader
        {
            get
            {
                if (this.tradeHeader != null)
                {
                    return this.tradeHeader; 
                }
                else if (this.tradeHeaderIDRef != null)
                {
                    tradeHeader = IDManager.getID(tradeHeaderIDRef) as TradeHeader;
                    return this.tradeHeader; 
                }
                else
                {
        ...
        public string TradeHeaderIDRef { get; set; }
        #region Product
        ...
        public List<Payment> OtherPartyPayment
        {
            get
            {
                ...
                else if (this.otherPartyPaymentIDRef != null)
                {
                    otherPartyPayment = IDManager.getID(otherPartyPaymentIDRef) as List<Payment>;
                    return this.otherPartyPayment; 
                }
                else
                {
            ...
            set
            {
                if (this.otherPartyPayment != value)
                {
                    this.otherPartyPayment = value;
                }
            }
        }
        #endregion
        ...
        #region BrokerPartyReference
        private List<PartyReference> brokerPartyReference;
        public List<PartyReference> BrokerPartyReference
        {
            get
            {
                ...
                else if (this.brokerPartyReferenceIDRef != null)
                {
                    brokerPartyReference = IDManager.getID(brokerPartyReferenceIDRef) as List<PartyReference>;
                    return this.brokerPartyReference; 
                }
                else
                {
            ...
            set
            {
                if (this.brokerPartyReference != value)
                {
                    this.brokerPartyReference = value;
                }
            }
        }
        #endregion
        ...
        #region CalculationAgentBusinessCenter
        ...
        public BusinessCenter CalculationAgentBusinessCenter
        {
            get
            {
                ...
                else if (this.calculationAgentBusinessCenterIDRef != null)
                {
                    calculationAgentBusinessCenter = IDManager.getID(calculationAgentBusinessCenterIDRef) as BusinessCenter;
                    return this.calculationAgentBusinessCenter; 
                }
                else
                {
            ...
            set
            {
                if (this.calculationAgentBusinessCenter != value)
                {
        ...
        #region DeterminingParty
        private List<PartyReference> determiningParty;
        public List<PartyReference> DeterminingParty
        {
            get
            {
                ...
                else if (this.determiningPartyIDRef != null)
                {
                    determiningParty = IDManager.getID(determiningPartyIDRef) as List<PartyReference>;
                    return this.determiningParty; 
                }
                else
                {
            ...
            set
            {
                if (this.determiningParty != value)
                {
                    this.determiningParty = value;
                }
            }
        }
        #endregion
        ...
        public string PartyReferenceIDRef { get; set; }
        #region HedgingParty
        private List<PartyReference> hedgingParty;
        public List<PartyReference> HedgingParty
        {
            get
            {
                ...
                else if (this.hedgingPartyIDRef != null)
                {
                    hedgingParty = IDManager.getID(hedgingPartyIDRef) as List<PartyReference>;
                    return this.hedgingParty; 
                }
                else
                {
            ...
            set
            {
                if (this.hedgingParty != value)
                {
                    this.hedgingParty = value;
                }
            }
        }
        #endregion
        ...
        public Documentation Documentation
        {
            get
            {
                ...
                {
                    documentation = IDManager.getID(documentationIDRef) as Documentation;
                    return this.documentation; 
                }
                else
                {
        ...
        public string DocumentationIDRef { get; set; }
        #region GoverningLaw
