    ...
    public class CancelableProvision
    {
        ...
        public CancelableProvisionAdjustedDates CancelableProvisionAdjustedDates
        {
            get
            {
                ...
                else if (this.cancelableProvisionAdjustedDatesIDRef != null)
                {
                    cancelableProvisionAdjustedDates = IDManager.getID(cancelableProvisionAdjustedDatesIDRef) as CancelableProvisionAdjustedDates;
                    return this.cancelableProvisionAdjustedDates; 
                }
                else
                {
            ...
            set
            {
                if (this.cancelableProvisionAdjustedDates != value)
                {
        ...
        public string CancelableProvisionAdjustedDatesIDRef { get; set; }
        ...
        public List<FinalCalculationPeriodDateAdjustment> FinalCalculationPeriodDateAdjustment
        {
            get
            {
                ...
                else if (this.finalCalculationPeriodDateAdjustmentIDRef != null)
                {
                    finalCalculationPeriodDateAdjustment = IDManager.getID(finalCalculationPeriodDateAdjustmentIDRef) as List<FinalCalculationPeriodDateAdjustment>;
                    return this.finalCalculationPeriodDateAdjustment; 
                }
                else
                {
            ...
            set
            {
                if (this.finalCalculationPeriodDateAdjustment != value)
                {
                    this.finalCalculationPeriodDateAdjustment = value;
                }
            }
        }
        #endregion
        
        public string FinalCalculationPeriodDateAdjustmentIDRef { get; set; }
        #region InitialFee
        ...
        public SimplePayment InitialFee
        {
            get
            {
                ...
                else if (this.initialFeeIDRef != null)
                {
                    initialFee = IDManager.getID(initialFeeIDRef) as SimplePayment;
                    return this.initialFee; 
                }
                else
                {
