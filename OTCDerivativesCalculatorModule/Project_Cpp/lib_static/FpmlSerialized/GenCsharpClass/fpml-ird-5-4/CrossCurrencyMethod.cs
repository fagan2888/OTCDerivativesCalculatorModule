...
namespace FpmlSerializedCSharp
{
    public class CrossCurrencyMethod
    {
        ...
        private List<Currency> cashSettlementCurrency;
        public List<Currency> CashSettlementCurrency
        {
            get
            {
                ...
                {
                    cashSettlementCurrency = IDManager.getID(cashSettlementCurrencyIDRef) as List<Currency>;
                    return this.cashSettlementCurrency; 
                }
                else
                {
