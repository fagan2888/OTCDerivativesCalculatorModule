...
value_type ThrowAnException(value_type v1) 
{ 
...
void Splash()
{
  ...
  mu::console() << _T("  (C) 2011 Ingo Berg\n");
}
...
//#define USE_GERMAN_LOCALE
  ...
  parser.DefineFun(_T("strfun0"), StrFun0, false);
  parser.DefineFun(_T("strfun2"), StrFun2, false);
