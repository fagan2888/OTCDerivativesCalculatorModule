// Excel_condi_structuredCouponSchedule.hpp 
#ifndef FpmlSerialized_Excel_condi_structuredCouponSchedule_hpp
#define FpmlSerialized_Excel_condi_structuredCouponSchedule_hpp
...
class Excel_condi_structuredCouponSchedule : public ISerialized { 
   public: 
       Excel_condi_structuredCouponSchedule(TiXmlNode* xmlNode);
