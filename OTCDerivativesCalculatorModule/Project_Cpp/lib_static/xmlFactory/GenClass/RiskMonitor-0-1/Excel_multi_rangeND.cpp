// Excel_multi_rangeND.cpp 
#include "Excel_multi_rangeND.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_multi_rangeND::Excel_multi_rangeND(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_multi_rangeND::getJoint_type()
{
...
std::vector<boost::shared_ptr<Range1D>> Excel_multi_rangeND::getRange1D()
{
...
std::vector<boost::shared_ptr<Excel_underlyingCalcID>> Excel_multi_rangeND::getExcel_underlyingCalcID()
{
