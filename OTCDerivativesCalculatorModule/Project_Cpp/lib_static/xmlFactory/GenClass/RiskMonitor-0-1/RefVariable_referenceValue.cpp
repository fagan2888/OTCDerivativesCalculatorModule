// RefVariable_referenceValue.cpp 
#include "RefVariable_referenceValue.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
RefVariable_referenceValue::RefVariable_referenceValue(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<VariableInfo> RefVariable_referenceValue::getVariableInfo()
{
