// Excel_multiAsset_upInOutCall.cpp 
#include "Excel_multiAsset_upInOutCall.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_multiAsset_upInOutCall::Excel_multiAsset_upInOutCall(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getPayoffDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getExerciseDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getInOut()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getBaseUnderlyingValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getBaseCoupon()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getStrike()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getStrikeValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getPartiRate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getBarrier()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getBarrierValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getRebateCoupon()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getRebateCouponValue()
{
...
std::vector<boost::shared_ptr<Excel_underlyingCalcID>> Excel_multiAsset_upInOutCall::getExcel_underlyingCalcID()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getObservationStartDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_upInOutCall::getObservationEndDate()
{
