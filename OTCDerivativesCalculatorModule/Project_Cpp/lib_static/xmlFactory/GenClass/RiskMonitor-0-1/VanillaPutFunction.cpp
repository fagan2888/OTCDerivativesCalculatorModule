// VanillaPutFunction.cpp 
#include "VanillaPutFunction.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
VanillaPutFunction::VanillaPutFunction(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeDouble> VanillaPutFunction::getPartiRate()
{
...
boost::shared_ptr<XsdTypeDouble> VanillaPutFunction::getStrike()
{
...
boost::shared_ptr<XsdTypeDouble> VanillaPutFunction::getSpread()
{
