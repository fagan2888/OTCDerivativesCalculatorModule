// BarrierWithConstRebatePutOption.cpp 
#include "BarrierWithConstRebatePutOption.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
BarrierWithConstRebatePutOption::BarrierWithConstRebatePutOption(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<PayoffDateInfo> BarrierWithConstRebatePutOption::getPayoffDateInfo()
{
...
boost::shared_ptr<XsdTypeDouble> BarrierWithConstRebatePutOption::getParticipateRate()
{
...
boost::shared_ptr<ReferenceCalculationInfo> BarrierWithConstRebatePutOption::getReferenceCalculationInfo()
{
...
boost::shared_ptr<BarrierInfo> BarrierWithConstRebatePutOption::getBarrierInfo()
{
...
boost::shared_ptr<XsdTypeDouble> BarrierWithConstRebatePutOption::getStrike()
{
...
boost::shared_ptr<XsdTypeDouble> BarrierWithConstRebatePutOption::getLowerBound()
{
...
boost::shared_ptr<XsdTypeDouble> BarrierWithConstRebatePutOption::getRebateRate()
{
