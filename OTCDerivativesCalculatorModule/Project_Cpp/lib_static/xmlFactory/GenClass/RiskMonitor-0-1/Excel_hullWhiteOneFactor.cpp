// Excel_hullWhiteOneFactor.cpp 
#include "Excel_hullWhiteOneFactor.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_hullWhiteOneFactor::Excel_hullWhiteOneFactor(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_hullWhiteOneFactor::getCurrentValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_hullWhiteOneFactor::getAlpha()
{
...
boost::shared_ptr<XsdTypeToken> Excel_hullWhiteOneFactor::getVolatility()
{
...
boost::shared_ptr<Excel_rateInfo> Excel_hullWhiteOneFactor::getExcel_rateInfo()
{
...
boost::shared_ptr<XsdTypeToken> Excel_hullWhiteOneFactor::getLinkedCurveCode()
{
...
boost::shared_ptr<Excel_yieldCurve> Excel_hullWhiteOneFactor::getExcel_yieldCurve()
{
...
boost::shared_ptr<XsdTypeToken> Excel_hullWhiteOneFactor::getVba_description()
{
