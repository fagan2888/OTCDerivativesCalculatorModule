...
boost::shared_ptr<XsdTypeToken> CreditEvents::getFailureToPay()
{
...
boost::shared_ptr<XsdTypeToken> CreditEvents::getObligationAcceleration()
{
...
boost::shared_ptr<XsdTypeToken> CreditEvents::getRepudiationMoratorium()
{
...
boost::shared_ptr<XsdTypeToken> CreditEvents::getRestructuring()
{
...
boost::shared_ptr<XsdTypeToken> CreditEvents::getDefaultRequirement()
{
