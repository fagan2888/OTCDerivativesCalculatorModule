...
IdentityReferenceCal::IdentityReferenceCal(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> IdentityReferenceCal::getKrCode()
{
...
boost::shared_ptr<FixingDateInfo> IdentityReferenceCal::getFixingDateInfo()
{
