// SecuritiesInfo.hpp 
#ifndef FpmlSerialized_SecuritiesInfo_hpp
#define FpmlSerialized_SecuritiesInfo_hpp
...
class SecuritiesInfo : public ISerialized { 
   public: 
       SecuritiesInfo(TiXmlNode* xmlNode);
