// Excel_maximumUnderlyingCalcID.cpp 
#include "Excel_maximumUnderlyingCalcID.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_maximumUnderlyingCalcID::Excel_maximumUnderlyingCalcID(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
std::vector<boost::shared_ptr<Excel_selectedUnderlying>> Excel_maximumUnderlyingCalcID::getExcel_selectedUnderlying()
{
...
boost::shared_ptr<XsdTypeToken> Excel_maximumUnderlyingCalcID::getEventDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_maximumUnderlyingCalcID::getAverageDays()
{
