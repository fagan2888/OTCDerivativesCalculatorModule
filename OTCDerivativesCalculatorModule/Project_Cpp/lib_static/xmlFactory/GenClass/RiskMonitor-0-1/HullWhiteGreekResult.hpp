// HullWhiteGreekResult.hpp 
#ifndef FpmlSerialized_HullWhiteGreekResult_hpp
#define FpmlSerialized_HullWhiteGreekResult_hpp
...
class HullWhiteGreekResult : public ISerialized { 
   public: 
       HullWhiteGreekResult(TiXmlNode* xmlNode);
