// Excel_multiAsset_downInOutPut.cpp 
#include "Excel_multiAsset_downInOutPut.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_multiAsset_downInOutPut::Excel_multiAsset_downInOutPut(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getPayoffDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getExerciseDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getInOut()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getBaseUnderlyingValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getBaseCoupon()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getStrike()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getStrikeValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getPartiRate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getBarrier()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getBarrierValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getRebateCoupon()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getRebateCouponValue()
{
...
std::vector<boost::shared_ptr<Excel_underlyingCalcID>> Excel_multiAsset_downInOutPut::getExcel_underlyingCalcID()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getObservationStartDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiAsset_downInOutPut::getObservationEndDate()
{
