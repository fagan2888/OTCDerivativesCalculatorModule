...
SecuritiesInfo::SecuritiesInfo(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeDate> SecuritiesInfo::getNotional()
{
...
boost::shared_ptr<XsdTypeDate> SecuritiesInfo::getTradeDate()
{
...
boost::shared_ptr<XsdTypeDate> SecuritiesInfo::getEffectiveDate()
{
...
boost::shared_ptr<XsdTypeDate> SecuritiesInfo::getMaturityDate()
{
...
boost::shared_ptr<CalculationAmount> SecuritiesInfo::getCalculationAmount()
{
...
boost::shared_ptr<XsdTypeDouble> SecuritiesInfo::getPremium()
{
