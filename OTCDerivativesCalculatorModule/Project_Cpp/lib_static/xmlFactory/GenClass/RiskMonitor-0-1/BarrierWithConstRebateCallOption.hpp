// BarrierWithConstRebateCallOption.hpp 
#ifndef FpmlSerialized_BarrierWithConstRebateCallOption_hpp
#define FpmlSerialized_BarrierWithConstRebateCallOption_hpp
...
class BarrierWithConstRebateCallOption : public ISerialized { 
   public: 
       BarrierWithConstRebateCallOption(TiXmlNode* xmlNode);
