// Excel_multiAsset_upInOutCall.hpp 
#ifndef FpmlSerialized_Excel_multiAsset_upInOutCall_hpp
#define FpmlSerialized_Excel_multiAsset_upInOutCall_hpp
...
class Excel_multiAsset_upInOutCall : public ISerialized { 
   public: 
       Excel_multiAsset_upInOutCall(TiXmlNode* xmlNode);
