// Excel_choiceUnderlyingCalcID.cpp 
#include "Excel_choiceUnderlyingCalcID.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_choiceUnderlyingCalcID::Excel_choiceUnderlyingCalcID(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
std::vector<boost::shared_ptr<Excel_selectedUnderlying>> Excel_choiceUnderlyingCalcID::getExcel_selectedUnderlying()
{
...
boost::shared_ptr<XsdTypeToken> Excel_choiceUnderlyingCalcID::getEventDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_choiceUnderlyingCalcID::getAverageDays()
{
