// Excel_hullWhiteTwoFactor.hpp 
#ifndef FpmlSerialized_Excel_hullWhiteTwoFactor_hpp
#define FpmlSerialized_Excel_hullWhiteTwoFactor_hpp
...
class Excel_hullWhiteTwoFactor : public ISerialized { 
   public: 
       Excel_hullWhiteTwoFactor(TiXmlNode* xmlNode);
