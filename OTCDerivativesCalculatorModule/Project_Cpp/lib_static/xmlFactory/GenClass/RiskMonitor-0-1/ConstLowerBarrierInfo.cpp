// ConstLowerBarrierInfo.cpp 
#include "ConstLowerBarrierInfo.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
ConstLowerBarrierInfo::ConstLowerBarrierInfo(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<ReferenceCalculationInfo> ConstLowerBarrierInfo::getReferenceCalculationInfo()
{
...
boost::shared_ptr<BarrierDateInfo> ConstLowerBarrierInfo::getBarrierDateInfo()
{
...
boost::shared_ptr<XsdTypeDouble> ConstLowerBarrierInfo::getTrigger()
{
...
boost::shared_ptr<XsdTypeDate> ConstLowerBarrierInfo::getPastEventOccDate()
{
...
boost::shared_ptr<XsdTypeDouble> ConstLowerBarrierInfo::getPastEventOccValue()
{
...
boost::shared_ptr<XsdTypeToken> ConstLowerBarrierInfo::getRefVariableFlag_eventOccDate()
{
...
boost::shared_ptr<XsdTypeToken> ConstLowerBarrierInfo::getRefVariableFlag_eventOccValue()
{
