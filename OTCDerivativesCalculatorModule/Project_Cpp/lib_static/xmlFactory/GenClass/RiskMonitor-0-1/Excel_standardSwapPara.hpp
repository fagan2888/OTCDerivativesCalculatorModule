// Excel_standardSwapPara.hpp 
#ifndef FpmlSerialized_Excel_standardSwapPara_hpp
#define FpmlSerialized_Excel_standardSwapPara_hpp
...
class Excel_standardSwapPara : public ISerialized { 
   public: 
       Excel_standardSwapPara(TiXmlNode* xmlNode);
