// EventTriggerList.cpp 
#include "EventTriggerList.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
EventTriggerList::EventTriggerList(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
std::vector<boost::shared_ptr<EventTrigger>> EventTriggerList::getEventTrigger()
{
