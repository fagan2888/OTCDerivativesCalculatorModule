// Excel_standardSwapPara.cpp 
#include "Excel_standardSwapPara.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_standardSwapPara::Excel_standardSwapPara(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_standardSwapPara::getReferenceDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_standardSwapPara::getSimulationNum()
{
...
boost::shared_ptr<Excel_underlyingCalcInfo_para> Excel_standardSwapPara::getExcel_underlyingCalcInfo_para()
{
...
boost::shared_ptr<Excel_discountCurve_para> Excel_standardSwapPara::getExcel_discountCurve_para()
{
