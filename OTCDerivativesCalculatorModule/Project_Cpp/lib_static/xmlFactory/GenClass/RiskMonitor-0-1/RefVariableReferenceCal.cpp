...
RefVariableReferenceCal::RefVariableReferenceCal(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> RefVariableReferenceCal::getRefName()
{
