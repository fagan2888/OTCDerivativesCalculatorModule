// Excel_occReturnCalcInfo.hpp 
#ifndef FpmlSerialized_Excel_occReturnCalcInfo_hpp
#define FpmlSerialized_Excel_occReturnCalcInfo_hpp
...
class Excel_occReturnCalcInfo : public ISerialized { 
   public: 
       Excel_occReturnCalcInfo(TiXmlNode* xmlNode);
