...
PreDefinedVariableInfo::PreDefinedVariableInfo(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> PreDefinedVariableInfo::getRefInstanceName()
{
...
boost::shared_ptr<FixingInformation> PreDefinedVariableInfo::getFixingInformation()
{
