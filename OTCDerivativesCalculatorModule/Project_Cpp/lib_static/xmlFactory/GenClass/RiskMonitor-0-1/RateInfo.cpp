...
RateInfo::RateInfo(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> RateInfo::getCurrency()
{
...
boost::shared_ptr<XsdTypeToken> RateInfo::getIndexType()
{
...
boost::shared_ptr<XsdTypeToken> RateInfo::getTenor()
{
...
boost::shared_ptr<XsdTypeToken> RateInfo::getLegTenor()
{
