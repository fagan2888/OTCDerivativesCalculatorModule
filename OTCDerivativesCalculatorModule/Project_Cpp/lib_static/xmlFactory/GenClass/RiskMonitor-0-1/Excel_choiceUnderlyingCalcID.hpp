// Excel_choiceUnderlyingCalcID.hpp 
#ifndef FpmlSerialized_Excel_choiceUnderlyingCalcID_hpp
#define FpmlSerialized_Excel_choiceUnderlyingCalcID_hpp
...
class Excel_choiceUnderlyingCalcID : public ISerialized { 
   public: 
       Excel_choiceUnderlyingCalcID(TiXmlNode* xmlNode);
