// Excel_occReturnCalcInfo.cpp 
#include "Excel_occReturnCalcInfo.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_occReturnCalcInfo::Excel_occReturnCalcInfo(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Excel_returnCalcInfo> Excel_occReturnCalcInfo::getExcel_returnCalcInfo()
{
