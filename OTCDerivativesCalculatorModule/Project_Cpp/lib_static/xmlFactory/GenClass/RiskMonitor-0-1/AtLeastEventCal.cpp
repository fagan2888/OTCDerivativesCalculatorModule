...
AtLeastEventCal::AtLeastEventCal(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeInteger> AtLeastEventCal::getNum()
{
   if(!this->numIsNull_){
        return this->num_;
   }else
...
boost::shared_ptr<EventCalculationList> AtLeastEventCal::getEventCalculationList()
{
...
boost::shared_ptr<XsdTypeBoolean> AtLeastEventCal::getComplement()
{
