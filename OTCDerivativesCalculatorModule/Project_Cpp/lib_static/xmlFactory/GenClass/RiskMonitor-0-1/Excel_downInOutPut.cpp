// Excel_downInOutPut.cpp 
#include "Excel_downInOutPut.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_downInOutPut::Excel_downInOutPut(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getPayoffDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getExerciseDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getInOut()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getUnderlyingCode()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getBaseUnderlyingValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getBaseCoupon()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getStrike()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getStrikeValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getPartiRate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getBarrier()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getBarrierValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getRebateCoupon()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getRebateCouponValue()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getObservationStartDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_downInOutPut::getObservationEndDate()
{
