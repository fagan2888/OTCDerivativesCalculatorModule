// InterestRateSwapPayoff_A.cpp 
#include "InterestRateSwapPayoff_A.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
InterestRateSwapPayoff_A::InterestRateSwapPayoff_A(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<PayoffInfo> InterestRateSwapPayoff_A::getPayoffInfo()
{
