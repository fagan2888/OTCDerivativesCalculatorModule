// Excel_returnCalcInfo_CallableOption.cpp 
#include "Excel_returnCalcInfo_CallableOption.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_returnCalcInfo_CallableOption::Excel_returnCalcInfo_CallableOption(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Excel_returnCalcInfo> Excel_returnCalcInfo_CallableOption::getExcel_returnCalcInfo()
{
