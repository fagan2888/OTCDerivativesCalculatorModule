// Excel_fixedRateSwapLeg.cpp 
#include "Excel_fixedRateSwapLeg.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_fixedRateSwapLeg::Excel_fixedRateSwapLeg(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Excel_swapLegInfo> Excel_fixedRateSwapLeg::getExcel_swapLegInfo()
{
...
boost::shared_ptr<Excel_interface> Excel_fixedRateSwapLeg::getExcel_interface()
{
