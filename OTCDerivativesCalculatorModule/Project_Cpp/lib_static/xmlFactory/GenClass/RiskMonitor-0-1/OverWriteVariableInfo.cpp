...
OverWriteVariableInfo::OverWriteVariableInfo(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> OverWriteVariableInfo::getUsingRefVarName()
{
...
boost::shared_ptr<XsdTypeToken> OverWriteVariableInfo::getRefInstanceName()
{
...
boost::shared_ptr<XsdTypeBoolean> OverWriteVariableInfo::getSave()
{
   if(!this->saveIsNull_){
        return this->save_;
   }else
