// Excel_vanillaFloatingRateSwapLeg.hpp 
#ifndef FpmlSerialized_Excel_vanillaFloatingRateSwapLeg_hpp
#define FpmlSerialized_Excel_vanillaFloatingRateSwapLeg_hpp
...
class Excel_vanillaFloatingRateSwapLeg : public ISerialized { 
   public: 
       Excel_vanillaFloatingRateSwapLeg(TiXmlNode* xmlNode);
