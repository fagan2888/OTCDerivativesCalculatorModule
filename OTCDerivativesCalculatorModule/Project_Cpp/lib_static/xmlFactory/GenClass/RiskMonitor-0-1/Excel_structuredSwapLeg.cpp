// Excel_structuredSwapLeg.cpp 
#include "Excel_structuredSwapLeg.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_structuredSwapLeg::Excel_structuredSwapLeg(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Excel_swapLegInfo> Excel_structuredSwapLeg::getExcel_swapLegInfo()
{
...
boost::shared_ptr<Excel_interface> Excel_structuredSwapLeg::getExcel_interface()
{
