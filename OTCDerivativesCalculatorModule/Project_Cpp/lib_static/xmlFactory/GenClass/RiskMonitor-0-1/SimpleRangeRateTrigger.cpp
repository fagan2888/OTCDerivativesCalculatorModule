// SimpleRangeRateTrigger.cpp 
#include "SimpleRangeRateTrigger.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
SimpleRangeRateTrigger::SimpleRangeRateTrigger(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> SimpleRangeRateTrigger::getDayCounter()
{
...
boost::shared_ptr<XsdTypeDate> SimpleRangeRateTrigger::getCalculationStartDate()
{
...
boost::shared_ptr<XsdTypeDate> SimpleRangeRateTrigger::getCalculationEndDate()
{
...
boost::shared_ptr<ReferenceCalculationInfo> SimpleRangeRateTrigger::getReferenceCalculationInfo()
{
...
boost::shared_ptr<SimpleRangeEventList> SimpleRangeRateTrigger::getSimpleRangeEventList()
{
...
boost::shared_ptr<PayoffDateInfo> SimpleRangeRateTrigger::getPayoffDateInfo()
{
