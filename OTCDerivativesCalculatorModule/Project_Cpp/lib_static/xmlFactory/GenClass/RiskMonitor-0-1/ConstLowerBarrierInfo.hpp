// ConstLowerBarrierInfo.hpp 
#ifndef FpmlSerialized_ConstLowerBarrierInfo_hpp
#define FpmlSerialized_ConstLowerBarrierInfo_hpp
...
class ConstLowerBarrierInfo : public ISerialized { 
   public: 
       ConstLowerBarrierInfo(TiXmlNode* xmlNode);
