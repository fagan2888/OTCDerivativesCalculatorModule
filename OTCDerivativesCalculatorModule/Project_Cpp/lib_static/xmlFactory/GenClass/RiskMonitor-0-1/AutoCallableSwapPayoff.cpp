// AutoCallableSwapPayoff.cpp 
#include "AutoCallableSwapPayoff.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
AutoCallableSwapPayoff::AutoCallableSwapPayoff(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<RecieveSwapPart> AutoCallableSwapPayoff::getRecieveSwapPart()
{
...
boost::shared_ptr<PaySwapPart> AutoCallableSwapPayoff::getPaySwapPart()
{
