// Excel_vanillaFloatingRateSwapLeg.cpp 
#include "Excel_vanillaFloatingRateSwapLeg.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_vanillaFloatingRateSwapLeg::Excel_vanillaFloatingRateSwapLeg(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Excel_swapLegInfo> Excel_vanillaFloatingRateSwapLeg::getExcel_swapLegInfo()
{
...
boost::shared_ptr<Excel_interface> Excel_vanillaFloatingRateSwapLeg::getExcel_interface()
{
