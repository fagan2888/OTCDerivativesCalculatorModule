// Excel_standardPara.hpp 
#ifndef FpmlSerialized_Excel_standardPara_hpp
#define FpmlSerialized_Excel_standardPara_hpp
...
class Excel_standardPara : public ISerialized { 
   public: 
       Excel_standardPara(TiXmlNode* xmlNode);
