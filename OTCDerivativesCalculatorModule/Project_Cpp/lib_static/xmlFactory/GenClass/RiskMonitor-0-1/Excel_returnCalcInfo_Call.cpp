// Excel_returnCalcInfo_Call.cpp 
#include "Excel_returnCalcInfo_Call.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_returnCalcInfo_Call::Excel_returnCalcInfo_Call(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Excel_returnCalcInfo> Excel_returnCalcInfo_Call::getExcel_returnCalcInfo()
{
