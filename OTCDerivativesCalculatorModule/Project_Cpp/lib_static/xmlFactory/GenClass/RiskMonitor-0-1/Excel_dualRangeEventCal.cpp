// Excel_dualRangeEventCal.cpp 
#include "Excel_dualRangeEventCal.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_dualRangeEventCal::Excel_dualRangeEventCal(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_dualRangeEventCal::getLowerRng()
{
...
boost::shared_ptr<XsdTypeToken> Excel_dualRangeEventCal::getUpperRng()
{
...
boost::shared_ptr<Excel_underlyingCalcID> Excel_dualRangeEventCal::getExcel_underlyingCalcID()
{
