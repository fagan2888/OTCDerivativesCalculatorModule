// Correlation_para.cpp 
#include "Correlation_para.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Correlation_para::Correlation_para(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Correlation_para::getFirst()
{
...
boost::shared_ptr<XsdTypeToken> Correlation_para::getSecond()
{
...
boost::shared_ptr<XsdTypeDouble> Correlation_para::getValue()
{
