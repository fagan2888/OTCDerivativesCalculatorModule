// Excel_standardHifivePara.cpp 
#include "Excel_standardHifivePara.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_standardHifivePara::Excel_standardHifivePara(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_standardHifivePara::getReferenceDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_standardHifivePara::getSimulationNum()
{
...
boost::shared_ptr<Excel_underlyingCalcInfo_para> Excel_standardHifivePara::getExcel_underlyingCalcInfo_para()
{
...
boost::shared_ptr<Excel_discountCurve_para> Excel_standardHifivePara::getExcel_discountCurve_para()
{
