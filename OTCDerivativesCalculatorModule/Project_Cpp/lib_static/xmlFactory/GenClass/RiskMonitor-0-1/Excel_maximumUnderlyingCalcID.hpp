// Excel_maximumUnderlyingCalcID.hpp 
#ifndef FpmlSerialized_Excel_maximumUnderlyingCalcID_hpp
#define FpmlSerialized_Excel_maximumUnderlyingCalcID_hpp
...
class Excel_maximumUnderlyingCalcID : public ISerialized { 
   public: 
       Excel_maximumUnderlyingCalcID(TiXmlNode* xmlNode);
