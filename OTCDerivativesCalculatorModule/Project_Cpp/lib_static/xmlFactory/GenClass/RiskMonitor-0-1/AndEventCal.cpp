...
AndEventCal::AndEventCal(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<EventCalculationList> AndEventCal::getEventCalculationList()
{
...
boost::shared_ptr<XsdTypeBoolean> AndEventCal::getComplement()
{
