// Excel_multiAsset_downInOutPut.hpp 
#ifndef FpmlSerialized_Excel_multiAsset_downInOutPut_hpp
#define FpmlSerialized_Excel_multiAsset_downInOutPut_hpp
...
class Excel_multiAsset_downInOutPut : public ISerialized { 
   public: 
       Excel_multiAsset_downInOutPut(TiXmlNode* xmlNode);
