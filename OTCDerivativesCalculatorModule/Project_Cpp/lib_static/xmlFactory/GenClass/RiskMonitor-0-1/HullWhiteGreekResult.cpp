// HullWhiteGreekResult.cpp 
#include "HullWhiteGreekResult.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
HullWhiteGreekResult::HullWhiteGreekResult(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> HullWhiteGreekResult::getUnderlyingName()
{
...
boost::shared_ptr<XsdTypeDouble> HullWhiteGreekResult::getDelta()
{
...
boost::shared_ptr<XsdTypeToken> HullWhiteGreekResult::getGamma()
{
...
boost::shared_ptr<XsdTypeToken> HullWhiteGreekResult::getVega()
{
   if(!this->vegaIsNull_){
        return this->vega_;
   }else
