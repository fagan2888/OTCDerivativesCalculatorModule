// MinimumReferenceCal.hpp 
#ifndef FpmlSerialized_MinimumReferenceCal_hpp
#define FpmlSerialized_MinimumReferenceCal_hpp
...
class MinimumReferenceCal : public ISerialized { 
   public: 
       MinimumReferenceCal(TiXmlNode* xmlNode);
