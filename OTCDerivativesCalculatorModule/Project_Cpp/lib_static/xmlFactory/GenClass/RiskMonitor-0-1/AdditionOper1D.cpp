...
AdditionOper1D::AdditionOper1D(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> AdditionOper1D::getConstValue()
{
...
boost::shared_ptr<XsdTypeToken> AdditionOper1D::getRefName()
{
