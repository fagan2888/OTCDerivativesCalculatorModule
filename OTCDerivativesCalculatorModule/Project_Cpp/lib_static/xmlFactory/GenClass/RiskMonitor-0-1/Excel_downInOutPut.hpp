// Excel_downInOutPut.hpp 
#ifndef FpmlSerialized_Excel_downInOutPut_hpp
#define FpmlSerialized_Excel_downInOutPut_hpp
...
class Excel_downInOutPut : public ISerialized { 
   public: 
       Excel_downInOutPut(TiXmlNode* xmlNode);
