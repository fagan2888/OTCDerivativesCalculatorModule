// Excel_multiCondi_multiRng_structuredAccrualCouponSchedule.cpp 
#include "Excel_multiCondi_multiRng_structuredAccrualCouponSchedule.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::Excel_multiCondi_multiRng_structuredAccrualCouponSchedule(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
   ...
   //excel_multi_rangeNDNode ----------------------------------------------------------------------------------------------------------------------
   TiXmlElement* excel_multi_rangeNDNode = xmlNode->FirstChildElement("excel_multi_rangeND");

   if(excel_multi_rangeNDNode){excel_multi_rangeNDIsNull_ = false;}
   else{excel_multi_rangeNDIsNull_ = true;}

   if(excel_multi_rangeNDNode)
   {
      for(excel_multi_rangeNDNode; excel_multi_rangeNDNode; excel_multi_rangeNDNode = excel_multi_rangeNDNode->NextSiblingElement("excel_multi_rangeND")){
          #ifdef ConsolePrint
              FileManager::instance().outFile_ << FileManager::instance().tap_.c_str() << "- excel_multi_rangeNDNode , address : " << excel_multi_rangeNDNode << std::endl;
          #endif
          excel_multi_rangeND_.push_back(boost::shared_ptr<Excel_multi_rangeND>(new Excel_multi_rangeND(excel_multi_rangeNDNode)));
      }
   }
   else {
       #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getEventDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getPayoffDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getCalculationStartDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getCalculationEndDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getDescription()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getVba_description()
{
...
std::vector<boost::shared_ptr<Excel_multi_rangeND>> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getExcel_multi_rangeND()
{
   if(!this->excel_multi_rangeNDIsNull_){
        return this->excel_multi_rangeND_;
   }else
   {
      QL_FAIL("null Ptr");
      return std::vector<boost::shared_ptr<Excel_multi_rangeND>>();
   }
}
std::vector<boost::shared_ptr<Excel_returnCalcInfo>> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getExcel_returnCalcInfo()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getDayCounter()
{
...
boost::shared_ptr<XsdTypeToken> Excel_multiCondi_multiRng_structuredAccrualCouponSchedule::getDetailScheduleType()
{
