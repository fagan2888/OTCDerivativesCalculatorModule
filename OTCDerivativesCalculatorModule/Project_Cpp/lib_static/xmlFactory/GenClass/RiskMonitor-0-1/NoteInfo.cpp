...
NoteInfo::NoteInfo(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeDate> NoteInfo::getNotional()
{
...
boost::shared_ptr<XsdTypeDate> NoteInfo::getTradeDate()
{
...
boost::shared_ptr<XsdTypeDate> NoteInfo::getEffectiveDate()
{
...
boost::shared_ptr<XsdTypeDate> NoteInfo::getMaturityDate()
{
...
boost::shared_ptr<CalculationAmount> NoteInfo::getCalculationAmount()
{
...
boost::shared_ptr<XsdTypeDouble> NoteInfo::getPremium()
{
