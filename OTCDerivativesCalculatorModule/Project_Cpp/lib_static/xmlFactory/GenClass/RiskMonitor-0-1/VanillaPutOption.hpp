// VanillaPutOption.hpp 
#ifndef FpmlSerialized_VanillaPutOption_hpp
#define FpmlSerialized_VanillaPutOption_hpp
...
class VanillaPutOption : public ISerialized { 
   public: 
       VanillaPutOption(TiXmlNode* xmlNode);
