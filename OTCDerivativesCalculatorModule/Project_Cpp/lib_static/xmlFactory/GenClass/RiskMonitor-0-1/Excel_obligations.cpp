// Excel_obligations.cpp 
#include "Excel_obligations.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_obligations::Excel_obligations(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_obligations::getCategory()
{
...
boost::shared_ptr<XsdTypeToken> Excel_obligations::getNotSubordinated()
{
...
boost::shared_ptr<XsdTypeToken> Excel_obligations::getNotDomesticCurrency()
{
...
boost::shared_ptr<XsdTypeToken> Excel_obligations::getNotDomesticLaw()
{
...
boost::shared_ptr<XsdTypeToken> Excel_obligations::getNotDomesticIssuance()
{
