...
OptionInfo::OptionInfo(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeDate> OptionInfo::getNotional()
{
...
boost::shared_ptr<XsdTypeDate> OptionInfo::getTradeDate()
{
...
boost::shared_ptr<XsdTypeDate> OptionInfo::getEffectiveDate()
{
...
boost::shared_ptr<XsdTypeDate> OptionInfo::getMaturityDate()
{
...
boost::shared_ptr<CalculationAmount> OptionInfo::getCalculationAmount()
{
...
boost::shared_ptr<XsdTypeDouble> OptionInfo::getPremium()
{
