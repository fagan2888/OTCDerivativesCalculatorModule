// Excel_complementReturnCalc_Call.cpp 
#include "Excel_complementReturnCalc_Call.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_complementReturnCalc_Call::Excel_complementReturnCalc_Call(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<Excel_returnCalcInfo> Excel_complementReturnCalc_Call::getExcel_returnCalcInfo()
{
