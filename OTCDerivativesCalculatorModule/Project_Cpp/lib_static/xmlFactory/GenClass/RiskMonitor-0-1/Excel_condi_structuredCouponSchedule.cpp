// Excel_condi_structuredCouponSchedule.cpp 
#include "Excel_condi_structuredCouponSchedule.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_condi_structuredCouponSchedule::Excel_condi_structuredCouponSchedule(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_condi_structuredCouponSchedule::getEventDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_condi_structuredCouponSchedule::getPayoffDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_condi_structuredCouponSchedule::getCalculationStartDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_condi_structuredCouponSchedule::getCalculationEndDate()
{
...
boost::shared_ptr<XsdTypeToken> Excel_condi_structuredCouponSchedule::getDescription()
{
...
boost::shared_ptr<XsdTypeToken> Excel_condi_structuredCouponSchedule::getVba_description()
{
...
boost::shared_ptr<Excel_eventCalcInfo> Excel_condi_structuredCouponSchedule::getExcel_eventCalcInfo()
{
...
boost::shared_ptr<Excel_returnCalcInfo> Excel_condi_structuredCouponSchedule::getExcel_returnCalcInfo()
{
...
boost::shared_ptr<XsdTypeToken> Excel_condi_structuredCouponSchedule::getDayCounter()
{
...
boost::shared_ptr<XsdTypeToken> Excel_condi_structuredCouponSchedule::getDetailScheduleType()
{
