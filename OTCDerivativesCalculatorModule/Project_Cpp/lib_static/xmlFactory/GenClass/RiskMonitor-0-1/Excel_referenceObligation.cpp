// Excel_referenceObligation.cpp 
#include "Excel_referenceObligation.hpp"
#ifdef ConsolePrint
    #include <iostream>
#endif 
...
Excel_referenceObligation::Excel_referenceObligation(TiXmlNode* xmlNode)
: ISerialized(xmlNode)
{
    #ifdef ConsolePrint
...
boost::shared_ptr<XsdTypeToken> Excel_referenceObligation::getInstrumentId()
{
...
boost::shared_ptr<XsdTypeDouble> Excel_referenceObligation::getCouponRate()
{
...
boost::shared_ptr<XsdTypeDate> Excel_referenceObligation::getMaturity()
{
...
boost::shared_ptr<XsdTypeToken> Excel_referenceObligation::getCurrency()
{
