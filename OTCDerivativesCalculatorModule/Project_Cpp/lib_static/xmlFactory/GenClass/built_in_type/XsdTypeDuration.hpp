#ifndef FpmlSerialized_XsdTypeDuration_hpp
#define FpmlSerialized_XsdTypeDuration_hpp
...
class XsdTypeDuration : public ISerialized {

   public:
       XsdTypeDuration(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
