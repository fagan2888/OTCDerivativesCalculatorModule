#ifndef FpmlSerialized_XsdTypeInteger_hpp
#define FpmlSerialized_XsdTypeInteger_hpp
...
class XsdTypeInteger : public ISerialized {

   public:
       XsdTypeInteger(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
