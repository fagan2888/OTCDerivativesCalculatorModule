#ifndef FpmlSerialized_XsdTypeUnsignedLong_hpp
#define FpmlSerialized_XsdTypeUnsignedLong_hpp
...
class XsdTypeUnsignedLong : public ISerialized {

   public:
       XsdTypeUnsignedLong(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
