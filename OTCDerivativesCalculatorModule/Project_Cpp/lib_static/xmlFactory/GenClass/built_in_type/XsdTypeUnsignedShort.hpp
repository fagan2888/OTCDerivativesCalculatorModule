#ifndef FpmlSerialized_XsdTypeUnsignedShort_hpp
#define FpmlSerialized_XsdTypeUnsignedShort_hpp
...
class XsdTypeUnsignedShort : public ISerialized {

   public:
       XsdTypeUnsignedShort(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
