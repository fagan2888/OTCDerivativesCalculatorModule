#ifndef FpmlSerialized_XsdTypeDecimal_hpp
#define FpmlSerialized_XsdTypeDecimal_hpp
...
class XsdTypeDecimal : public ISerialized {

   public:
       XsdTypeDecimal(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
