#ifndef FpmlSerialized_XsdTypeNOTATION_hpp
#define FpmlSerialized_XsdTypeNOTATION_hpp
...
class XsdTypeNOTATION : public ISerialized {

   public:
       XsdTypeNOTATION(TiXmlNode* xmlNode)
       : ISerialized(xmlNode){
