...
namespace QuantLib {
    ...
    */
    ...
    InterpolatedDiscountCurve<T>::InterpolatedDiscountCurve(
                                 ...
                                 const std::vector<Date>& jumpDates,
                                 const T& interpolator)
    //: YieldTermStructure(dates.front(), calendar, dayCounter, jumps, jumpDates),// Tag :: TS_ReferenceDate_Change
	: YieldTermStructure(Settings::instance().evaluationDate(), calendar, dayCounter, jumps, jumpDates),
