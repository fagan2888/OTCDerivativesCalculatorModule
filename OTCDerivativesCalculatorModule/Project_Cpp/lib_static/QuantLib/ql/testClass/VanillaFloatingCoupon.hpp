...
#ifndef quantlib_vanilla_floating_coupon_hpp
#define quantlib_vanilla_floating_coupon_hpp
...
namespace QuantLib {
    ...
    class VanillaFloatingCoupon : public MonteCoupon {
      public:
        VanillaFloatingCoupon(Real nominal,
