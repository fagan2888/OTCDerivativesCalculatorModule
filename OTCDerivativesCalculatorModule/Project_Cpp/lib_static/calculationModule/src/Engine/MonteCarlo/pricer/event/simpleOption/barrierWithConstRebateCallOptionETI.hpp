#ifndef quantlib_BarrierWithConstRebateCallOptionETI_hpp
#define quantlib_BarrierWithConstRebateCallOptionETI_hpp
...
namespace QuantLib {
	...
	class BarrierWithConstRebateCallOptionETI : public EventTriggerInfo
	{
		public:
