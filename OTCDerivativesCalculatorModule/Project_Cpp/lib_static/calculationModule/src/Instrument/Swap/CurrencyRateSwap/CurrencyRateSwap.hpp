...
namespace QuantLib {
    ...
    */
    class CurrencyRateSwap : public Swap {
      public:
        ...
        */
        ...
        CurrencyRateSwap(const Leg& firstLeg,
             const Leg& secondLeg);
        /*! Multi leg constructor. */
        CurrencyRateSwap(const Leg& legs,
    ...
    class CurrencyRateSwap::arguments : public virtual PricingEngine::arguments {
      public:
        std::vector<Leg> legs;
    ...
    class CurrencyRateSwap::results : public Instrument::results {
      public:
    ...
    class CurrencyRateSwap::engine : public GenericEngine<CurrencyRateSwap::arguments,
                                              CurrencyRateSwap::results> {};
