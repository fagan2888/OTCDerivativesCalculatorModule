...
namespace QuantLib {
	...
	class StepDownProductPayoff  {
		public:
			StepDownProductPayoff(std::vector<boost::shared_ptr<IEventCheck>> redemEventCheck,
								  boost::shared_ptr<IEventCheck> timeEventCheck,
								  boost::shared_ptr<IEventCheck> complementEventCheck);
